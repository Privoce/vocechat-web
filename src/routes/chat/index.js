...
export default function ChatPage() {
 ...
 return (
  <>
   {channelModalVisible && <ChannelModal closeModal={toggleChannelModalVisible} personal={true} />}
   ...
   <StyledWrapper>
    ...
    <div className={`right ${placeholderVisible ? "placeholder" : ""}`}>
     ...
     {channel_id && <ChannelChat cid={channel_id} dropFiles={channelDropFiles} client={client} />}
