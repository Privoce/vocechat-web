...
`;function n(e){return(0,a.jsx)(l,{readOnly:!0,...e,type:"checkbox"})}},9975:(e,s,t)=>{t.d(s,{Z:()=>i});const i=t(57889).ZP.div`
  cursor: pointer;
  position: relative;
  width: 44px;
  height: 24px;
...
`;function ae(){const{t:e}=(0,o.$)("setting"),{t:s}=(0,o.$)(),{updateConfig:t,values:a}=(0,j.Z)("login"),{data:l}=(0,N.BL)(),[n,{data:c,isSuccess:r,isLoading:d}]=(0,N.gU)();(0,i.useEffect)((()=>{r&&((0,z.Bn)(),u.ZP.success("Update API Secret Successfully!"))}),[r]);const M=null===a||void 0===a?void 0:a.third_party;return(0,_.jsxs)(ie,{children:[(0,_.jsx)(E.Z,{onClick:(e=>{t({...a,...e})}).bind(null,{third_party:!M}),"data-checked":M}),(0,_.jsxs)("div",{className:"input",children:[(0,_.jsxs)("label",{htmlFor:"secret",children:[" ",e("third_app.key"),":"]}),(0,_.jsx)(g.Z,{disabled:!M,type:"password",id:"secret",value:c||l})]}),(0,_.jsx)(O.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,_.jsxs)(te,{children:[(0,_.jsx)("div",{className:"tip",children:e("third_app.update_tip")}),(0,_.jsxs)("div",{className:"btns",children:[(0,_.jsx)(Q.Z,{onClick:()=>(0,z.Bn)(),className:"cancel small",children:s("action.cancel")}),(0,_.jsx)(Q.Z,{disabled:d,className:"small danger",onClick:()=>n(),children:s("action.yes")})]})]}),children:(0,_.jsxs)(Q.Z,{disabled:!M,children:[" ",e("third_app.update")]})}),(0,_.jsx)("div",{className:"tip",children:e("third_app.key_tip")})]})}var le=t(7699),ne=t.n(le),ce=t(51892),re=t(80874),oe=t(40698),de=t(80308);const Me=e=>{let{closeModal:s}=e;const{t:t}=(0,o.$)("setting"),{t:a}=(0,o.$)(),[l,{isLoading:n,isSuccess:c}]=(0,N.O2)(),[r,M]=(0,i.useState)(`${de.kd[0].pid}|${de.kd[0].limit}`);return(0,_.jsx)(re.Z,{id:"modal-modal",children:(0,_.jsx)(oe.Z,{title:t("license.renew"),description:t("license.renew_select"),buttons:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(Q.Z,{onClick:s,className:"ghost",children:a("action.cancel")}),(0,_.jsx)(Q.Z,{disabled:n||c,onClick:async()=>{const[e,s]=r.split("|"),t=await l({priceId:e,metadata:{user_limit:Number(s),expire:"2035-01-01",domain:location.hostname.startsWith("localhost")?"*":location.hostname},cancel_url:location.href,success_url:`${location.origin}/#/cb/payment_success`});"error"in t?u.ZP.error("Payment link initialized failed!"):location.href=t.data.session_url},children:n?"Initialize Payment Url":c?"Redirecting":t("license.renew")})]}),children:(0,_.jsx)(d.Z,{options:de.kd.map((e=>{let{title:s,desc:t}=e;return`${s} [${t}]`})),values:de.kd.map((e=>{let{pid:s,limit:t}=e;return`${s}|${t}`})),value:r,onChange:e=>{M(e)}})})})};var je=t(57425);const ue=e=>{let{closeModal:s,updateLicense:t,updating:a,updated:l}=e;const[n,c]=(0,i.useState)(""),{t:r}=(0,o.$)("setting"),{t:d}=(0,o.$)();return(0,i.useEffect)((()=>{l&&(u.ZP.success("Update Successfully!"),s())}),[l]),(0,_.jsx)(re.Z,{id:"modal-modal",children:(0,_.jsx)(oe.Z,{buttons:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(Q.Z,{onClick:s,className:"ghost",children:d("action.cancel")}),(0,_.jsx)(Q.Z,{disabled:a||l||!n,onClick:()=>{t(n)},children:a?"Updating":l?"Update Successfully":r("license.update")})]}),children:(0,_.jsx)(m.Z,{rows:18,placeholder:r("license.update_placeholder"),value:n,onChange:e=>{c(e.target.value)}})})})},Ne=e=>{let{label:s,data:t,foldable:i=!1,...a}=e;const l=(0,je.Z)("font-bold w-full cursor-pointer",i?" overflow-hidden text-ellipsis":"whitespace-pre-wrap break-all");return t?(0,_.jsxs)("div",{className:"whitespace-nowrap  flex flex-col items-start justify-start text-lg",children:[(0,_.jsx)("span",{className:"text-sm text-gray-400",children:s}),Array.isArray(t)?(0,_.jsx)("ul",{className:l,children:t.map((e=>(0,_.jsx)("li",{children:e},e)))}):(0,_.jsx)("span",{className:l,...a,children:t})]}):null};function xe(){const{t:e}=(0,o.$)("setting"),{license:s,reachLimit:t,upsertLicense:a,upserting:l,upserted:n}=(0,ce.Z)(),[c,r]=(0,i.useState)(!1),[d,M]=(0,i.useState)(!1),[j,u]=(0,i.useState)(!0),N=()=>{r((e=>!e))},x=()=>{M((e=>!e))};return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsxs)("div",{className:"max-w-3xl flex flex-col justify-start items-start gap-4",children:[(0,_.jsxs)("div",{className:(0,je.Z)("relative w-full p-3 rounded border-solid border flex flex-col gap-4 shadow",t?"border-red-600 bg-red-200/50":"border-green-600 bg-green-200/50"),children:[(0,_.jsx)(Ne,{label:e("license.signed"),data:null!==s&&void 0!==s&&s.sign?"Yes":"Not Yet"}),(0,_.jsx)(Ne,{label:e("license.domain"),data:null===s||void 0===s?void 0:s.domains}),(0,_.jsx)(Ne,{label:e("license.user_limit"),data:99999==(null===s||void 0===s?void 0:s.user_limit)?"No Limit":null===s||void 0===s?void 0:s.user_limit}),(0,_.jsx)(Ne,{label:e("license.expire"),data:ne()(null===s||void 0===s?void 0:s.expired_at).format("YYYY-MM-DD h:mm:ss A")}),(0,_.jsx)(Ne,{label:e("license.create"),data:ne()(null===s||void 0===s?void 0:s.created_at).format("YYYY-MM-DD h:mm:ss A")}),(0,_.jsx)(Ne,{label:e("license.value"),data:null===s||void 0===s?void 0:s.base58,foldable:j,title:j?"Click to see full text":"Click to fold text",onClick:()=>{u((e=>!e))}})]}),(0,_.jsxs)("div",{className:"flex gap-2",children:[(0,_.jsx)(Q.Z,{onClick:N,children:e("license.renew")}),(0,_.jsx)(Q.Z,{onClick:x,className:"ghost",children:e("license.update")})]}),(0,_.jsxs)("div",{className:"flex flex-col gap-4 bg-primary-500 text-white rounded drop-shadow-xl p-5",children:[(0,_.jsxs)("h2",{className:"text-2xl font-bold",children:[e("license.tip.title")," \ud83c\udf81"]}),(0,_.jsxs)("p",{className:"text-base flex flex-col",children:[(0,_.jsx)("span",{children:e("license.tip.user_test")}),(0,_.jsxs)("span",{children:[e("license.tip.booking")," ",(0,_.jsx)("a",{className:"underline text-lg text-green-200",href:"https://calendly.com/hansu/han-meeting",target:"_blank",rel:"noopener noreferrer",children:"https://calendly.com/hansu/han-meeting"})]}),(0,_.jsxs)("span",{children:[e("license.tip.wechat"),(0,_.jsx)("em",{className:"text-lg text-green-200",children:"Privoce"})]})]})]})]}),c&&(0,_.jsx)(Me,{closeModal:N}),d&&(0,_.jsx)(ue,{updated:n,updating:l,updateLicense:a,closeModal:x})]})}var ge=t(28489),De=t(61991);const me=e=>{let{paramKey:s,paramDefault:t,remarks:i}=e;return(0,_.jsxs)("tr",{className:"bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100",children:[(0,_.jsx)("td",{className:"px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900",children:s}),(0,_.jsx)("td",{className:"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap",children:t}),(0,_.jsx)("td",{className:"text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap",children:i})]})};function pe(){const{t:e}=(0,o.$)("setting",{keyPrefix:"widget"});return(0,_.jsxs)("div",{className:"flex flex-col justify-start items-start",children:[(0,_.jsx)("div",{className:"text-gray-600 ",children:e("tip")}),(0,_.jsxs)("label",{htmlFor:"code",className:"text-gray-500 text-sm mt-5",children:[e("code"),":"]}),(0,_.jsx)(ge.Z,{id:"code",language:"html",style:De.Z,className:"rounded",children:`\x3c!-- ${e("code_comment")} --\x3e\n<script \n  data-host-id="1" \n  data-close-width="48" \n  data-close-height="48" \n  data-open-width="380" \n  data-open-height="680" \n  src="${location.origin}/widget.js" \n  async \n/>`}),(0,_.jsxs)("div",{className:"text-gray-500 text-sm mt-5 mb-2",children:[e("config"),":"]}),(0,_.jsx)("div",{className:"w-[700px] border border-solid border-gray-300 rounded overflow-hidden",children:(0,_.jsxs)("table",{className:"min-w-full table-auto",children:[(0,_.jsx)("thead",{className:"border-b bg-gray-50",children:(0,_.jsx)("tr",{children:[e("param_key"),e("default_value"),e("remark")].map((e=>(0,_.jsx)("th",{scope:"col",className:"text-sm font-bold text-gray-900 px-6 py-4 text-left",children:e},e)))})}),(0,_.jsx)("tbody",{children:[{paramKey:"host-id",paramDefault:1,remarks:e("param_host")},{paramKey:"close-width",paramDefault:"48(px)",remarks:e("param_open_width")},{paramKey:"close-height",paramDefault:"48(px)",remarks:e("param_close_height")},{paramKey:"open-width",paramDefault:"380(px)",remarks:e("param_open_width")},{paramKey:"open-height",paramDefault:"680(px)",remarks:e("param_open_height")}].map((e=>(0,_.jsx)(me,{...e},e.paramKey)))}),(0,_.jsx)("tfoot",{className:"border-t border-solid border-gray-200",children:(0,_.jsx)("tr",{children:(0,_.jsxs)("td",{colSpan:3,className:"text-gray-400 px-5 py-3 text-sm",children:["* All the parameters are optional, and prefixed by ",(0,_.jsx)("i",{className:"bg-gray-700 text-white px-1",children:"data-"})]})})})]})})]})}var _e=t(51205);const he=()=>{const{t:e}=(0,o.$)("setting",{keyPrefix:"faq"}),{data:s}=(0,N.p5)();return(0,_.jsxs)("div",{className:"flex flex-col gap-3",children:[(0,_.jsxs)("div",{className:"item",children:[e("client_version"),": ","0.3.23"]}),(0,_.jsxs)("div",{className:"item",children:[e("server_version"),": ",s]}),(0,_.jsxs)("div",{className:"item",children:[e("build_time"),": ","1669701379"]})]})},Ie=[{title:"general",items:[{name:"overview",component:(0,_.jsx)(T,{})},{name:"my_account",component:(0,_.jsx)(c.Z,{})},{name:"members",component:(0,_.jsx)(_e.Z,{}),admin:!0}]},{title:"config",items:[{name:"firebase",component:(0,_.jsx)(X,{})},{name:"smtp",component:(0,_.jsx)(se,{})},{name:"login_method",component:(0,_.jsx)(J,{})},{name:"third_app",component:(0,_.jsx)(ae,{})},{name:"widget",component:(0,_.jsx)(pe,{})},{name:"license",component:(0,_.jsx)(xe,{})}],admin:!0},{title:"about",items:[{name:"faq",component:(0,_.jsx)(he,{})},{name:"terms",component:"Terms & Privacy"},{name:"feedback",component:"Email: han@privoce.com Wechat: Privoce"}]}],we=()=>{const{t:e}=(0,o.$)("setting"),s=(0,M.CG)((e=>e.authData.user));return Ie.map((s=>{const{title:t,items:i,...a}=s;return{title:e(`nav.${t}`),items:i.map((s=>{const{name:t,...i}=s;return{name:t,title:e(`nav.${t}`),...i}})),...a}})).filter((e=>!(null===s||void 0===s||!s.is_admin)||!e.admin))};var Te=t(24645),ye=t(34400);const Le=(0,r.ZP)(oe.Z)`
  .clear {
    font-weight: normal;
    font-size: 14px;
    line-height: 20px;
...
`,Ee=e=>{let{closeModal:s}=e;const{t:t}=(0,o.$)(),[a,l]=(0,i.useState)(!1),{logout:n,exited:c,exiting:r,clearLocalData:d}=(0,ye.Z)();return(0,i.useEffect)((()=>{c&&(a&&d(),u.ZP.success("Logout Successfully"))}),[c,a]),(0,_.jsx)(re.Z,{id:"modal-modal",children:(0,_.jsx)(Le,{title:"Log Out",description:"Are you sure want to log out this account?",buttons:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(Q.Z,{onClick:s,children:t("action.cancel")}),(0,_.jsx)(Q.Z,{onClick:()=>{n()},className:"danger",children:r?"Logging out":t("action.logout")})]}),children:(0,_.jsxs)("div",{className:"clear",children:[(0,_.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:"Clear local data"}),(0,_.jsx)(Te.Z,{name:"clear_cb",checked:a,onChange:e=>{l(e.target.checked)}})]})})})};let Oe="";function ze(){const{t:e}=(0,o.$)(),[s]=(0,a.lr)(),t=we(),c=t.map((e=>{let{items:s}=e;return s})).flat(),r=s.get("nav"),[d,M]=(0,i.useState)(!1),j=(0,l.s0)();Oe=Oe||(s.get("f")||"/");const u=()=>{M((e=>!e))},N=c.find((e=>e.name==r))||c[0];return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(n.Z,{nav:N,closeModal:()=>{j(Oe),Oe=""},title:e("setting"),navs:t,dangers:[{title:e("action.logout"),handler:u}],children:N.component}),d&&(0,_.jsx)(Ee,{closeModal:u})]})}}}]);