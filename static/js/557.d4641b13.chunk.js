...
`,o=e=>{let{url:i="",name:s="",type:a="user",uploadImage:o,disabled:d=!1}=e;const[M,x]=(0,t.useState)(!1);return(0,c.jsxs)(r,{children:[(0,c.jsxs)("div",{className:"avatar",children:[(0,c.jsx)(n.Z,{type:a,url:i,name:s}),!d&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("div",{className:"tip",children:M?"Uploading":"Change Avatar"}),(0,c.jsx)("input",{multiple:!1,onChange:async e=>{if(M)return;if(!e.target.files)return;const[i]=Array.from(e.target.files);x(!0),await o(i),x(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,c.jsx)("img",{src:l,alt:"icon",className:"icon"})]})}},6047:(e,i,s)=>{s.d(i,{Z:()=>z});var t=s(7313),a=s(9184),n=s(2963),l=s(9784),c=s(3657),r=s(6123),o=s(5515),d=s(5281),M=s(3165),x=s(4050),u=s(1140),j=s(6417);const N=a.ZP.div`
  display: flex;
...
`;function z(e){var i;let{cid:s=0}=e;const{contacts:a,channels:M,loginUser:x}=(0,f.CG)((e=>({contacts:e.contacts,channels:e.channels,loginUser:e.authData.user}))),{copyEmail:u,removeFromChannel:N,removeUser:p,canRemove:m,canRemoveFromChannel:w}=(0,y.Z)({cid:s}),[I,{isSuccess:z}]=(0,r.wv)();(0,t.useEffect)((()=>{z&&c.ZP.success("Update Successfully")}),[z]);const E=e=>{let{ignore:i=!1,uid:s=null,isAdmin:t=!0}=e;(0,l.Bn)(),i||I({id:s,is_admin:t})},O=null!==(i=M.byId[s])&&void 0!==i?i:null,b=O?O.is_public?a.ids:O.members:a.ids;return(0,j.jsxs)(L,{children:[(null===x||void 0===x?void 0:x.is_admin)&&(0,j.jsx)(g,{}),(0,j.jsxs)("div",{className:"intro",children:[(0,j.jsx)("h4",{className:"title",children:"Manage Members"}),(0,j.jsx)("p",{className:"desc",children:"Disabling your account means you can recover it at any time after taking this action."})]}),(0,j.jsx)("ul",{className:"members",children:b.map((e=>{const{name:i,email:t,is_admin:l}=a.byId[e],c=O&&O.owner==e,r=x.is_admin&&x.uid!==e,M=t||(null===x||void 0===x?void 0:x.is_admin);return(0,j.jsxs)("li",{className:"member",children:[(0,j.jsxs)("div",{className:"left",children:[(0,j.jsx)(o.Z,{compact:!0,uid:e,interactive:!1}),(0,j.jsxs)("div",{className:"info",children:[(0,j.jsxs)("span",{className:"name",children:[i," ",c&&(0,j.jsx)(h.Z,{})]}),(0,j.jsx)("span",{className:"email",children:t})]})]}),(0,j.jsxs)("div",{className:"right",children:[(0,j.jsxs)("span",{className:"role",children:[l?"Admin":"User",r&&(0,j.jsx)(n.ZP,{interactive:!0,placement:"bottom-end",trigger:"click",content:(0,j.jsxs)(d.Z,{className:"menu",children:[(0,j.jsxs)("li",{className:"item sb",onClick:E.bind(null,{ignore:l,uid:e,isAdmin:!0}),children:["Admin",l&&(0,j.jsx)(T.Z,{className:"icon"})]}),(0,j.jsxs)("li",{className:"item sb",onClick:E.bind(null,{ignore:!l,uid:e,isAdmin:!1}),children:["User",!l&&(0,j.jsx)(T.Z,{className:"icon"})]})]}),children:(0,j.jsx)(_,{className:"icon"})})]}),M&&(0,j.jsx)(n.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,j.jsxs)(d.Z,{className:"menu",children:[t&&(0,j.jsx)("li",{className:"item",onClick:u.bind(null,t),children:"Copy Email"}),w&&(0,j.jsx)("li",{className:"item danger",onClick:N.bind(null,e),children:"Remove From Channel"}),m&&!s&&(0,j.jsx)("li",{className:"item danger",onClick:p.bind(null,e),children:"Remove From Server"})]}),children:(0,j.jsx)("div",{className:"opts",children:(0,j.jsx)("img",{className:"dots",src:D,alt:"dots icon"})})})]})]},e)}))})]})}},5579:(e,i,s)=>{s.d(i,{Z:()=>l});var t=s(9184),a=s(6417);const n=t.ZP.div`
  width: 100%;
  position: absolute;
  bottom: 64px;
  left: 0;
...
`,c={},r={};function o(e){let{options:i,values:s=r,value:a=c,defaultValue:o,onChange:d}=e;const M=(0,t.useId)(),[x,u]=(0,t.useState)(o),j=a!==c?a:x;return(0,n.jsx)(l,{children:i.map(((e,i)=>(0,n.jsxs)("div",{className:"option",children:[(0,n.jsx)("input",{type:"radio",checked:(s!==r?s.indexOf(j):j)===i,onChange:()=>{const e=s===r?i:s[i];a===c&&u(e),d&&d(e)},id:`${M}-${i}`}),(0,n.jsx)("div",{className:"box",children:(0,n.jsx)("label",{htmlFor:`${M}-${i}`,children:e})})]},i)))})}},4458:(e,i,s)=>{s.d(i,{Z:()=>t});const t=s(9184).ZP.textarea`
  font-family: inherit;
  width: 100%;
  background: #ffffff;
  border: 1px solid #e5e7eb;
...
`;function u(e){let{label:i="Username",valueKey:s="name",value:a="",title:r="Change your username",intro:u="Enter a new username and your existing password.",closeModal:j}=e;const[N,g]=(0,t.useState)(a),[p,{isLoading:m,isSuccess:D}]=(0,c.g$)();return(0,t.useEffect)((()=>{D&&(n.ZP.success("update user info successfully"),j())}),[D]),(0,M.jsx)(d.Z,{id:"modal-modal",children:(0,M.jsx)(x,{title:r,description:u,buttons:(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o.Z,{className:"cancel",onClick:j,children:"Cancel"}),(0,M.jsx)(o.Z,{onClick:()=>{p({[s]:N})},children:m?"Updating":"Done"})]}),children:(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:s,children:i}),(0,M.jsx)(l.Z,{name:s,value:N,onChange:e=>{g(e.target.value)}})]})})})}},5883:(e,i,s)=>{s.d(i,{Z:()=>u});var t=s(7313),a=s(9184),n=s(3657),l=s(4050),c=s(2509),r=s(6571),o=s(1140),d=s(666),M=s(6417);const x=(0,a.ZP)(r.Z)`
  .input {
    margin: 16px 0;
    width: 100%;
    display: flex;
...
`,u=e=>{let{closeModal:i}=e;const{data:s}=(0,c.I1)(),[a,r]=(0,t.useState)({current:"",newPassword:"",confirmPassword:""}),[u,{isLoading:j,isSuccess:N}]=(0,c.a3)(),g=e=>{const{type:i}=e.target.dataset;r((s=>({...s,[i]:e.target.value})))};(0,t.useEffect)((()=>{N&&(n.ZP.success("update password successfully"),i())}),[N]);const{current:p,newPassword:m,confirmPassword:D}=a,h=(null===s||void 0===s?void 0:s.password)&&!p||!m||!D||m!==D||j;return(0,M.jsx)(d.Z,{id:"modal-modal",children:(0,M.jsxs)(x,{title:"Change your password",description:"Enter current password and new password.",buttons:(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o.Z,{className:"cancel",onClick:i,children:"Cancel"}),(0,M.jsx)(o.Z,{disabled:h,onClick:()=>{const{current:e,newPassword:i}=a;u({old_password:e,new_password:i})},children:j?"Updating":"Update"})]}),children:[(null===s||void 0===s?void 0:s.password)&&(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:"current",children:"Current Password"}),(0,M.jsx)(l.Z,{type:"password",id:"current",name:"current",value:p,"data-type":"current",onChange:g})]}),(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:"newPassword",children:"New Password"}),(0,M.jsx)(l.Z,{type:"password",name:"newPassword",value:m,"data-type":"newPassword",onChange:g})]}),(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:"confirmPassword",children:"Confirm New Password"}),(0,M.jsx)(l.Z,{onBlur:()=>{const{newPassword:e,confirmPassword:i}=a;e!==i&&n.ZP.error("Not same with new password")},type:"password",name:"confirmPassword",value:D,"data-type":"confirmPassword",onChange:g})]})]})})}},1390:(e,i,s)=>{s.r(i),s.d(i,{default:()=>Ne});var t=s(7313),a=s(9466),n=s(7890),l=s(5638),c=s(6880),r=s(9184),o=s(3657),d=s(2378),M=s(3960),x=s(4050),u=s(7169),j=s(4458),N=s(5579),g=s(643),p=s(8529),m=s(6417);const D=r.ZP.div`
  position: relative;
  width: 512px;
  height: 100%;
  display: flex;
...
`;function h(){const{loginUser:e,server:i}=(0,p.CG)((e=>({loginUser:e.authData.user,server:e.server}))),[s,a]=(0,t.useState)(!1),[n,l]=(0,t.useState)(i),[c,r]=(0,t.useState)(null),{data:h,refetch:w}=(0,d.ww)(),[I,{isSuccess:_}]=(0,d.e2)(),[T,{isSuccess:y}]=(0,d.jd)(),[f,{isSuccess:L}]=(0,d.QP)(),z=e=>{const i=e.target.value,{type:s}=e.target.dataset;l((e=>({...e,[s]:i})))};if((0,t.useEffect)((()=>{y&&o.ZP.success("Update logo successfully!")}),[y]),(0,t.useEffect)((()=>{i&&l(i)}),[i]),(0,t.useEffect)((()=>{h&&r(h)}),[h]),(0,t.useEffect)((()=>{if(i&&n&&h&&c){const{name:e,description:s}=n,{name:t,description:l}=i,{who_can_sign_up:r}=c,{who_can_sign_up:o}=h;a(t!==e||l!==s||o!==r)}}),[i,n,h,c]),(0,t.useEffect)((()=>{_&&L&&(o.ZP.success("Configuration updated!"),w())}),[_,L]),!n||!c)return null;const{name:E,description:O,logo:b}=n,{who_can_sign_up:v}=c,C=null===e||void 0===e?void 0:e.is_admin;return(0,m.jsxs)(D,{children:[(0,m.jsxs)("div",{className:"logo",children:[(0,m.jsx)("div",{className:"preview",children:(0,m.jsx)(M.Z,{disabled:!C,url:y?`${b}?t=${+new Date}`:b,name:E,uploadImage:T})}),C&&(0,m.jsx)("div",{className:"upload",children:(0,m.jsx)("div",{className:"tip",children:"Minimum size is 128x128, We recommend at least 512x512 for the server. Max size limited to 5M."})})]}),(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"name",children:"Server Name"}),(0,m.jsx)(x.Z,{disabled:!C,"data-type":"name",onChange:z,value:E,name:"name",id:"name",placeholder:"Server Name"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Server Description"}),(0,m.jsx)(j.Z,{disabled:!C,"data-type":"description",onChange:z,value:null!==O&&void 0!==O?O:"",rows:4,name:"name",id:"name",placeholder:"Tell the world a bit about this server"})]}),C&&(0,m.jsxs)("div",{className:"radioButton",children:[(0,m.jsx)("p",{className:"label",children:"Default Sign Up"}),(0,m.jsx)("p",{className:"tip",children:"Who can sign up this server."}),(0,m.jsx)(g.Z,{options:["Everyone","Invitation Link Only"],values:["EveryOne","InvitationOnly"],value:v,onChange:e=>r({...h,who_can_sign_up:e})})]})]}),s&&(0,m.jsx)(N.Z,{saveHandler:()=>{const{name:i,description:s}=n;I({name:i,description:s}),null!==e&&void 0!==e&&e.is_admin&&f({...h,who_can_sign_up:c.who_can_sign_up})},resetHandler:()=>{l(i),r(h)}})]})}const w=r.ZP.div`
  position: relative;
  width: 512px;
  height: 100%;
  display: flex;
...
`;function b(e){let{link:i="#"}=e;return(0,m.jsx)(y.ZP,{delay:[0,500],interactive:!0,arrow:f.ki,placement:"bottom",content:(0,m.jsxs)(O,{children:["Need more detail? See our"," ",(0,m.jsx)("a",{target:"doc",href:i,children:"doc"}),"."]}),children:(0,m.jsx)(E,{className:"icon"})})}var v=s(552),C=s(746),A=s(5281);const k=r.ZP.div`
  user-select: none;
  border: 1px solid #e5e7eb;
  border-radius: 4px;
  padding: 8px;
...
`;var Q;function B(){return B=Object.assign||function(e){for(var i=1;i<arguments.length;i++){var s=arguments[i];for(var t in s)Object.prototype.hasOwnProperty.call(s,t)&&(e[t]=s[t])}return e},B.apply(this,arguments)}const R=(e,i)=>{let{title:s,titleId:a,...n}=e;return t.createElement("svg",B({width:16,height:16,viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",ref:i,"aria-labelledby":a},n),s?t.createElement("title",{id:a},s):null,Q||(Q=t.createElement("path",{d:"M8.00004 1.33301C4.32004 1.33301 1.33337 4.31967 1.33337 7.99967C1.33337 11.6797 4.32004 14.6663 8.00004 14.6663C11.68 14.6663 14.6667 11.6797 14.6667 7.99967C14.6667 4.31967 11.68 1.33301 8.00004 1.33301ZM11.3334 8.66634H4.66671V7.33301H11.3334V8.66634Z",fill:"#D0D5DD"})))},G=(0,t.forwardRef)(R);function W(e){let{issuers:i=[],onChange:s}=e;const[a,n]=(0,t.useState)({}),[l,c]=(0,t.useState)(""),r=!l&&!(null!==a&&void 0!==a&&a.value)||!(null!==a&&void 0!==a&&a.title)||i.some((e=>e.domain===l));return(0,m.jsx)(Y,{children:(0,m.jsxs)("ul",{className:"issuers",children:[i.map((e=>{let{enable:t,favicon:a,domain:n}=e;return(0,m.jsxs)("li",{className:"issuer",children:[(0,m.jsxs)("div",{className:"left",children:[(0,m.jsx)(G,{className:"remove",onClick:()=>{s(i.filter((e=>e.domain!==n)))}}),(0,m.jsxs)("div",{className:"data",children:[Boolean(a)&&(0,m.jsx)("img",{src:a,alt:"logo",className:"icon"}),(0,m.jsx)(x.Z,{readOnly:!0,value:n,prefix:"https://",placeholder:"Issuer Domain",className:"url"})]})]}),(0,m.jsx)("div",{className:"right",children:(0,m.jsx)(I,{"data-checked":t,onClick:()=>{s(i.map((e=>({...e,enable:e.domain===n?!t:e.enable}))))}})})]},n)})),(0,m.jsxs)("li",{className:"issuer add",children:[(0,m.jsxs)("div",{className:"left",children:[(0,m.jsx)(S,{options:Z.map((e=>({...e,selected:i.some((i=>i.domain===e.value))}))),current:a,updateSelect:n}),(0,m.jsx)("div",{className:"data",children:(0,m.jsx)(x.Z,{onChange:e=>{c(e.target.value)},readOnly:!(null===a||void 0===a||!a.value),value:(null===a||void 0===a?void 0:a.value)||l,prefix:"https://",placeholder:"domain.com",className:"url"})})]}),(0,m.jsx)("div",{className:"right",children:(0,m.jsx)(P.Z,{disabled:r,onClick:()=>{const{icon:e,value:t}=Z.find((e=>e.value===a.value));s(i.concat({enable:!0,favicon:e||"",domain:t||l})),n({}),c("")},children:"Add"})})]})]})})}var K=s(9137),F=s(1923);function H(){const{changed:e,clientId:i,updateClientId:s,updateClientIdToServer:t}=(0,K.Z)(),{config:a,changed:n,updateGithubAuthConfigToServer:l,updateGithubAuthConfig:c}=(0,F.Z)(),{values:r,updateConfig:d,setValues:M,reset:j,changed:g}=(0,T.Z)("login"),p=e=>{const{key:i}=e.target.dataset;i&&c({[i]:e.target.value})},D=e=>{M((i=>({...i,...e})))};if(!r)return null;const{google:h,magic_link:_,github:y,metamask:f,password:L,oidc:z=[]}=null!==r&&void 0!==r?r:{},E=e||g||n;return(0,m.jsxs)(w,{children:[(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsx)("div",{className:"input",children:(0,m.jsxs)("div",{className:"row",children:[(0,m.jsxs)("div",{className:"title",children:[(0,m.jsx)("div",{className:"txt",children:(0,m.jsx)(u.Z,{children:"Password"})}),(0,m.jsx)("span",{className:"desc",children:"Allows members login with password."})]}),(0,m.jsx)(I,{onClick:D.bind(null,{password:!L}),"data-checked":L})]})}),(0,m.jsx)("div",{className:"input",children:(0,m.jsxs)("div",{className:"row",children:[(0,m.jsxs)("div",{className:"title",children:[(0,m.jsx)("div",{className:"txt",children:(0,m.jsx)(u.Z,{children:"Magic Link"})}),(0,m.jsx)("span",{className:"desc",children:"Allows members login with Magic Link."})]}),(0,m.jsx)(I,{onClick:D.bind(null,{magic_link:!_}),"data-checked":_})]})}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsxs)("div",{className:"row",children:[(0,m.jsxs)("div",{className:"title",children:[(0,m.jsxs)("div",{className:"txt",children:[(0,m.jsx)(u.Z,{children:"Google"}),(0,m.jsx)(b,{link:"https://doc.voce.chat/en-us/login-google.html"})]}),(0,m.jsx)("span",{className:"desc",children:"Allows members login with Google."})]}),(0,m.jsx)(I,{onClick:D.bind(null,{google:!h}),"data-checked":h})]}),(0,m.jsx)("div",{className:"row",children:(0,m.jsx)(x.Z,{disabled:!h,onChange:e=>{s(e.target.value)},placeholder:"Client ID",value:i})})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsxs)("div",{className:"row",children:[(0,m.jsxs)("div",{className:"title",children:[(0,m.jsxs)("div",{className:"txt",children:[(0,m.jsx)(u.Z,{children:"Github"}),(0,m.jsx)(b,{link:"https://doc.voce.chat/en-us/login-github.html"})]}),(0,m.jsx)("span",{className:"desc",children:"Allows members login with Github."})]}),(0,m.jsx)(I,{onClick:D.bind(null,{github:!y}),"data-checked":y})]}),(0,m.jsxs)("div",{className:"row inputs",children:[(0,m.jsx)(x.Z,{disabled:!y,"data-key":"client_id",onChange:p,placeholder:"Github Client ID",value:null===a||void 0===a?void 0:a.client_id}),(0,m.jsx)(x.Z,{disabled:!y,"data-key":"client_secret",onChange:p,placeholder:"Github Client Secret",value:null===a||void 0===a?void 0:a.client_secret})]})]}),(0,m.jsx)("div",{className:"input",children:(0,m.jsxs)("div",{className:"row",children:[(0,m.jsxs)("div",{className:"title",children:[(0,m.jsxs)("div",{className:"txt",children:[(0,m.jsx)(u.Z,{children:"Metamask"}),(0,m.jsx)(b,{link:"https://doc.voce.chat/en-us/login-metamask.html"})]}),(0,m.jsx)("span",{className:"desc",children:"Allows members login with Metamask."})]}),(0,m.jsx)(I,{onClick:D.bind(null,{metamask:!f}),"data-checked":f})]})}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)("div",{className:"row",children:(0,m.jsxs)("div",{className:"title",children:[(0,m.jsxs)("div",{className:"txt",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"OIDC"}),(0,m.jsx)(b,{link:"https://doc.voce.chat/en-us/login-webid.html"})]}),(0,m.jsx)("span",{className:"desc",children:"Save my login details for next time."})]})}),(0,m.jsx)("div",{className:"row",children:(0,m.jsx)(W,{issuers:z,onChange:e=>{M((i=>({...i,oidc:e})))}})})]})]}),E&&(0,m.jsx)(N.Z,{saveHandler:async()=>{const{google:i}=r;g&&d(r),i&&e&&(await t(),g||o.ZP.success("Configuration Updated!")),y&&n&&(await l(),g||o.ZP.success("Configuration Updated!"))},resetHandler:j})]})}function J(){const{values:e,toggleEnable:i,updateConfig:s,setValues:t,reset:a,changed:n}=(0,T.Z)("firebase"),l=e=>{const i=e.target.value,{type:s}=e.target.dataset;t((e=>({...e,[s]:i})))},{token_url:c,project_id:r,private_key:o,client_email:d,enabled:M=!1}=null!==e&&void 0!==e?e:{};return(0,m.jsxs)(w,{children:[(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input row",children:[(0,m.jsx)(u.Z,{children:"Enable"}),(0,m.jsx)(I,{onClick:i,"data-checked":M})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"name",children:"Token Url"}),(0,m.jsx)(x.Z,{disabled:!M,"data-type":"token_url",onChange:l,value:c||"https://oauth2.googleapis.com/token",name:"token_url",placeholder:"Token URL"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Project ID"}),(0,m.jsx)(x.Z,{disabled:!M,"data-type":"project_id",onChange:l,value:r,name:"project_id",placeholder:"Project ID"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Private Key"}),(0,m.jsx)(j.Z,{rows:10,disabled:!M,"data-type":"private_key",onChange:l,value:o,name:"private_key",placeholder:"Private key"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Client Email"}),(0,m.jsx)(x.Z,{disabled:!M,"data-type":"client_email",onChange:l,value:d,name:"client_email",placeholder:"Client Email address"})]})]}),n&&(0,m.jsx)(N.Z,{saveHandler:()=>{s(e)},resetHandler:a})]})}const V=s.p+"static/media/question.f1e6b7aab95b0ab2de07.svg",X=r.ZP.div`
  display: flex;
  gap: 16px;
  white-space: nowrap;
  margin-top: 24px;
`;function q(){const[e,i]=(0,t.useState)(""),[s,{isSuccess:a,isError:n}]=(0,d.D$)(),{reset:l,updateConfig:c,values:r,setValues:M,changed:j,toggleEnable:g}=(0,T.Z)("smtp"),p=e=>{const i=e.target.value,{type:s}=e.target.dataset;M((e=>({...e,[s]:i})))};(0,t.useEffect)((()=>{a&&o.ZP.success("Send Test Email Successfully"),n&&o.ZP.error("Send Test Email Fail")}),[a,n]);const{host:D,port:h,from:_,username:y,password:f,enabled:L=!1}=null!==r&&void 0!==r?r:{};return(0,m.jsxs)(w,{children:[(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input row",children:[(0,m.jsx)(u.Z,{children:"Enable"}),(0,m.jsx)(I,{onClick:g,"data-checked":L})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"name",children:"Host"}),(0,m.jsx)(x.Z,{disabled:!L,"data-type":"host",onChange:p,value:D,name:"host",placeholder:"SMTP Host"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Port"}),(0,m.jsx)(x.Z,{disabled:!L,type:"number","data-type":"port",onChange:p,value:h,name:"port",placeholder:"SMTP Port"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"From"}),(0,m.jsx)(x.Z,{disabled:!L,"data-type":"from",onChange:p,value:_,name:"from",placeholder:"SMTP From"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Username"}),(0,m.jsx)(x.Z,{disabled:!L,"data-type":"username",onChange:p,value:y,name:"username",placeholder:"SMTP Username"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"desc",children:"Password"}),(0,m.jsx)(x.Z,{type:"password",disabled:!L,"data-type":"password",onChange:p,value:f,name:"password",placeholder:"SMTP Password"})]})]}),(0,m.jsxs)("div",{className:"tip",children:[(0,m.jsx)("img",{src:V,alt:"question icon"}),(0,m.jsx)("a",{href:"https://voce.chat/doc/smtp-setting",target:"_blank",className:"link",rel:"noreferrer",children:"How to set up SMTP?"})]}),(0,m.jsxs)(X,{children:[(0,m.jsx)(x.Z,{type:"email",disabled:!L,onChange:e=>{const s=e.target.value;i(s)},value:e,name:"email",placeholder:"test@email.com"}),(0,m.jsx)(P.Z,{disabled:!L||!e,onClick:()=>{s({to:e,subject:"test title",content:"test content"})},children:"Send Test Email"})]}),j&&(0,m.jsx)(N.Z,{saveHandler:()=>{var e;c({...r,port:Number(null!==(e=r.port)&&void 0!==e?e:0)})},resetHandler:l})]})}const $=r.ZP.div`
  padding: 12px;
  border-radius: 10px;
...
`;function ie(){const{data:e}=(0,d.BL)(),[i,{data:s,isSuccess:a,isLoading:n}]=(0,d.gU)();return(0,t.useEffect)((()=>{a&&((0,f.Bn)(),o.ZP.success("Update API Secret Successfully!"))}),[a]),(0,m.jsxs)(ee,{children:[(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)("label",{htmlFor:"secret",children:"API Secure Key:"}),(0,m.jsx)(x.Z,{type:"password",id:"secret",value:s||e})]}),(0,m.jsx)(y.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,m.jsxs)($,{children:[(0,m.jsx)("div",{className:"tip",children:"Are you sure to update API secret? Previous secret will be invalided"}),(0,m.jsxs)("div",{className:"btns",children:[(0,m.jsx)(P.Z,{onClick:f.Bn,className:"cancel small",children:"Cancel"}),(0,m.jsx)(P.Z,{disabled:n,className:"small danger",onClick:i,children:"Yes"})]})]}),children:(0,m.jsx)(P.Z,{children:"Update Secret"})}),(0,m.jsxs)("div",{className:"tip",children:["Tip: The security key agreed between the server and the third-party app is used to encrypt the communication data."," "]})]})}var se=s(6047);const te=r.ZP.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`;function ae(){const{data:e}=(0,d.p5)();return(0,m.jsxs)(te,{children:[(0,m.jsxs)("div",{className:"item",children:["Client Version: ","0.3.1"]}),(0,m.jsxs)("div",{className:"item",children:["Server Version: ",e]}),(0,m.jsxs)("div",{className:"item",children:["Build Timestamp: ","1656479044"]})]})}function ne(){const{changed:e,reset:i,values:s,setValues:t,toggleEnable:a,updateConfig:n}=(0,T.Z)("agora"),l=e=>{const i=e.target.value,{type:s}=e.target.dataset;t((e=>({...e,[s]:i})))},{url:c,project_id:r,app_id:o,app_certificate:d,rtm_key:M,rtm_secret:g,enabled:p=!1}=null!==s&&void 0!==s?s:{};return(0,m.jsxs)(w,{children:[(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input row",children:[(0,m.jsx)(u.Z,{children:"Enable"}),(0,m.jsx)(I,{onClick:a,"data-checked":p})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"url",children:"Agora Url"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"url",onChange:l,value:c||"https://api.agora.io",name:"url",placeholder:"Agora URL"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"project_id",children:"Project ID"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"project_id",onChange:l,value:r,name:"project_id",placeholder:"Project ID"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"app_id",children:"App ID"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"app_id",onChange:l,value:o,name:"app_id",placeholder:"APP ID"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"app_certificate",children:"APP Certificate"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"app_certificate",onChange:l,value:d,name:"app_certificate",placeholder:"APP Certificate"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"rtm_key",children:"RTM Key"}),(0,m.jsx)(j.Z,{disabled:!p,"data-type":"rtm_key",onChange:l,value:M,name:"rtm_key",placeholder:"RTM Key"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(u.Z,{htmlFor:"rtm_secret",children:"RTM Secret"}),(0,m.jsx)(j.Z,{disabled:!p,"data-type":"rtm_secret",onChange:l,value:g,name:"rtm_secret",placeholder:"RTM Secret"})]})]}),e&&(0,m.jsx)(N.Z,{saveHandler:()=>{n(s)},resetHandler:i})]})}const le=[{title:"General",items:[{name:"overview",title:"Overview",component:(0,m.jsx)(h,{})},{name:"members",title:"Members",component:(0,m.jsx)(se.Z,{}),admin:!0}]},{title:"User",items:[{name:"my_account",title:"My Account",component:(0,m.jsx)(c.Z,{})}]},{title:"Configuration",items:[{name:"firebase",title:"Firebase",component:(0,m.jsx)(J,{})},{name:"agora",title:"Agora",component:(0,m.jsx)(ne,{})},{name:"smtp",title:"SMTP",component:(0,m.jsx)(q,{})},{name:"social_login",title:"Login Methods",component:(0,m.jsx)(H,{})},{name:"api",title:"Third-party APP",component:(0,m.jsx)(ie,{})}],admin:!0},{title:"About",items:[{name:"faq",title:"FAQ",component:(0,m.jsx)(ae,{})},{name:"terms",title:"Terms & Privacy",component:"Terms & Privacy"},{name:"feedback",title:"Feedback",component:"feedback"}]}],ce=()=>{const e=(0,p.CG)((e=>e.authData.user));return le.filter((i=>!(null===e||void 0===e||!e.is_admin)||!i.admin))};var re=s(6571),oe=s(3215),de=s(310),Me=s(666);const xe=(0,r.ZP)(re.Z)`
  .clear {
    font-weight: normal;
    font-size: 14px;
    line-height: 20px;
...
`;function ue(e){let{closeModal:i}=e;const[s,a]=(0,t.useState)(!1),{logout:n,exited:l,exiting:c,clearLocalData:r}=(0,de.Z)();return(0,t.useEffect)((()=>{l&&(s&&r(),o.ZP.success("Logout Successfully"),setTimeout((()=>{location.href=`${location.origin}#/login`}),500))}),[l,s]),(0,m.jsx)(Me.Z,{id:"modal-modal",children:(0,m.jsx)(xe,{title:"Log Out",description:"Are you sure want to log out this account?",buttons:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(P.Z,{onClick:i,children:"Cancel"}),(0,m.jsx)(P.Z,{onClick:()=>{n()},className:"danger",children:c?"Logging out":"Log Out"})]}),children:(0,m.jsxs)("div",{className:"clear",children:[(0,m.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:"Clear local data"}),(0,m.jsx)(oe.Z,{name:"clear_cb",checked:s,onChange:e=>{a(e.target.checked)}})]})})})}let je=null;function Ne(){var e;const[i]=(0,a.lr)(),s=ce(),c=s.map((e=>{let{items:i}=e;return i})).flat(),r=i.get("nav");je=null!==(e=je)&&void 0!==e?e:i.get("f")||"/";const[o,d]=(0,t.useState)(!1),M=(0,n.s0)(),x=()=>{d((e=>!e))},u=c.find((e=>e.name==r))||c[0];return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(l.Z,{nav:u,closeModal:()=>{M(je),je=null},title:"Settings",navs:s,dangers:[{title:"Log Out",handler:x}],children:u.component}),o&&(0,m.jsx)(ue,{closeModal:x})]})}}}]);