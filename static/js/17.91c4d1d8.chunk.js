...
`,v=()=>{const{pathname:e}=(0,a.TH)();return(0,d.jsx)(f,{children:(0,d.jsx)("li",{className:"menu link_navs",children:(0,d.jsx)(n.OL,{className:"link",to:`/setting?f=${e}`,children:(0,d.jsx)(g.Z,{placement:"right",tip:"Settings",children:(0,d.jsx)("img",{src:m,alt:"setting icon",className:"w-6 h-6 max-w-[unset]"})})})})})};var x=s(7699),b=s.n(x),w=s(98090),C=s.n(w),k=s(3074),j=s(96157),y=s(2101),_=s(53517),E=s(1823),L=s(88332),N=s(53429),O=s(27197),Z=s(81980),S=s(75265),M=s(12564);const P=()=>{const[e,t]=(0,r.useState)(!1),s=(0,k.I0)();return{rehydrate:async()=>{const e={channels:[],users:[],fileMessage:{},channelMessage:{},userMessage:{},reactionMessage:{},message:{replying:{}},footprint:{},ui:{},server:{}},r=Object.keys(window.CACHE);await Promise.all(r.map((t=>{var s;return null===(s=window.CACHE[t])||void 0===s?void 0:s.iterate(((s,r)=>{switch(t){case"channels":s&&e.channels.push(s);break;case"users":s&&e.users.push(s);break;case"footprint":e.footprint[r]=s;break;case"ui":e.ui[r]=s;break;case"messageChannel":e.channelMessage[r]=s;break;case"messageFile":e.fileMessage[r]=s||[];break;case"messageDM":e.userMessage[r]=s;break;case"messageReaction":e.reactionMessage[r]=s;break;case"message":e.message[r]=s;break;case"server":e.server[r]=s}}))}))),s((0,O.i2)(e.users)),s((0,y.tD)(e.server)),s((0,N.vB)(e.channels)),s((0,S.Cb)(e.fileMessage.list)),s((0,E.sL)(e.channelMessage)),s((0,L.Cc)(e.userMessage)),s((0,_.KC)(e.message)),s((0,Z.ZN)(e.footprint)),s((0,M.HM)(e.ui)),s((0,j.kY)(e.reactionMessage)),t(!0)},rehydrated:e}};var D=s(80308);const I=[{storeName:"channels",description:"store channel list"},{storeName:"users",description:"store user list"},{storeName:"messageDM",description:"store DM message with IDs"},{storeName:"messageChannel",description:"store channel message with IDs"},{storeName:"message",description:"store message with key-val full data"},{storeName:"messageFile",description:"store file message list refs"},{storeName:"messageReaction",description:"store message reaction with key-val full data"},{storeName:"footprint",description:"store user visit data"},{storeName:"server",description:"store server data"},{storeName:"ui",description:"store UI state"}],T=()=>{const e=`local_db_${localStorage.getItem(D.kK)||""}_v_${D.YM.split(".").join("_")}`;window.CACHE={},I.forEach((t=>{let{storeName:s,description:r}=t;window.CACHE[s]=C().createInstance({name:e,storeName:s,description:r})}))};var R=s(24783),B=s(52334),H=s(65809),U=s(27418),G=s(21645),$=s(64488),A=s(38289),V=s(15312);let F,W=null,z=!1,K=0;function Q(){var e;const[t,{isLoading:s}]=(0,V.SO)(),[a,n]=(0,r.useState)(!1),{authData:i,ui:{ready:o},footprint:{afterMid:l,usersVersion:d,readUsers:u,readChannels:p}}=(0,c.CG)((e=>e)),h=(0,c.TL)(),g=(null===(e=i.user)||void 0===e?void 0:e.uid)||0,m=(0,r.useCallback)((()=>{if(window.clearTimeout(K),s)return;if(F&&(F.readyState===EventSource.OPEN||F.readyState===EventSource.CONNECTING))return;const{token:e="",refreshToken:r,expireTime:a=+new Date}=i;if(!e)return;if(b()().isAfter(new Date(a-2e4)))return void t({token:e,refresh_token:r});const n={"api-key":e};0!==l&&(n.after_mid=`${l}`),0!==d&&(n.users_version=`${d}`),F=new EventSource(`${D.ZP}/user/events?${(e=>{const t=new URLSearchParams;return Object.entries(e).forEach((e=>{let[s,r]=e;r&&t.append(s,r)})),t.toString()})(n)}`),F.onopen=()=>{z=!0},F.onerror=e=>{const{readyState:t}=e.target;t!==EventSource.OPEN&&t!==EventSource.CONNECTING&&(W&&window.clearTimeout(W),W=window.setTimeout((()=>{m()}),1e3))},F.onmessage=e=>{const t=JSON.parse(e.data),{type:s}=t;switch(s){case"heartbeat":window.clearTimeout(K),K=window.setTimeout((()=>{f(),m()}),17e3);break;case"ready":h((0,M.Uc)());break;case"users_snapshot":{const{version:e}=t;h((0,Z.uM)(e))}break;case"users_log":{const{logs:e}=t;h((0,O.ii)(e)),e.forEach((e=>{const{uid:t,action:s,log_id:r,...a}=e;t===g&&"update"===s&&h((0,G.L2)((0,A.omitBy)(a,A.isNull)))}))}break;case"user_settings":case"user_settings_changed":Object.keys(t).forEach((e=>{switch(e){case"read_index_groups":h((0,Z.TP)(t[e]));break;case"read_index_users":h((0,Z.RT)(t[e]));break;case"add_mute_users":case"mute_users":case"add_mute_groups":case"mute_groups":{const s=t[e];if(s&&s.length){const t=e.endsWith("users")?"add_users":"add_groups";h((0,Z.Uw)({[t]:s}))}}break;case"remove_mute_users":case"remove_mute_groups":{const s=t[e];if(s&&s.length){const t=e.endsWith("users")?"remove_users":"remove_groups";h((0,Z.Uw)({[t]:s}))}}}}));break;case"users_state":case"users_state_changed":{let{type:e,...s}=t;const r="users_state_changed"==e?[s]:s.users;h((0,O._D)(r))}break;case"kick":switch(t.reason){case"login_from_other_device":h((0,G.sQ)()),(0,U.ZP)("kicked from the other device");break;case"delete_user":h((0,G.sQ)()),(0,U.ZP)("Your account has been deleted")}break;case"related_groups":h((0,N.vB)(t.groups));break;case"joined_group":h((0,N.mR)(t.group));break;case"group_changed":{const{gid:e,...s}=t;h((0,N.pW)({gid:e,...s}))}break;case"user_joined_group":{const{gid:e,uid:s}=t;h((0,N.pW)({operation:"add_member",gid:e,members:s}))}break;case"user_leaved_group":{const{gid:e,uid:s}=t;s.findIndex((e=>e==g))>-1?h((0,N.OG)(e)):h((0,N.pW)({operation:"remove_member",gid:e,members:s}))}break;case"kick_from_group":h((0,N.OG)(t.gid));break;case"pinned_message_updated":h((0,N.ac)(t));break;case"chat":(0,$.Z)(t,h,{ready:o,loginUid:g,readUsers:u,readChannels:p})}}}),[i,l,d,s]),f=()=>{F&&(F.close(),F=void 0)};return(0,r.useEffect)((()=>(a&&!z&&m(),()=>{a&&!z&&f()})),[a]),{setStreamingReady:n,startStreaming:m,stopStreaming:f}}var Y=s(6144);let q=!1;var J=s(3014),X=s(49209);let ee=!1,te=!1;const se=e=>{const[t,s]=(0,r.useState)("");if(navigator.serviceWorker){const t=(0,X.KL)((0,J.ZF)(D.qe));if(ee||te)return;ee=!0,(0,X.LP)(t,{vapidKey:e}).then((e=>{e&&s(e),ee=!1})).catch((e=>{ee=!1,te=!0}))}return t};let re=!1,ae=!1;const ne=()=>{const e=se(D.um),[t]=(0,V.Vd)();return(0,r.useEffect)((()=>{(async e=>{if(e&&!ae&&!re)try{ae=!0,await t(e),re=!0}catch{ae=!1,re=!0}})(e)}),[e]),null},ie=(0,r.memo)(ne);var oe=s(80874),le=s(25552),ce=s(69885);const de=i.ZP.div`
  position: relative;
  margin-top: 15px;
  pointer-events: all;
  width: 406px;
