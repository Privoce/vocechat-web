...
`;function h(e){let{config:t={}}=e;const{client_id:n}=t;return(0,u.jsxs)(g,{onClick:()=>{location.href=`http://github.com/login/oauth/authorize?client_id=${n}`},children:[(0,u.jsx)(c,{className:"icon"}),"Sign in with Github"]})}},5328:(e,t,n)=>{n.d(t,{Z:()=>g});var i=n(7313),s=n(2338),a=n(3657),o=n(9184);const r=n.p+"static/media/google.db7474a481e12799b961.svg";var c=n(1140),l=n(2509),d=n(6417);const u=(0,o.ZP)(c.Z)`
  width: 100%;
  margin-bottom: 16px;
  display: flex;
  align-items: center;
...
`,g=e=>{let{clientId:t}=e;const[n,{isSuccess:o,isLoading:c}]=(0,l.YA)(),{signIn:g,loaded:h}=(0,s.useGoogleLogin)({onScriptLoadFailure:e=>{},clientId:t,onSuccess:e=>{let{tokenId:t,...i}=e;n({id_token:t,type:"google"})},onFailure:e=>{}});(0,i.useEffect)((()=>{o&&a.ZP.success("Login Successfully")}),[o]);return(0,d.jsxs)(u,{disabled:!h||c,onClick:()=>{g()},children:[(0,d.jsx)("img",{className:"icon",src:r,alt:"google icon"}),h?"Sign in with Google":"Initailizing"]})}},1923:(e,t,n)=>{n.d(t,{Z:()=>a});var i=n(7313),s=n(2378);function a(){const[e,t]=(0,i.useState)(!1),[n,a]=(0,i.useState)({}),{data:o}=(0,s.R)(void 0,{refetchOnMountOrArgChange:!0}),[r,{isSuccess:c}]=(0,s.Ku)();(0,i.useEffect)((()=>{o&&a(o)}),[o]),(0,i.useEffect)((()=>{t(!c&&JSON.stringify(o)!==JSON.stringify(n))}),[o,n,c]);return{config:n,changed:e,updateGithubAuthConfig:e=>{a((t=>({...t,...e})))},updateGithubAuthConfigToServer:async()=>{await r(n)},isSuccess:c}}},9137:(e,t,n)=>{n.d(t,{Z:()=>a});var i=n(7313),s=n(2378);function a(){const[e,t]=(0,i.useState)(!1),[n,a]=(0,i.useState)(""),{data:o}=(0,s.eM)(void 0,{refetchOnMountOrArgChange:!0}),[r,{isSuccess:c}]=(0,s.Qg)();(0,i.useEffect)((()=>{o&&a(o.client_id)}),[o]),(0,i.useEffect)((()=>{t(!c&&(null===o||void 0===o?void 0:o.client_id)!==n)}),[o,n,c]);return{config:o,changed:e,clientId:n,updateClientId:a,updateClientIdToServer:async()=>{n&&await r({client_id:n})},updateGoogleAuthConfig:r,isSuccess:c}}},5866:(e,t,n)=>{n.r(t),n.d(t,{default:()=>S});var i=n(7313),s=n(3657),a=n(7935),o=n(4050),r=n(1140),c=n(2509),l=n(9184),d=n(6417);const u=l.ZP.div`
  display: flex;
...
`;function f(){const e=(0,h.s0)();return(0,d.jsxs)(p,{children:[(0,d.jsx)("span",{children:"Have an account?"}),(0,d.jsx)("a",{onClick:()=>{e("/login")},children:"Sign In"})]})}var m=n(2378),x=n(1923),w=n(9137),C=n(5328),v=n(4968);function S(){const[e,{isLoading:t,data:n,isSuccess:l}]=(0,c.uk)(),[u,{isLoading:h}]=(0,c.N0)(),[p,S]=(0,i.useState)(""),[b,j]=(0,i.useState)({email:"",password:"",confirmPassword:""});(0,i.useEffect)((()=>{const e=new URLSearchParams(location.search).get("magic_token");e&&S(e)}),[]),(0,i.useEffect)((()=>{if(l&&n){const{new_magic_token:e,mail_is_sent:t}=n;!t&&e&&(location.href=`?magic_token=${e}#/register/set_name`)}}),[l,n]);const y=e=>{const{type:t}=e.target.dataset,{value:n}=e.target;j((e=>(e[t]=n,{...e})))},{clientId:_}=(0,w.Z)(),{config:Z}=(0,x.Z)(),{data:P,isSuccess:k}=(0,m.ww)();if(!k)return null;const{github:E,google:N,who_can_sign_up:I}=P,O=N&&_;if("EveryOne"!==I&&!p)return"Sign up method is updated to Invitation Link Only";const{email:L,password:z,confirmPassword:A}=b;if(null!==n&&void 0!==n&&n.mail_is_sent)return(0,d.jsx)(g,{});const G=t||h;return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsxs)("div",{className:"tips",children:[(0,d.jsx)("img",{src:`${a.ZP}/resource/organization/logo`,alt:"logo",className:"logo"}),(0,d.jsx)("h2",{className:"title",children:"Sign Up to Rustchat"}),(0,d.jsx)("span",{className:"desc",children:"Please enter your details."})]}),(0,d.jsxs)("form",{onSubmit:async t=>{t.preventDefault();const{email:n,password:i,confirmPassword:a}=b;if(i!==a)return void s.ZP.error("Not Same Password!");const{data:o}=await u(n);o?e({magic_token:p,email:n,password:i}):s.ZP.error("Email already registered!")},autoSave:"false",autoComplete:"true",children:[(0,d.jsx)(o.Z,{className:"large",name:"email",value:L,required:!0,placeholder:"Enter email","data-type":"email",onChange:y}),(0,d.jsx)(o.Z,{className:"large",type:"password",value:z,name:"password",required:!0,"data-type":"password",onChange:y,placeholder:"Enter password"}),(0,d.jsx)(o.Z,{required:!0,onBlur:()=>{const{password:e,confirmPassword:t}=b;e!==t&&s.ZP.error("Not Same Password!")},type:"password",name:"confirmPassword",value:A,"data-type":"confirmPassword",onChange:y,placeholder:"Confirm Password"}),(0,d.jsx)(r.Z,{type:"submit",disabled:G,children:G?"Signing Up":"Sign Up"})]}),(0,d.jsx)("hr",{className:"or"}),O&&(0,d.jsx)(C.Z,{clientId:_}),E&&(0,d.jsx)(v.Z,{config:Z}),(0,d.jsx)(f,{})]})}}}]);