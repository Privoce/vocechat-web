...
`,o=e=>{let{url:i="",name:s="",type:a="user",uploadImage:o,disabled:d=!1}=e;const[M,x]=(0,t.useState)(!1);return(0,c.jsxs)(r,{children:[(0,c.jsxs)("div",{className:"avatar",children:[(0,c.jsx)(n.Z,{type:a,url:i,name:s}),!d&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("div",{className:"tip",children:M?"Uploading":"Change Avatar"}),(0,c.jsx)("input",{multiple:!1,onChange:async e=>{if(M)return;if(!e.target.files)return;const[i]=Array.from(e.target.files);x(!0),await o(i),x(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,c.jsx)("img",{src:l,alt:"icon",className:"icon"})]})}},6047:(e,i,s)=>{s.d(i,{Z:()=>z});var t=s(7313),a=s(244),n=s(2963),l=s(2370),c=s(6059),r=s(6113),o=s(1742),d=s(5281),M=s(9559),x=s(4050),u=s(1140),j=s(6417);const N=a.ZP.div`
  display: flex;
