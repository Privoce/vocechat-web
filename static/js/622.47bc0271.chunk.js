...
`;function h(e){let{config:t={}}=e;const{client_id:n}=t;return(0,u.jsxs)(g,{onClick:()=>{location.href=`http://github.com/login/oauth/authorize?client_id=${n}`},children:[(0,u.jsx)(c,{className:"icon"}),"Sign in with Github"]})}},1618:(e,t,n)=>{n.d(t,{Z:()=>l});var i=n(2338);const s=n.p+"static/media/google.db7474a481e12799b961.svg";var a=n(9184),o=n(1296),r=n(6417);const c=(0,a.ZP)(o.Z)`
  width: 100%;
  margin-bottom: 16px;
  display: flex;
  align-items: center;
