...
`,c=e=>{let{size:i=96,uid:t,className:s="",url:c="",name:p="",type:x="user",uploadImage:h,disabled:m=!1}=e;const{t:f}=(0,o.$G)(),[g,u]=(0,n.useState)(!1);return(0,r.jsxs)(d,{size:i,className:s,children:[(0,r.jsxs)("div",{className:"avatar",children:[(0,r.jsx)(l.Z,{width:i,height:i,type:x,src:c,name:p,className:s}),!m&&(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("div",{className:"tip",children:f(g?"status.uploading":"action.change_avatar")}),(0,r.jsx)("input",{multiple:!1,onChange:async e=>{if(g)return;if(!e.target.files)return;const[i]=Array.from(e.target.files);u(!0),t?await h({uid:t,file:i}):await h(i),u(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!m&&(0,r.jsx)("img",{src:a,alt:"icon",className:"icon"})]})}},93826:(e,i,t)=>{t.d(i,{Z:()=>z});var n=t(70537),s=t(7829),l=t(69195),a=t(27418),o=t(52334),r=t(18951);const d=t(57889).ZP.section`
  display: flex;
