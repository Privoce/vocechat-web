...
`;var c=s(64631),d=s(66160),p=s(80683);const h=l.ZP.div`
  padding: 10px 12px;
  .avatar {
    width: 32px;
    height: 32px;
...
`,u=e=>{let{uid:t}=e;const{pathname:s}=(0,r.TH)(),a=(0,d.CG)((e=>e.users.byId[t]));return a?(0,p.jsx)(h,{children:(0,p.jsx)(n.OL,{to:`/setting?nav=my_account&f=${s}`,children:(0,p.jsx)("div",{className:"avatar",children:(0,p.jsx)(c.Z,{width:32,height:32,src:a.avatar,name:a.name})})})}):null};var g=s(63356),f=s(31159);const m=s.p+"static/media/setting.3775f508cd4166c61556.svg",x=l.ZP.ul`
  display: flex;
  flex-direction: column;
  position: absolute;
  left: 0;
