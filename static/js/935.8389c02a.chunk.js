...
`,G=e=>{let{issuers:t,type:i="login"}=e;const{t:n}=(0,v.$G)("auth"),[o,s]=(0,a.useState)(!1);return t?(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(L.I,{onClick:()=>{s(!0)},children:n("login"==i?"login.oidc":"reg.oidc")}),o&&(0,C.jsx)(A.Z,{id:"modal-modal",children:(0,C.jsxs)(B,{title:"Login with OIDC",children:[t.filter((e=>e.enable)).map(((e,t)=>(0,C.jsx)(R,{issuer:e},t))),(0,C.jsx)(w.Z,{className:"border_less ghost buttonCancel",onClick:()=>{s(!1)},children:"Close"})]})})]}):null},q=e=>{let{type:t="login"}=e;const[i,{isSuccess:n}]=(0,b.YA)(),{config:o}=(0,d.Z)(),{data:s,isSuccess:r}=(0,c.ww)(),{clientId:u}=(0,p.Z)();if((0,a.useEffect)((()=>{n&&l.ZP.success("Login Successfully")}),[n]),!r)return null;const{github:g,google:h,metamask:x,oidc:f=[]}=s,m=h&&!!u;return(0,C.jsxs)(C.Fragment,{children:[m&&(0,C.jsx)(k,{type:t,clientId:u}),g&&(0,C.jsx)(M,{type:t,client_id:null===o||void 0===o?void 0:o.client_id}),x&&(0,C.jsx)(z,{type:t,login:i}),f.length>0&&(0,C.jsx)(G,{type:t,issuers:f})]})}},64813:(e,t,i)=>{i.d(t,{I:()=>s,Z:()=>r});var n=i(57889),o=i(69885);const s=(0,n.ZP)(o.Z)`
  width: 100%;
  /* margin-bottom: 16px; */
  display: flex;
  align-items: center;
