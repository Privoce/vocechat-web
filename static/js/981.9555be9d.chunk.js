...
`;var d=i(6499),u=i(2509);const g=i.p+"static/media/metamask.f04d5fb63394197766d0.svg";var p=i(6417);function h(e){let{login:t}=e;const[i,s]=(0,n.useState)(!1),[o,a]=(0,n.useState)([]),[r]=(0,u.sZ)(),l=(0,n.useRef)();(0,n.useEffect)((()=>{function e(e){a(e)}return l.current||(l.current=new d.Z),d.Z.isMetaMaskInstalled()&&ethereum.on("accountsChanged",e),()=>{d.Z.isMetaMaskInstalled()&&ethereum.removeListener("accountsChanged",e)}}),[]),(0,n.useEffect)((()=>{if(d.Z.isMetaMaskInstalled())if(o.length>0){const[e]=o;(async e=>{const{data:i,isSuccess:n}=await r(e);if(n){const n=await h(e,i);t({public_address:e,nonce:i,signature:n,type:"metamask"})}})(e),s(!0),l.current.stopOnboarding()}else s(!1)}),[o]);const h=async(e,t)=>await ethereum.request({method:"personal_sign",params:[t,e,"hello from "]});return(0,p.jsxs)(c,{disabled:i,onClick:async()=>{if(d.Z.isMetaMaskInstalled()){s(!0);try{const e=await ethereum.request({method:"eth_requestAccounts"});a(e)}catch(e){ethereum.request({method:"wallet_requestPermissions",params:[{eth_accounts:{}}]})}s(!1)}else l.current.startOnboarding()},children:[(0,p.jsx)("img",{className:"icon",src:g,alt:"meta mask icon"}),"Sign in with MetaMask"]})}var f=i(6571),m=i(666);const x=e=>{let{issuer:t}=e;const[i,{data:s,isLoading:o,isSuccess:a}]=(0,u.CB)();return(0,n.useEffect)((()=>{if(a&&s){const{url:e}=s;location.href=e}}),[s,a]),(0,p.jsxs)(c,{disabled:o,onClick:()=>{i({issuer:t.domain,redirect_uri:`${location.origin}/#/login`})},children:[Boolean(t.favicon)&&(0,p.jsx)("img",{src:t.favicon,className:"icon",alt:"icon"}),"Login with ",t.domain]})},b=(0,a.ZP)(f.Z)`
  text-align: center;
...
`,w=e=>{let{issuers:t}=e;const[i,s]=(0,n.useState)(!1);return t?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(c,{onClick:()=>{s(!0)},children:"Sign in with OIDC"}),i&&(0,p.jsx)(m.Z,{id:"modal-modal",children:(0,p.jsxs)(b,{title:"Login with OIDC",children:[t.filter((e=>e.enable)).map(((e,t)=>(0,p.jsx)(x,{issuer:e},t))),(0,p.jsx)(r.Z,{className:"border_less ghost buttonCancel",onClick:()=>{s(!1)},children:"Close"})]})})]}):null};var v=i(4050),C=i(7890);const j=(0,a.ZP)(r.Z)`
  width: 100%;
  margin-bottom: 16px;
