...
`,x=e=>{let{type:t="login",loaded:n,loadError:i}=e;const[o,{isSuccess:r,isLoading:s,error:d}]=(0,m.YA)(),g=localStorage.getItem(u.LJ);return(0,a.useEffect)((()=>{r&&l.ZP.success("Login Successfully")}),[r]),(0,a.useEffect)((()=>{if(d&&"status"in d)if(410===d.status)l.ZP.error("No associated account found, please user admin for an invitation link to join.");else l.ZP.error("Something Error");else;}),[d]),(0,w.jsxs)(v,{disabled:!n||s,children:[(0,w.jsxs)("div",{className:"mask",children:[(0,w.jsx)(h,{className:"icon"}),i?"Script Load Error!":n?("login"===t?"Sign in":"Sign up")+" with Google":"Initializing"]}),(0,w.jsx)("div",{className:"invisible",children:(0,w.jsx)(c.kZ,{width:"360px",onSuccess:e=>{o({magic_token:g,id_token:e.credential||"",type:"google"})}})})]})},S=e=>{let{type:t="login",clientId:n}=e;const[i,o]=(0,a.useState)(!1),[r,s]=(0,a.useState)(!1);return n?(0,w.jsx)(c.rg,{onScriptLoadError:()=>{s(!0)},onScriptLoadSuccess:()=>{o(!0)},clientId:n,children:(0,w.jsx)(x,{type:t,loaded:i,loadError:r})}):null}},1923:(e,t,n)=>{n.d(t,{Z:()=>r});var i=n(7313),o=n(2378);function r(){const[e,t]=(0,i.useState)(!1),[n,r]=(0,i.useState)(void 0),{data:s}=(0,o.R)(void 0,{refetchOnMountOrArgChange:!0}),[a,{isSuccess:c}]=(0,o.Ku)();(0,i.useEffect)((()=>{s&&r(s)}),[s]),(0,i.useEffect)((()=>{t(!c&&JSON.stringify(s)!==JSON.stringify(n))}),[s,n,c]);return{config:n,changed:e,updateGithubAuthConfig:e=>{r((t=>t?{...t,...e}:e))},updateGithubAuthConfigToServer:async()=>{n&&await a(n)},isSuccess:c}}},9137:(e,t,n)=>{n.d(t,{Z:()=>r});var i=n(7313),o=n(2378);function r(){const[e,t]=(0,i.useState)(!1),[n,r]=(0,i.useState)(""),{data:s}=(0,o.eM)(void 0,{refetchOnMountOrArgChange:!0}),[a,{isSuccess:c}]=(0,o.Qg)();(0,i.useEffect)((()=>{s&&r(s.client_id)}),[s]),(0,i.useEffect)((()=>{t(!c&&(null===s||void 0===s?void 0:s.client_id)!==n)}),[s,n,c]);return{config:s,changed:e,clientId:n,updateClientId:r,updateClientIdToServer:async()=>{n&&await a({client_id:n})},updateGoogleAuthConfig:a,isSuccess:c}}},5866:(e,t,n)=>{n.r(t),n.d(t,{default:()=>S});var i=n(7313),o=n(6059),r=n(7935),s=n(4050),a=n(1140),c=n(2509),l=n(244),d=n(6417);const u=l.ZP.div`
  display: flex;
