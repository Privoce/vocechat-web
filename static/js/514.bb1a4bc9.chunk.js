...
`,a=e=>{let{saveHandler:t,resetHandler:n}=e;const{t:l}=(0,i.$G)("setting");return(0,o.jsxs)(s,{className:"animate__animated animate__flipInX animate__faster",children:[(0,o.jsx)("span",{className:"txt",children:l("save_tip")}),(0,o.jsxs)("div",{className:"btns",children:[(0,o.jsx)("button",{className:"btn reset",onClick:n,children:l("reset")}),(0,o.jsx)("button",{className:"btn",onClick:t,children:l("save_change")})]})]})}},7477:(e,t,n)=>{n.d(t,{Z:()=>c});var i=n(57889),l=n(15924),o=n(64084);const s=n.p+"static/media/arrow.left.92fbb139607631555459.svg";var a=n(80683);const r=i.ZP.div`
  width: 100vw;
  height: 100vh;
  display: flex;
...
`},40698:(e,t,n)=>{n.d(t,{Z:()=>s});var i=n(57889),l=n(80683);const o=i.ZP.div`
  padding: 32px;
...
`,s=e=>{let{title:t="",description:n="",buttons:i,children:s,...a}=e;return(0,l.jsxs)(o,{...a,children:[t&&(0,l.jsx)("h3",{className:"title",children:t}),n&&(0,l.jsx)("p",{className:"desc",children:n}),s,i&&(0,l.jsx)("div",{className:"btns",children:i})]})}},15621:(e,t,n)=>{n.d(t,{Z:()=>c});var i=n(70537),l=n(57889),o=n(80683);const s=l.ZP.form`
  width: 100%;
  > .option {
    &:not(:last-child) {
      margin-bottom: 8px;
...
`,a="",r=[],c=e=>{let{options:t,values:n=r,value:l=a,defaultValue:c="",onChange:d}=e;const p=(0,i.useId)(),[x,u]=(0,i.useState)(c),f=l!==a?l:x;return(0,o.jsx)(s,{children:t.map(((e,t)=>(0,o.jsxs)("div",{className:"option",children:[(0,o.jsx)("input",{type:"radio",checked:(n!==r?n.indexOf(f):f)===t,onChange:()=>{const e=n===r?t:n[t];l===a&&u(e),d&&d(e)},id:`${p}-${t}`}),(0,o.jsx)("div",{className:"box",children:(0,o.jsx)("label",{htmlFor:`${p}-${t}`,children:e})})]},t)))})}},26209:(e,t,n)=>{n.d(t,{Z:()=>s});var i=n(70537),l=n(34108),o=n(27418);const s=e=>{const{enableToast:t=!0}=e||{},[n,s]=(0,i.useState)(!1);(0,i.useEffect)((()=>{n&&t&&o.ZP.success("Copied!")}),[n]);const a=e=>{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="absolute",t.style.left="-9999px",document.body.appendChild(t);const n=document.getSelection();if(!n)return!1;const i=n.rangeCount>0&&n.getRangeAt(0);t.select();const l=document.execCommand("copy");return document.body.removeChild(t),i&&(n.removeAllRanges(),n.addRange(i)),l};return{copied:n,copy:function(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],i=0;return n||(t?(0,l.VP)(e).then((()=>{s(!0),i=window.setTimeout((()=>{s(!1)}),500)})):(s(a(e)),i=window.setTimeout((()=>{s(!1)}),500))),()=>{clearTimeout(i)}}}}},50911:(e,t,n)=>{n.d(t,{Z:()=>p});var i=n(70537),l=n(27418),o=n(15924),s=n(69195),a=n(6144),r=n(52334),c=n(26209),d=n(66160);const p=e=>{let{uid:t,cid:n}=e;const[p,x]=(0,i.useState)(void 0),u=(0,o.bS)(`/users/${t}`),[f,{isSuccess:m}]=(0,r.EO)(),[h,{isSuccess:g}]=(0,a.Cg)(),b=(0,o.s0)(),{copy:v}=(0,c.Z)(),{user:w,channel:j,loginUser:y}=(0,d.CG)((e=>({user:"undefined"!==typeof t?e.users.byId[t]:t,channel:"undefined"!==typeof n?e.channels.byId[n]:n,loginUser:e.authData.user})));(0,i.useEffect)((()=>{x(null!==t&&void 0!==t?t:null===y||void 0===y?void 0:y.uid)}),[t,y]),(0,i.useEffect)((()=>{(g||m)&&(l.ZP.success("Remove Successfully"),m&&u&&b("/users"))}),[g,m,u]);const C=!(null===y||void 0===y||!y.is_admin),k=null===y||void 0===y?void 0:y.uid,N=!!n&&!(null!==j&&void 0!==j&&j.is_public)&&C,Z=!!n&&!(null!==j&&void 0!==j&&j.is_public)&&(C||(null===j||void 0===j?void 0:j.owner)==k)&&t!=(null===j||void 0===j?void 0:j.owner);return{canDeleteChannel:N,canRemove:C&&k!=t&&!n&&1!==t,removeUser:e=>{const t=!Number.isNaN(+e)&&e||p;t&&(f(t),(0,s.Bn)())},startChat:()=>{b(`/chat/dm/${t}`)},removeFromChannel:e=>{if(!n)return;const t=!Number.isNaN(+e)&&e||p;t&&(h({id:+n,members:[+t]}),(0,s.Bn)())},canRemoveFromChannel:Z,canCopyEmail:!(null===w||void 0===w||!w.email),copyEmail:e=>{const t="string"==typeof e&&e||(null===w||void 0===w?void 0:w.email);v(t||""),(0,s.Bn)()}}}},29434:(e,t,n)=>{n.r(t),n.d(t,{default:()=>C});var i=n(70537),l=n(15924),o=n(64084),s=n(7477),a=n(27418),r=n(80874),c=n(52334),d=n(40698),p=n(69885),x=n(14566),u=n(80683);const f=e=>{let{id:t,closeModal:n}=e;const{t:o}=(0,x.$G)("setting"),{t:s}=(0,x.$G)(),f=(0,l.s0)(),[m,{isLoading:h,isSuccess:g}]=(0,c.EO)();return(0,i.useEffect)((()=>{g&&(a.ZP.success("delete user successfully!"),n(),f("/chat"))}),[g]),t?(0,u.jsx)(r.Z,{id:"modal-modal",children:(0,u.jsx)(d.Z,{className:"compact",title:o("dm.delete"),description:o("dm.delete_desc"),buttons:(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(p.Z,{onClick:n.bind(null,void 0),className:"cancel",children:s("action.cancel")}),(0,u.jsx)(p.Z,{onClick:()=>{m(t)},className:"danger",children:h?"Deleting":s("action.remove")})]})})}):null};var m=n(71044);function h(e){let{id:t=0}=e;return(0,u.jsx)("section",{className:"w-full h-full flex justify-center items-start",children:(0,u.jsx)(m.Z,{uid:t})})}var g=n(24563),b=n(15621);const v=e=>{let{id:t,type:n="channel",expires_in:l=0}=e;const[o,{isSuccess:s}]=(0,c.ar)(),[r,d]=(0,i.useState)(l),{t:p}=(0,x.$G)("setting",{keyPrefix:"auto_delete_msg"}),f=[{title:p("off"),value:0},{title:p("30_seconds"),value:30},{title:p("10_min"),value:600},{title:p("1_hour"),value:3600},{title:p("1_day"),value:86400},{title:p("1_week"),value:604800}];return(0,i.useEffect)((()=>{s&&a.Am.success("Update Successfully!")}),[s]),(0,u.jsxs)("section",{className:"max-w-[512px] h-full relative",children:[(0,u.jsxs)("div",{className:"text-sm",children:[(0,u.jsx)("h2",{children:p("title")}),(0,u.jsx)("p",{className:"text-gray-500",children:p("desc")})]}),(0,u.jsx)("div",{className:"mt-4",children:(0,u.jsx)(b.Z,{options:f.map((e=>{let{title:t}=e;return t})),values:f.map((e=>{let{value:t}=e;return t})),value:r,onChange:e=>{d(e)}})}),l!==r&&(0,u.jsx)(g.Z,{saveHandler:()=>{o("user"==n?{users:[{uid:t,expires_in:r}]}:{groups:[{gid:t,expires_in:r}]})},resetHandler:()=>{d(l)}})]})},w=e=>{const{t:t}=(0,x.$G)("setting");return[{title:t("nav.general"),items:[{name:"overview",title:t("nav.overview"),component:(0,u.jsx)(h,{id:e})},{name:"auto_delete_msg",title:t("nav.auto_delete_msg"),component:(0,u.jsx)(v,{id:e,type:"user"})}]}]};var j=n(66160);let y="";function C(){const{t:e}=(0,x.$G)(),{uid:t=0}=(0,l.UO)(),{loginUser:n}=(0,j.CG)((e=>({loginUser:e.authData.user,user:t?e.users.byId[+t]:void 0}))),a=(0,l.s0)(),[r]=(0,o.lr)(),c=w(+t),d=c.map((e=>{let{items:t}=e;return t})).flat(),p=r.get("nav");y=y||(r.get("f")||"/");const[m,h]=(0,i.useState)(!1),g=()=>{h((e=>!e))};if(!t)return null;const b=d.find((e=>e.name==p))||d[0],v=null===n||void 0===n?void 0:n.is_admin;return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(s.Z,{nav:b,closeModal:()=>{a(y),y=""},title:"DM Setting",navs:c,dangers:[v&&{title:e("action.remove_user"),handler:g}],children:b.component}),m&&(0,u.jsx)(f,{closeModal:g,id:+t})]})}}}]);