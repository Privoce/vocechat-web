...
`;var h=n(63211),g=n(50911),b=n(66160),v=n(14566),w=n(80683);const j=e=>{let{uid:t,type:n="embed",cid:i}=e;const{t:l}=(0,v.$G)("member"),{t:a}=(0,v.$G)(),{canCopyEmail:r,copyEmail:c,removeFromChannel:p,canRemoveFromChannel:x,canRemove:j,removeUser:y}=(0,g.Z)({uid:t,cid:i}),{data:C}=(0,b.CG)((e=>({data:e.users.byId[t]})));if(!C)return null;const{name:k,email:N,avatar:Z}=C,_="embed"==n&&j,E=N||x||_;return(0,w.jsxs)(m,{className:n,children:[(0,w.jsx)(f.Z,{className:"rounded-full w-20 h-20 object-cover",url:Z,name:k}),(0,w.jsx)("h2",{className:"text-lg select-text font-bold text-[#1c1c1e]",children:k}),(0,w.jsx)("span",{className:"text-sm text-[#98a2b3] select-text",children:N}),(0,w.jsxs)("ul",{className:"icons",children:[(0,w.jsx)(o.OL,{to:`/chat/dm/${t}`,children:(0,w.jsxs)("li",{className:"icon chat",children:[(0,w.jsx)(d,{}),(0,w.jsx)("span",{className:"txt",children:l("send_msg")})]})}),(0,w.jsx)(s.ZP,{disabled:!E,interactive:!0,popperOptions:{strategy:"fixed"},placement:"bottom-start",trigger:"click",hideOnClick:!0,content:(0,w.jsxs)(h.Z,{children:[r&&(0,w.jsx)("li",{className:"item",onClick:c.bind(void 0,N),children:l("copy_email")}),x&&(0,w.jsx)("li",{className:"item danger",onClick:p.bind(null,t),children:l("remove_from_channel")}),_&&(0,w.jsx)("li",{className:"item danger",onClick:y.bind(null,t),children:l("remove")})]}),children:(0,w.jsxs)("li",{className:"icon more "+(E?"":"disabled"),children:[(0,w.jsx)(u,{}),(0,w.jsx)("span",{className:"txt",children:a("more")})]})})]})]})},y=(0,l.memo)(j)},24563:(e,t,n)=>{n.d(t,{Z:()=>a});var i=n(14566),l=n(57889),o=n(80683);const s=l.ZP.div`
  width: 100%;
  position: absolute;
  bottom: 64px;
  left: 0;
...
`,s=e=>{let{title:t="",description:n="",buttons:i,children:s,...a}=e;return(0,l.jsxs)(o,{...a,children:[t&&(0,l.jsx)("h3",{className:"title",children:t}),n&&(0,l.jsx)("p",{className:"desc",children:n}),s,i&&(0,l.jsx)("div",{className:"btns",children:i})]})}},15621:(e,t,n)=>{n.d(t,{Z:()=>d});var i=n(70537),l=n(57889),o=n(80683);const s=l.ZP.form`
  width: 100%;
  > .option {
    &:not(:last-child) {
      margin-bottom: 8px;
