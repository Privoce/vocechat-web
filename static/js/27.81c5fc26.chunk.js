...
`,U={doc:{title:"Documents",icon:(0,w.jsx)(A.Z,{className:"icon"})},pdf:{title:"PDFs",icon:(0,w.jsx)(F.Z,{className:"icon"})},image:{title:"Images",icon:(0,w.jsx)(Y.Z,{className:"icon"})},audio:{title:"Audio",icon:(0,w.jsx)(R.Z,{className:"icon"})},video:{title:"Videos",icon:(0,w.jsx)(B.Z,{className:"icon"})},code:{title:"Code Snippets",icon:(0,w.jsx)(D.Z,{className:"icon"})},unkown:{title:"Unkown Files",icon:(0,w.jsx)(T.Z,{className:"icon"})}};function q(e){let{select:t="",updateFilter:i}=e;const n=e=>{i({type:e})};return(0,w.jsx)(W,{children:(0,w.jsxs)("ul",{className:"list",children:[(0,w.jsxs)("li",{className:"type",onClick:n.bind(null,void 0),children:["Any Type",!t&&(0,w.jsx)(H.Z,{className:"check"})]}),Object.entries(U).map((e=>{let[i,{title:l,icon:a}]=e;return(0,w.jsxs)("li",{className:"type",onClick:n.bind(null,i),children:[a," ",l,t==i&&(0,w.jsx)(H.Z,{className:"check"})]},l)}))]})})}var G=i(746);const J=l.ZP.div`
  /* padding: 20px 0; */
  display: flex;
  align-items: center;
  gap: 8px;
...
`;function K(e){let{filter:t,updateFilter:i}=e;const[l,a]=(0,n.useState)({channel:!1,date:!1,from:!1,type:!1}),s=e=>{a((t=>({...t,...e})))},o=e=>{i(e);let t=Object.keys(e)[0];s({[t]:!1})},{contactMap:c,channelMap:d}=(0,r.v9)((e=>({contactMap:e.contacts.byId,channelMap:e.channels.byId}))),{from:p,channel:x,type:h,date:u}=t,{channel:f,date:m,type:g,from:v}=l;return(0,w.jsxs)(J,{children:[(0,w.jsx)(Z.ZP,{interactive:!0,onClickOutside:s.bind(null,{from:!1}),visible:v,placement:"bottom-start",content:(0,w.jsx)(_,{select:t.from,updateFilter:o}),children:(0,w.jsxs)("div",{className:`filter ${p&&"selected"}`,onClick:s.bind(null,{from:!0}),children:[p&&(0,w.jsx)(N.Z,{className:"avatar",name:c[p].name,url:c[p].avatar}),(0,w.jsxs)("span",{className:"txt",children:["From ",p&&c[p].name]}),(0,w.jsx)(G.Z,{className:"arrow"})]})}),(0,w.jsx)(Z.ZP,{interactive:!0,onClickOutside:s.bind(null,{channel:!1}),visible:f,placement:"bottom-start",content:(0,w.jsx)($,{select:t.channel,updateFilter:o}),children:(0,w.jsxs)("div",{className:`filter ${x&&"selected"}`,onClick:s.bind(null,{channel:!0}),children:[(0,w.jsx)("span",{className:"txt",children:x?`In ${d[x].name}`:"Channel"}),(0,w.jsx)(G.Z,{className:"arrow"})]})}),(0,w.jsx)(Z.ZP,{interactive:!0,onClickOutside:s.bind(null,{type:!1}),visible:g,placement:"bottom-start",content:(0,w.jsx)(q,{select:t.type,updateFilter:o}),children:(0,w.jsxs)("div",{className:`filter ${h&&"selected"}`,onClick:s.bind(null,{type:!0}),children:[(0,w.jsx)("span",{className:"txt",children:h?U[h].title:"Type"}),(0,w.jsx)(G.Z,{className:"arrow"})]})}),(0,w.jsx)(Z.ZP,{interactive:!0,onClickOutside:s.bind(null,{date:!1}),visible:m,placement:"bottom-start",content:(0,w.jsx)(E,{select:t.date,updateFilter:o}),children:(0,w.jsxs)("div",{className:`filter ${u&&"selected"}`,onClick:s.bind(null,{date:!0}),children:[(0,w.jsx)("span",{className:"txt",children:u?O[u].title:"Date"}),(0,w.jsx)(G.Z,{className:"arrow"})]})})]})}var Q=i(658),X=i.n(Q),ee=i(9694),te=i.n(ee);const ie=l.ZP.div`
  background: #f3f4f6;
