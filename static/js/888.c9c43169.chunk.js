...
`;function Q(e){let{filter:t,updateFilter:i}=e;const[n,a]=(0,l.useState)({channel:!1,date:!1,from:!1,type:!1}),s=e=>{a((t=>({...t,...e})))},r=e=>{i(e);let t=Object.keys(e)[0];s({[t]:!1})},{userMap:o,channelMap:c}=(0,J.CG)((e=>({userMap:e.users.byId,channelMap:e.channels.byId}))),{from:d,channel:p,type:x,date:h}=t,{channel:u,date:f,type:m,from:g}=n;return(0,v.jsxs)(K,{children:[(0,v.jsx)(C.ZP,{interactive:!0,onClickOutside:s.bind(null,{from:!1}),visible:g,placement:"bottom-start",content:(0,v.jsx)(H,{select:t.from,updateFilter:r}),children:(0,v.jsxs)("div",{className:`filter ${d&&"selected"}`,onClick:s.bind(null,{from:!0}),children:[d&&(0,v.jsx)(Z.Z,{className:"avatar",name:o[d].name,url:o[d].avatar}),(0,v.jsxs)("span",{className:"txt",children:["From ",d&&o[d].name]}),(0,v.jsx)(q.Z,{className:"arrow"})]})}),(0,v.jsx)(C.ZP,{interactive:!0,onClickOutside:s.bind(null,{channel:!1}),visible:u,placement:"bottom-start",content:(0,v.jsx)($,{select:t.channel,updateFilter:r}),children:(0,v.jsxs)("div",{className:`filter ${p&&"selected"}`,onClick:s.bind(null,{channel:!0}),children:[(0,v.jsx)("span",{className:"txt",children:p?`In ${c[p].name}`:"Channel"}),(0,v.jsx)(q.Z,{className:"arrow"})]})}),(0,v.jsx)(C.ZP,{interactive:!0,onClickOutside:s.bind(null,{type:!1}),visible:m,placement:"bottom-start",content:(0,v.jsx)(U,{select:t.type,updateFilter:r}),children:(0,v.jsxs)("div",{className:`filter ${x&&"selected"}`,onClick:s.bind(null,{type:!0}),children:[(0,v.jsx)("span",{className:"txt",children:x?W[x].title:"Type"}),(0,v.jsx)(q.Z,{className:"arrow"})]})}),(0,v.jsx)(C.ZP,{interactive:!0,onClickOutside:s.bind(null,{date:!1}),visible:f,placement:"bottom-start",content:(0,v.jsx)(M,{select:t.date,updateFilter:r}),children:(0,v.jsxs)("div",{className:`filter ${h&&"selected"}`,onClick:s.bind(null,{date:!0}),children:[(0,v.jsx)("span",{className:"txt",children:h?_[h].title:"Date"}),(0,v.jsx)(q.Z,{className:"arrow"})]})})]})}var X=i(658),ee=i.n(X);const te=s.ZP.div`
  background: #f3f4f6;
...
`,le=e=>{let{url:t}=e;return(0,v.jsx)(ie,{children:(0,v.jsx)("video",{controls:!0,src:t})})},ne=s.ZP.div`
  height: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
...
`,ae=e=>{let{url:t}=e;const[i,n]=(0,l.useState)(!1);return t?(0,v.jsx)(ne,{children:i?(0,v.jsx)("div",{className:"err",children:"Unable to play this audio"}):(0,v.jsx)("audio",{controls:!0,src:t,onError:e=>{n(!0)}})}):null},se=s.ZP.div`
  height: 218px;
  overflow: hidden;
  img {
    width: 100%;
...
`,re=e=>{let{url:t,alt:i}=e;return t?(0,v.jsx)(se,{children:(0,v.jsx)("img",{src:t,alt:i})}):null},oe=s.ZP.div`
  padding: 8px;
  /* height: 218px; */
  overflow: hidden;
  embed {
...
`,ce=e=>{let{url:t}=e;return(0,v.jsx)(oe,{children:(0,v.jsx)("embed",{src:t,type:"application/pdf"})})},de=s.ZP.div`
  height: 218px;
  ...
  color: #eee;
`,pe=e=>{let{url:t}=e;const[i,n]=(0,l.useState)("");return(0,l.useEffect)((()=>{(async e=>{if(!e)return;const t=await fetch(e),i=await t.text();n(i)})(t)}),[t]),i?(0,v.jsx)(de,{children:i}):null},xe=s.ZP.div`
  background-color: #fff;
  height: 218px;
  padding: 15px 15px 0 15px;
  line-height: 1.4;
  ...
  white-space: pre-wrap;
  word-break: break-all;
`,he=e=>{let{url:t}=e;const[i,n]=(0,l.useState)("");return(0,l.useEffect)((()=>{(async e=>{if(!e)return;const t=await fetch(e),i=await t.text();n(i)})(t)}),[t]),i?(0,v.jsx)(xe,{children:i}):null};var ue=i(7990),fe=i(6544);const me=e=>{let{preview:t,flex:i,file_type:l,name:n,size:a,created_at:s,from_uid:r,content:o}=e;const c=(0,J.CG)((e=>e.users.byId[r])),d=(0,ue.LP)(l,n);if(!o||!c||!n)return null;const p=(e=>{const{file_type:t,name:i,content:l}=e;let n=null;const a={image:/^image/gi,audio:/^audio/gi,video:/^video/gi,code:/(json|javascript|java|rb|c|php|xml|css|html)$/gi,doc:/^text/gi,pdf:/\/pdf$/gi},s=i.split("."),r=t||s[s.length-1];switch(!0){case a.image.test(r):n=(0,v.jsx)(re,{url:l});break;case a.pdf.test(r):n=(0,v.jsx)(ce,{url:l});break;case a.code.test(r):n=(0,v.jsx)(pe,{url:l});break;case a.doc.test(r):n=(0,v.jsx)(he,{url:l});break;case a.audio.test(r):n=(0,v.jsx)(ae,{url:l});break;case a.video.test(r):n=(0,v.jsx)(le,{url:l})}return n})({file_type:l,content:o,name:n}),x=t&&p;return(0,v.jsxs)(te,{className:`file_box ${i?"flex":""} ${x?"preview":""} ${l.startsWith("audio")?"audio":""}`,children:[(0,v.jsxs)("div",{className:"basic",children:[d,(0,v.jsxs)("div",{className:"info",children:[(0,v.jsx)("span",{className:"name",children:n}),(0,v.jsxs)("span",{className:"details",children:[(0,v.jsx)("i",{className:"size",children:(0,ue.td)(a)}),(0,v.jsx)("i",{className:"time",children:ee()(s).fromNow()}),(0,v.jsxs)("i",{className:"from",children:["by ",(0,v.jsx)("strong",{children:c.name})]})]})]}),(0,v.jsx)("a",{className:"download",download:n,href:`${o}&download=true`,children:(0,v.jsx)(fe.Z,{})})]}),x&&(0,v.jsx)("div",{className:"preview",children:p})]})};let ge;function be(e){let{fileMessages:t}=e;const i=(0,l.useRef)(null),[n,s]=(0,l.useState)({}),{message:o,view:d,channelMessage:p}=(0,J.CG)((e=>({message:e.message,channelMessage:e.channelMessage,view:e.ui.fileListView})));return(0,l.useEffect)((()=>{if(d==c.kO.grid&&i){const e=i.current.getBoundingClientRect().width-32,t=Math.floor(e/368),l=e%368,n=Math.max(Math.floor(l/(t-1)),8);ge=new(a())(i.current,{fitWidth:!0,gutter:n,itemSelector:".file_box"})}else ge&&ge.destroy()}),[d,n]),(0,v.jsxs)(r,{children:[(0,v.jsx)(N,{value:n.name,updateSearchValue:e=>{s((t=>({...t,name:e})))}}),(0,v.jsx)("div",{className:"divider"}),(0,v.jsxs)("div",{className:"opts",children:[(0,v.jsx)(Q,{filter:n,updateFilter:e=>{s((t=>({...t,...e})))}}),(0,v.jsx)(j,{view:d})]}),(0,v.jsx)("div",{className:`list ${d}`,ref:i,children:t.map((e=>{const t=o[e];if(!t)return null;const i=((e,t,i)=>{let l=!0;const{mid:n,file_type:a,created_at:s,from_uid:r,properties:o}=e,{name:c,type:d,date:p,from:x,channel:h}=t,u=o?o.name:"";if(x&&x!=r&&(l=!1),h&&-1==i[h].findIndex((e=>e==n))&&(l=!1),c){let e=["",...c.toLowerCase(),""].join(".*");new RegExp(e).test(u)||(l=!1)}return l})(t,n,p);if(!i)return null;const{mid:l,content:a,created_at:s,from_uid:r,properties:x}=t,{name:h,content_type:u,size:f}=null!==x&&void 0!==x?x:{};return(0,v.jsx)(me,{preview:d==c.kO.grid,flex:d==c.kO.item,file_type:u,content:a,created_at:s,from_uid:r,size:f,name:h},l)}))})]})}const ve=(0,l.memo)(be,((e,t)=>{return i=e.fileMessages,l=t.fileMessages,i.length===l.length&&i.every(((e,t)=>e==l[t]));var i,l}))},562:(e,t,i)=>{e.exports=i.p+"static/media/search.6ee4d07d418f350e5389.svg"}}]);