...
`;const kt=function(e){let{updateDraft:t=null,initialValue:n="",height:a="50vh",placeholder:s,sendMarkdown:l,setEditorInstance:r}=e;const o=(0,i.useRef)(void 0),{uploadFile:c}=(0,ue.Z)();return(0,i.useEffect)((()=>{const e=null===o||void 0===o?void 0:o.current;if(e){const t=e.getInstance();t.removeHook("addImageBlobHook"),t.addHook("addImageBlobHook",(async(e,t)=>{const{thumbnail:n=""}=await c(e);t(n)})),r(t)}return()=>{if(e){const n=e.getInstance(),i=n.getMarkdown();t&&t(i),n.destroy()}}}),[]),(0,C.jsxs)(Mt,{className:"input",children:[(0,C.jsx)(yt.M,{initialValue:n,plugins:[Nt()],placeholder:s,ref:o,toolbarItems:[],hideModeSwitch:!0,previewStyle:"vertical",height:a,initialEditType:"markdown",useCommandShortcut:!0}),(0,C.jsx)(je.Z,{className:"send small",onClick:()=>{const e=o.current.getInstance();e.getMarkdown().trim()&&(l(e.getMarkdown()),e.reset())},children:"Send"})]})};const Et="text",Lt="markdown";const _t=function(e){var t,n,a,l;let{context:r="channel",id:o=""}=e;const{resetStageFiles:c}=(0,ue.Z)({context:r,id:o}),{getDraft:d,getUpdateDraft:p}=function(e){let{context:t="",id:n=""}=e;const i=(0,s.I0)(),a=`${t}_${n}`,{draftMarkdown:l,draftMixedText:r}=(0,s.v9)((e=>({draftMarkdown:e.ui.draftMarkdown,draftMixedText:e.ui.draftMixedText})));return{getDraft:function(){return"mixed"==(arguments.length>0&&void 0!==arguments[0]?arguments[0]:"mixed")?r[a]:l[a]},getUpdateDraft:function(){const e="mixed"==(arguments.length>0&&void 0!==arguments[0]?arguments[0]:"mixed")?Y.$K:Y.Ul;return t=>{i(e({key:a,value:t}))}}}}({context:r,id:o}),h=Ce(`${r}_${o}`),[x,u]=(0,i.useState)(null),[m,f]=(0,i.useState)(!1),g=(0,s.I0)(),v=function(e){let{context:t,to:n}=e;const i=(0,s.I0)(),a="channel"==t?ae.p_:se.ZK;return e=>{i((0,ie.Hz)(e)),i(a({id:n,mid:e.mid}))}}({context:r,to:o}),{from_uid:b,replying_mid:w=null,mode:j,uploadFiles:y,channelsData:Z,contactsData:N,uids:M}=(0,s.v9)((e=>({channelsData:e.channels.byId,uids:e.contacts.ids,contactsData:e.contacts.byId,mode:e.ui.inputMode,from_uid:e.authData.uid,replying_mid:e.message.replying[`${r}_${o}`],uploadFiles:e.ui.uploadFiles[`${r}_${o}`]}))),{sendMessage:k}=(0,ne.Z)({context:r,from:b,to:o});(0,i.useEffect)((()=>{w&&h.focus()}),[w]);const E="channel"==r?null===(t=Z[o])||void 0===t?void 0:t.name:null===(n=N[o])||void 0===n?void 0:n.name,L=`Send to ${le.bI[r]}${E} `,_="channel"==r?null!==(a=Z[o])&&void 0!==a&&a.is_public?M:null===(l=Z[o])||void 0===l?void 0:l.members:[];return(0,C.jsxs)(re,{className:`send ${j} ${m?"fullscreen":""} ${w?"reply":""} ${r}`,children:[w&&(0,C.jsx)(Be,{context:r,mid:w,id:o}),j==Et&&(0,C.jsx)(Oe,{context:r,id:o}),(0,C.jsxs)("div",{className:`send_box ${j}`,children:[(0,C.jsx)(jt,{selectEmoji:e=>{j==Lt&&x?x.insertText(e):h.insertText(e)}}),j==Et&&(0,C.jsx)(be,{updateDraft:p(),initialValue:d(),members:_,id:`${r}_${o}`,placeholder:L,sendMessages:async function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[];if(o){if(e&&e.length)for await(const n of e){var t;const{type:e,content:i,properties:a={}}=n;a.local_id=null!==(t=a.local_id)&&void 0!==t?t:(new Date).getTime(),await k({id:o,reply_mid:w,type:e,content:i,from_uid:b,properties:a})}y&&0!==y.length&&(y.forEach((e=>{const t=(new Date).getTime(),{url:n,name:i,size:a,type:s}=e,l={mid:t,content:n,content_type:le.bT.file,created_at:t,properties:{content_type:s,name:i,size:a,local_id:t},from_uid:b,sending:!0};v(l)})),c())}}}),(0,C.jsx)(ot,{context:r,to:o,mode:j,toggleMode:()=>{g((0,Y.XH)(j==Et?Lt:Et))},fullscreen:m,toggleMarkdownFullscreen:()=>{f((e=>!e))}}),j==Lt&&(0,C.jsx)(kt,{updateDraft:p("markdown"),initialValue:d("markdown"),height:m?"calc(100vh - 168px)":"30vh",placeholder:L,setEditorInstance:u,sendMarkdown:async e=>{k({id:o,reply_mid:w,type:"markdown",content:e,from_uid:b,properties:{local_id:(new Date).getTime()}})}})]})]})},Dt=r.ZP.article`
  position: relative;
  width: 100%;
  background: #fff;
