...
`,b=e=>{let{context:t,to:i,from_uid:n,id:a}=e;const{t:r}=(0,m.$G)(),{normalizeMessage:o,messages:l}=function(){const[e,t]=(0,s.useState)(null),[i,n]=(0,s.useState)(null),[a,{data:r,isError:o,isLoading:l,isSuccess:d}]=(0,g.uv)();return(0,s.useEffect)((()=>{if(r&&d){const t=(0,x.Hr)(r,e);n(t)}}),[r,d,e]),(0,s.useEffect)((()=>{e&&a(e)}),[e]),{normalizeMessage:e=>{t(e)},messages:i,isError:o,isLoading:l,isSuccess:d}}(),[d,c]=(0,s.useState)(null);return(0,s.useEffect)((()=>{a&&o(a)}),[a]),(0,s.useEffect)((()=>{if(l){const e=l.map((e=>{let{from_mid:t}=e;return t}))||[];c((0,v.jsxs)(w,{"data-forwarded-mids":e.join(","),children:[(0,v.jsxs)("h4",{className:"tip",children:[(0,v.jsx)(u.Z,{className:"icon"}),r("action.forward")]}),(0,v.jsx)("div",{className:"list",children:l.map(((e,s)=>{const{user:a={},download:r,content:o,content_type:l,properties:d,thumbnail:c}=e;return(0,v.jsxs)(f.Z,{className:"archive",children:[a&&(0,v.jsx)("div",{className:"avatar",children:(0,v.jsx)(h.Z,{width:24,height:24,src:a.avatar,name:a.name})}),(0,v.jsxs)("div",{className:"details",children:[(0,v.jsx)("div",{className:"up",children:(0,v.jsx)("span",{className:"name",children:(null===a||void 0===a?void 0:a.name)||"Deleted User"})}),(0,v.jsx)("div",{className:"down",children:Y({download:r,context:t,to:i,from_uid:n,content:o,content_type:l,properties:d,thumbnail:c})})]})]},s)}))})]}))}}),[l,t,i,n]),a?d:null};var j=i(84006);const y=p.ZP.div`
  background: #f3f4f6;
...
`,$=e=>{let{value:t,width:i="100%"}=e;return(0,v.jsx)(P,{style:{width:i},children:(0,v.jsx)("div",{className:"progress",style:{width:`${t}%`}})})};var F=i(11972),O=i(24041),M=i(66673),R=i(8969);const U=e=>{let{url:t,name:i,size:n,download:a}=e;const[r,o]=(0,s.useState)(!1),[l,d]=(0,s.useState)(!1),c=(0,x.td)(n);return(0,v.jsxs)("div",{className:"w-96 h-52 relative rounded-md border border-solid border-gray-300 overflow-hidden group",children:[(0,v.jsx)("div",{className:"absolute top-0 left-0 w-full h-full bg-black/40 z-20 group-hover:hidden"}),(0,v.jsxs)("div",{className:"absolute top-0 left-0 w-full flex justify-between z-30 px-3 py-2 overflow-hidden group-hover:bg-black/20",children:[(0,v.jsxs)("div",{className:"flex gap-2 ",children:[(0,v.jsx)(R.Z,{className:"w-9 h-auto"}),(0,v.jsxs)("div",{className:"flex flex-col gap-1 text-sm text-white",children:[(0,v.jsx)("span",{title:i,className:"font-bold whitespace-nowrap text-ellipsis w-[240px] overflow-hidden",children:i}),(0,v.jsx)("span",{children:c})]})]}),(0,v.jsx)("a",{href:a,className:"mt-2",children:(0,v.jsx)(F.Z,{className:"fill-white"})})]}),r?l?(0,v.jsx)("span",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-red-500",children:"Error"}):null:(0,v.jsx)("div",{className:"absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2",children:(0,v.jsx)(M.Z,{color:"#fff"})}),(0,v.jsx)("video",{onPlay:e=>{const t=e.currentTarget.previousSibling;t&&t.classList.add("hidden")},onError:()=>{o(!1),d(!0)},onCanPlay:()=>{o(!0)},onPause:e=>{const t=e.currentTarget.previousSibling;t&&t.classList.remove("hidden")},controls:r,className:"absolute left-0 top-0 w-full h-full object-cover z-10",children:(0,v.jsx)("source",{src:t,type:"video/mp4"})})]})};var I=i(20814),D=i(57425);const T=e=>{let{url:t,name:i,size:n,download:a}=e;const[r,o]=(0,s.useState)(!1),l=(0,x.td)(n);return(0,v.jsxs)("div",{className:"w-96 flex flex-col gap-2 px-3 py-2 rounded-md border border-solid border-gray-300 overflow-hidden bg-[#f1f3f4]",children:[(0,v.jsxs)("div",{className:"flex justify-between z-30 overflow-hidden",children:[(0,v.jsxs)("div",{className:"flex gap-2 ",children:[(0,v.jsx)(I.Z,{className:"w-9 h-auto"}),(0,v.jsxs)("div",{className:"flex flex-col gap-1 text-sm text-gray-700",children:[(0,v.jsx)("span",{title:i,className:"font-bold whitespace-nowrap text-ellipsis w-[240px] overflow-hidden",children:i}),(0,v.jsx)("span",{children:l})]})]}),(0,v.jsx)("a",{href:a,className:"mt-2",children:(0,v.jsx)(F.Z,{className:"download_icon gray"})})]}),(0,v.jsx)("audio",{src:t,onCanPlay:()=>{o(!0)},controls:!0,className:(0,D.Z)("w-full object-cover z-10",r?"":"hidden")})]})},G=e=>e.startsWith("blob:"),W=e=>{let{context:t,to:i,created_at:n,from_uid:a,content:o="",download:l="",thumbnail:d="",properties:c={local_id:0,name:"",size:0,content_type:""}}=e;const[p,f]=(0,s.useState)(null),[h,u]=(0,s.useState)(!1),g=function(e){let{context:t="user",id:i=0}=e;const s=(0,E.TL)(),n="channel"==t?L.nF:C.Fs;return e=>{s(n({id:i,mid:e})),s((0,k.Gd)(e))}}({context:t,id:i}),{sendMessage:m,isSuccess:w,isSending:b}=(0,S.Z)({context:t,from:a,to:i}),{stopUploading:j,data:N,uploadFile:_,progress:P,isSuccess:M}=(0,z.Z)(),R=(0,E.CG)((e=>e.users.byId[a])),{size:I=0,name:D,content_type:W}=null!==c&&void 0!==c?c:{};(0,s.useEffect)((()=>{G(o)&&(async e=>{let{url:t,name:i,type:s}=e;try{if(u(!0),s.startsWith("image")){const e=await(0,x.Ad)(t);f(e)}let e=await fetch(t).then((e=>e.blob())).then((e=>new File([e],i,{type:s})));await _(e),u(!1)}catch(n){u(!1)}})({url:o,name:D,type:W})}),[o,D,W]),(0,s.useEffect)((()=>{const e=null!==c&&void 0!==c?c:{},t=p?{...e,...p}:e;if(M&&G(o)){const{path:e}=N;m({ignoreLocal:!0,type:"file",content:{path:e},properties:t})}}),[M,N,c,o]),(0,s.useEffect)((()=>{w&&URL.revokeObjectURL(o)}),[w,o]);if(!c)return null;const H=(0,x.LP)(W,D);if(!o||!D)return null;const A=h||b;return(0,x.Or)(W,I)?(0,v.jsx)(Z,{uploading:A,progress:P,properties:{...p,...c},content:o,download:l,thumbnail:d},null===c||void 0===c?void 0:c.local_id):W.startsWith("video")&&!A?(0,v.jsx)(U,{size:I,url:o,name:D,download:l}):W.startsWith("audio")&&!A?(0,v.jsx)(T,{size:I,url:o,name:D,download:l}):(0,v.jsx)(y,{className:"file_message "+(A?"sending":""),children:(0,v.jsxs)("div",{className:"basic",children:[H,(0,v.jsxs)("div",{className:"info",children:[(0,v.jsx)("span",{className:"name",children:D}),(0,v.jsx)("span",{className:"details",children:A?(0,v.jsx)($,{value:P,width:"80%"}):(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)("i",{className:"size",children:(0,x.td)(I)}),(0,v.jsx)("i",{className:"time",children:r()(n).fromNow()}),R&&(0,v.jsxs)("i",{className:"from",children:["by ",(0,v.jsx)("strong",{children:R.name})]})]})})]}),A?(0,v.jsx)(O.Z,{className:"cancel",onClick:()=>{j(),URL.revokeObjectURL(o),g(c.local_id)}}):(0,v.jsx)("a",{className:"download",download:D,href:`${o}&download=true`,children:(0,v.jsx)(F.Z,{})})]})})},H=p.ZP.a`
  background: #f3f4f6;
  border: 1px solid #d4d4d4;
  box-sizing: border-box;
  border-radius: 6px;
...
`;function V(e){let{url:t=""}=e;const[i,n]=(0,s.useState)(""),[a]=(0,g.rf)(),[r,o]=(0,s.useState)(null);(0,s.useEffect)((()=>{(async e=>{var t;const{data:i}=await a(e),s=(null===i||void 0===i?void 0:i.title)||(null===i||void 0===i?void 0:i.site_name)||"",r=(null===i||void 0===i?void 0:i.description)||"",l=(null===i||void 0===i||null===(t=i.images.find((e=>!!e.url)))||void 0===t?void 0:t.url)||"",d=(null===i||void 0===i?void 0:i.favicon_url)||`${new URL(e).origin}/favicon.ico`;n(d),o({title:s,description:r,ogImage:l})})(t)}),[t]);if(!t||!r||!r.title)return null;const{title:l,description:d,ogImage:c}=r;return c?(0,v.jsxs)(A,{href:t,target:"_blank",children:[(0,v.jsx)("h3",{className:"title",children:l}),(0,v.jsx)("p",{className:"desc dots",children:d}),(0,v.jsx)("div",{className:"image",children:(0,v.jsx)("img",{src:c,alt:"og image"})})]}):(0,v.jsxs)(H,{href:t,target:"_blank",children:[i&&(0,v.jsx)("div",{className:"favicon",children:(0,v.jsx)("img",{onError:()=>{n("")},src:i,alt:"favicon"})}),(0,v.jsxs)("div",{className:"info",children:[(0,v.jsx)("h3",{className:"title",children:l}),(0,v.jsx)("p",{className:"desc dots",children:d}),(0,v.jsx)("span",{className:"link dots",children:t})]})]})}const Y=e=>{let{context:t,to:i=0,from_uid:a=0,created_at:o,properties:p,content_type:f,content:h,download:u,thumbnail:x,edited:g=!1}=e,m=null;switch(f){case d.bT.text:m=(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(n.Z,{componentDecorator:(e,t,i)=>(0,v.jsxs)(s.Fragment,{children:[(0,v.jsx)("a",{className:"link",target:"_blank",href:e,rel:"noreferrer",children:t},i),!e.startsWith("mailto")&&(0,v.jsx)(V,{url:e})]},i),children:l()(h,/(\s{1}@[0-9]+\s{1})/g,((e,t)=>{const s=e.trim().slice(1);return(0,v.jsx)(c.Z,{uid:+s,cid:i},t)}))}),g&&(0,v.jsx)("span",{className:"edited",title:r()(+g).format("YYYY-MM-DD h:mm:ss A"),children:"(edited)"})]});break;case d.bT.markdown:m=(0,v.jsx)(j.Z,{content:h});break;case d.bT.file:m=(0,v.jsx)(W,{properties:p,context:t,to:i,download:u,thumbnail:x,from_uid:a,created_at:o,content:h});break;case d.bT.archive:m=(0,v.jsx)(b,{properties:p,context:t,to:i,from_uid:a,created_at:o,id:h,thumbnail:x})}return m}},17150:(e,t,i)=>{i.d(t,{Z:()=>s});const s=i(57889).ZP.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 16px;
