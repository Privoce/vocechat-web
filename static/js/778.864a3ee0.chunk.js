...
`;var y=n(63211),w=n(50911),C=n(66160),j=n(71893),E=n(80683);const N=e=>{let{uid:t,type:n="embed",cid:i}=e;const{t:a}=(0,j.$)(["member","common"]),{canCall:o,call:r,canCopyEmail:d,copyEmail:p,removeFromChannel:u,canRemoveFromChannel:m,canRemove:h,removeUser:x}=(0,w.Z)({uid:t,cid:i}),{data:N}=(0,C.CG)((e=>({data:e.users.byId[t]})));if(!N)return null;const{name:Z,email:k,avatar:L}=N,O="card"==n&&o,S="embed"==n&&h,_=O||k||m||S;return(0,E.jsxs)(b,{className:n,children:[(0,E.jsx)(v.Z,{className:"rounded-full w-20 h-20 object-cover",url:L,name:Z}),(0,E.jsx)("h2",{className:"text-lg select-text font-bold text-[#1c1c1e]",children:Z}),(0,E.jsx)("span",{className:"text-sm text-[#98a2b3] select-text",children:k}),(0,E.jsxs)("ul",{className:"icons",children:[(0,E.jsx)(l.OL,{to:`/chat/dm/${t}`,children:(0,E.jsxs)("li",{className:"icon chat",children:[(0,E.jsx)(c,{}),(0,E.jsx)("span",{className:"txt",children:a("send_msg")})]})}),O&&(0,E.jsxs)("li",{className:"icon call",onClick:r,children:[(0,E.jsx)(f,{}),(0,E.jsx)("span",{className:"txt",children:a("call")})]}),(0,E.jsx)(s.ZP,{disabled:!_,interactive:!0,popperOptions:{strategy:"fixed"},placement:"bottom-start",trigger:"click",hideOnClick:!0,content:(0,E.jsxs)(y.Z,{children:[O&&(0,E.jsx)("li",{className:"item",onClick:r,children:a("call")}),d&&(0,E.jsx)("li",{className:"item",onClick:p.bind(void 0,k),children:a("copy_email")}),m&&(0,E.jsx)("li",{className:"item danger",onClick:u.bind(null,t),children:a("remove_from_channel")}),S&&(0,E.jsx)("li",{className:"item danger",onClick:x.bind(null,t),children:a("remove")})]}),children:(0,E.jsxs)("li",{className:"icon more "+(_?"":"disabled"),children:[(0,E.jsx)(g,{}),(0,E.jsx)("span",{className:"txt",children:a("more",{ns:"common"})})]})})]})]})},Z=(0,a.memo)(N)},63211:(e,t,n)=>{n.d(t,{Z:()=>i});const i=n(57889).ZP.ul`
  display: flex;
  flex-direction: column;
  gap: 2px;
  padding: 4px;
...
`;var l=n(96954),s=n(7699),o=n.n(s),r=n(20814),c=n(8969),d=n(26906),p=n(31271),u=n(79884),f=n(80308),m=n(66160),h=n(71893),x=n(80683);const g=function(){const{t:e}=(0,h.$)("fav"),[t,n]=(0,i.useState)(""),[s,g]=(0,i.useState)([]),v=[{icon:(0,x.jsx)(d.Z,{className:"icon"}),title:e("all_items"),filter:""},{icon:(0,x.jsx)(p.Z,{className:"icon"}),title:e("image"),filter:"image"},{icon:(0,x.jsx)(c.Z,{className:"icon"}),title:e("video"),filter:"video"},{icon:(0,x.jsx)(r.Z,{className:"icon"}),title:e("audio"),filter:"audio"}],{favorites:b,channelData:y,userData:w}=(0,m.CG)((e=>({favorites:e.favorites,userData:e.users.byId,channelData:e.channels.byId}))),C=e=>{n(e)};return(0,i.useEffect)((()=>{if(t)switch(t){case"audio":g(b.filter((e=>(e.messages||[]).every((e=>{var t;const n=null===(t=e.properties)||void 0===t?void 0:t.content_type;return e.content_type==f.bT.file&&n.startsWith("audio")})))));break;case"video":g(b.filter((e=>(e.messages||[]).every((e=>{var t;const n=null===(t=e.properties)||void 0===t?void 0:t.content_type;return e.content_type==f.bT.file&&n.startsWith("video")})))));break;case"image":{const e=b.filter((e=>(e.messages||[]).every((e=>{var t;const n=null===(t=e.properties)||void 0===t?void 0:t.content_type;return e.content_type==f.bT.file&&n.startsWith("image")}))));g(e)}}else g(b)}),[t,b]),(0,x.jsxs)(a,{children:[(0,x.jsx)("div",{className:"left",children:(0,x.jsx)("ul",{className:"filters",children:v.map((e=>{let{icon:n,title:i,filter:a}=e;return(0,x.jsxs)("li",{className:"filter "+(a==t?"active":""),onClick:C.bind(null,a),children:[n,(0,x.jsx)("span",{className:"txt",children:i})]},a)}))})}),(0,x.jsx)("div",{className:"right",children:s.map((e=>{var t,n;let{id:i,created_at:a,messages:s}=e;if(!s||0==s.length)return null;const[{source:{gid:r,uid:c}}]=s,d=r?(0,x.jsxs)("span",{className:"from channel",children:[(0,x.jsx)(u.Z,{className:"icon"})," ",null===(t=y[r])||void 0===t?void 0:t.name]}):(0,x.jsxs)("span",{className:"from user",children:["From ",(0,x.jsx)("strong",{children:null===(n=w[c])||void 0===n?void 0:n.name})]});return(0,x.jsxs)("div",{className:"container",children:[(0,x.jsxs)("h4",{className:"tip",children:[d,o()(a).format("YYYY-MM-DD")]}),(0,x.jsx)(l.Z,{id:i},i)]},i)}))})]})}}}]);