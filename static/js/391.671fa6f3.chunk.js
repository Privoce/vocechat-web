"use strict";(globalThis.webpackChunkvocechat_web=globalThis.webpackChunkvocechat_web||[]).push([[391],{75157:(e,n,s)=>{s.r(n),s.d(n,{default:()=>E});var a=s(70537),l=s(15924),i=s(64084),t=s(27418),c=s(57889),r=s(80874),d=s(6144),o=s(66160);function u(e){const{channel:n,loginUid:s}=(0,o.CG)((n=>{var s;return{channel:n.channels.byId[e],loginUid:null===(s=n.authData.user)||void 0===s?void 0:s.uid}})),[a,{isLoading:l,isSuccess:i}]=(0,d.tW)(),[t,{isLoading:c,isSuccess:r}]=(0,d.VJ)(),u=s==(null===n||void 0===n?void 0:n.owner);return{otherMembers:(null===n||void 0===n?void 0:n.members.filter((e=>e!=s)))||[],transferOwner:n=>{n&&a({id:e,owner:n})},leaveChannel:()=>{e&&t(e)},leaving:c,leaveSuccess:r,isOwner:u,transferring:l,transferSuccess:i}}var h=s(40698),v=s(69885),m=s(6458),p=s(80683);const x=c.ZP.ul`
  display: flex;
