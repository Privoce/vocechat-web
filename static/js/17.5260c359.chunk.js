...
`,v=()=>{const{pathname:e}=(0,a.TH)();return(0,d.jsx)(f,{children:(0,d.jsx)("li",{className:"menu link_navs",children:(0,d.jsx)(n.OL,{className:"link",to:`/setting?f=${e}`,children:(0,d.jsx)(g.Z,{placement:"right",tip:"Settings",children:(0,d.jsx)("img",{src:m,alt:"setting icon",className:"w-6 h-6 max-w-[unset]"})})})})})};var x=s(7699),b=s.n(x),w=s(98090),C=s.n(w),k=s(3074),j=s(96157),y=s(2101),_=s(53517),E=s(1823),L=s(88332),N=s(53429),O=s(27197),Z=s(81980),S=s(75265),M=s(12564);const I=()=>{const[e,t]=(0,r.useState)(!1),s=(0,k.I0)();return{rehydrate:async()=>{const e={channels:[],users:[],fileMessage:{},channelMessage:{},userMessage:{},reactionMessage:{},message:{replying:{}},footprint:{},ui:{},server:{}},r=Object.keys(window.CACHE);await Promise.all(r.map((t=>{var s;return null===(s=window.CACHE[t])||void 0===s?void 0:s.iterate(((s,r)=>{switch(t){case"channels":s&&e.channels.push(s);break;case"users":s&&e.users.push(s);break;case"footprint":e.footprint[r]=s;break;case"ui":e.ui[r]=s;break;case"messageChannel":e.channelMessage[r]=s;break;case"messageFile":e.fileMessage[r]=s||[];break;case"messageDM":e.userMessage[r]=s;break;case"messageReaction":e.reactionMessage[r]=s;break;case"message":e.message[r]=s;break;case"server":e.server[r]=s}}))}))),s((0,O.i2)(e.users)),s((0,y.tD)(e.server)),s((0,N.vB)(e.channels)),s((0,S.Cb)(e.fileMessage.list)),s((0,E.sL)(e.channelMessage)),s((0,L.Cc)(e.userMessage)),s((0,_.KC)(e.message)),s((0,Z.ZN)(e.footprint)),s((0,M.HM)(e.ui)),s((0,j.kY)(e.reactionMessage)),t(!0)},rehydrated:e}};var P=s(80308);const D=[{storeName:"channels",description:"store channel list"},{storeName:"users",description:"store user list"},{storeName:"messageDM",description:"store DM message with IDs"},{storeName:"messageChannel",description:"store channel message with IDs"},{storeName:"message",description:"store message with key-val full data"},{storeName:"messageFile",description:"store file message list refs"},{storeName:"messageReaction",description:"store message reaction with key-val full data"},{storeName:"footprint",description:"store user visit data"},{storeName:"server",description:"store server data"},{storeName:"ui",description:"store UI state"}],T=()=>{const e=`local_db_${localStorage.getItem(P.kK)||""}_v_${P.YM.split(".").join("_")}`;window.CACHE={},D.forEach((t=>{let{storeName:s,description:r}=t;window.CACHE[s]=C().createInstance({name:e,storeName:s,description:r})}))};var R=s(24783),B=s(52334),H=s(65809),U=s(27418),F=s(21645),G=s(64488),$=s(38289),A=s(15312);let V,W=!1,z=0;function K(){const e=(0,r.useRef)(!1),[t]=(0,A.SO)(),[s,a]=(0,r.useState)(!1),{authData:{user:n},ui:{ready:i},footprint:{afterMid:o,usersVersion:l,readUsers:d,readChannels:u}}=(0,c.CG)((e=>e)),p=(0,c.TL)(),h=(null===n||void 0===n?void 0:n.uid)||0,g=e=>{window.clearTimeout(z),z=window.setTimeout((()=>{f(),m()}),null!==e&&void 0!==e?e:2e4)},m=(0,r.useCallback)((async()=>{if(W)return;if(window.clearTimeout(z),V&&(V.readyState===EventSource.OPEN||V.readyState===EventSource.CONNECTING))return;const{token:s,refreshToken:r,expireTime:a}={token:localStorage.getItem(P.JE)||"",refreshToken:localStorage.getItem(P.Ie)||"",expireTime:Number(localStorage.getItem(P.Wv)||+new Date)};if(!s)return;let n=s;if(b()().isAfter(new Date(a-2e4))){const e=await t({token:s,refresh_token:r});if("error"in e)return;n=e.data.token}const c={"api-key":n};0!==o&&(c.after_mid=`${o}`),0!==l&&(c.users_version=`${l}`),V=new EventSource(`${P.ZP}/user/events?${(e=>{const t=new URLSearchParams;return Object.entries(e).forEach((e=>{let[s,r]=e;r&&t.append(s,r)})),t.toString()})(c)}`),V.onopen=()=>{e.current=!0,W=!0},V.onerror=e=>{const{readyState:t}=e.target;t!==EventSource.OPEN&&t!==EventSource.CONNECTING&&(W=!1,g(2e3))},V.onmessage=e=>{const t=JSON.parse(e.data),{type:s}=t;switch(s){case"heartbeat":g();break;case"ready":g(),p((0,M.Uc)());break;case"users_snapshot":{const{version:e}=t;p((0,Z.uM)(e))}break;case"users_log":{const{logs:e}=t;p((0,O.ii)(e)),e.forEach((e=>{const{uid:t,action:s,log_id:r,...a}=e;t===h&&"update"===s&&p((0,F.L2)((0,$.omitBy)(a,$.isNull)))}))}break;case"user_settings":case"user_settings_changed":Object.keys(t).forEach((e=>{switch(e){case"read_index_groups":p((0,Z.TP)(t[e]));break;case"read_index_users":p((0,Z.RT)(t[e]));break;case"add_mute_users":case"mute_users":case"add_mute_groups":case"mute_groups":{const s=t[e];if(s&&s.length){const t=e.endsWith("users")?"add_users":"add_groups";p((0,Z.Uw)({[t]:s}))}}break;case"remove_mute_users":case"remove_mute_groups":{const s=t[e];if(s&&s.length){const t=e.endsWith("users")?"remove_users":"remove_groups";p((0,Z.Uw)({[t]:s}))}}}}));break;case"users_state":case"users_state_changed":{let{type:e,...s}=t;const r="users_state_changed"==e?[s]:s.users;p((0,O._D)(r))}break;case"kick":switch(t.reason){case"login_from_other_device":p((0,F.sQ)()),(0,U.ZP)("kicked from the other device");break;case"delete_user":p((0,F.sQ)()),(0,U.ZP)("Your account has been deleted")}break;case"related_groups":p((0,N.vB)(t.groups));break;case"joined_group":p((0,N.mR)(t.group));break;case"group_changed":{const{gid:e,...s}=t;p((0,N.pW)({gid:e,...s}))}break;case"user_joined_group":{const{gid:e,uid:s}=t;p((0,N.pW)({operation:"add_member",gid:e,members:s}))}break;case"user_leaved_group":{const{gid:e,uid:s}=t;s.findIndex((e=>e==h))>-1?p((0,N.OG)(e)):p((0,N.pW)({operation:"remove_member",gid:e,members:s}))}break;case"kick_from_group":p((0,N.OG)(t.gid));break;case"pinned_message_updated":p((0,N.ac)(t));break;case"chat":(0,G.Z)(t,p,{ready:i,loginUid:h,readUsers:d,readChannels:u})}}}),[o,l]),f=()=>{V&&(V.close(),V=void 0,W=!1)};return(0,r.useEffect)((()=>{const t=e.current;return s&&!t&&m(),()=>{s&&!t&&f()}}),[s]),{setStreamingReady:a,startStreaming:m,stopStreaming:f}}var Q=s(6144);let J=!1;var Y=s(26369),q=s(53081);let X=!1,ee=!1;const te=e=>{const[t,s]=(0,r.useState)("");if(navigator.serviceWorker){const t=(0,q.KL)((0,Y.ZF)(P.qe));if(X||ee)return;X=!0,(0,q.LP)(t,{vapidKey:e}).then((e=>{e&&s(e),X=!1})).catch((e=>{X=!1,ee=!0}))}return t};let se=!1,re=!1;const ae=()=>{const e=te(P.um),[t]=(0,A.Vd)();return(0,r.useEffect)((()=>{(async e=>{if(e&&!re&&!se)try{re=!0,await t(e),se=!0}catch{re=!1,se=!0}})(e)}),[e]),null},ne=(0,r.memo)(ae);var ie=s(80874),oe=s(25552),le=s(69885);const ce=i.ZP.div`
  position: relative;
  margin-top: 15px;
  pointer-events: all;
  width: 406px;
