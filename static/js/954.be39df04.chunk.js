"use strict";(globalThis.webpackChunkvocechat_web=globalThis.webpackChunkvocechat_web||[]).push([[954],{643:(e,t,n)=>{n.d(t,{Z:()=>c});var i=n(7313),s=n(9184),a=n(6417);const o=s.ZP.form`
  > .option {
    &:not(:last-child) {
      margin-bottom: 8px;
    }
...
`;function y(e){let{serverName:t,nextStep:n}=e;const s=(0,u.I0)(),[a,{isLoading:o,error:l}]=(0,f.QK)(),[p,{isLoading:d,isSuccess:m,error:g}]=(0,b.YA)(),{data:y}=(0,f.z3)(),[j,{isLoading:N,isSuccess:S}]=(0,f.e2)(),[k,C]=(0,i.useState)(""),[T,Z]=(0,i.useState)(""),[z,P]=(0,i.useState)("");return(0,i.useEffect)((()=>{void 0!==l&&x.ZP.error(`Failed to sign up: ${l.data}`)}),[l]),(0,i.useEffect)((()=>{void 0!==g&&x.ZP.error(`Login failed: ${g.data}`)}),[g]),(0,i.useEffect)((()=>{m&&(s((0,w.R4)(!0)),setTimeout((()=>{j({...y,name:t})}),0))}),[m]),(0,i.useEffect)((()=>{S&&n()}),[S]),(0,c.jsxs)(v,{children:[(0,c.jsx)("span",{className:"primaryText",children:"Now let\u2019s set up your admin account"}),(0,c.jsx)("span",{className:"secondaryText",children:"You are the 1st user and admin of your space!"}),(0,c.jsx)(h.Z,{className:"input",placeholder:"Enter your email",value:k,onChange:e=>C(e.target.value)}),(0,c.jsx)(h.Z,{className:"input",type:"password",placeholder:"Enter your password",value:T,onChange:e=>Z(e.target.value)}),(0,c.jsx)(h.Z,{className:"input",type:"password",placeholder:"Confirm your password",value:z,onChange:e=>P(e.target.value)}),(0,c.jsx)(r.Z,{className:"button",onClick:async()=>{""!==k?""!==T?T===z?(await a({email:k,name:"Admin",password:T,gender:0}),await p({email:k,password:T,type:"password"})):x.ZP.error("Two passwords do not match!"):x.ZP.error("Please enter admin password!"):x.ZP.error("Please enter admin email!")},children:o||d||N?"...":"Sign Up"})]})}var j=n(643);const N=o.ZP.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
`;function S(e){let{nextStep:t}=e;const{data:n}=(0,f.ww)(),[s,{isSuccess:a,error:o}]=(0,f.QP)(),[l,p]=(0,i.useState)(void 0);return(0,i.useEffect)((()=>{n&&p(n.who_can_sign_up)}),[n]),(0,i.useEffect)((()=>{void 0!==o&&x.ZP.error(`Failed to update sign up rule: ${o.data}`)}),[o]),(0,i.useEffect)((()=>{a&&t()}),[a]),(0,c.jsxs)(N,{children:[(0,c.jsx)("span",{className:"primaryText",children:"Last step: invite others!"}),(0,c.jsx)("span",{className:"secondaryText",children:"Firstly, who can sign up to this server?"}),(0,c.jsx)(j.Z,{options:["Everyone","Invitation link only"],values:["EveryOne","InvitationOnly"],value:l,onChange:p}),(0,c.jsx)(r.Z,{className:"button",disabled:!l,onClick:()=>{void 0!==n&&s({...n,who_can_sign_up:l})},children:"Confirm"})]})}var k=n(9559);const C=o.ZP.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
