...
`,v=e=>{let{issuers:t}=e;const{t:i}=(0,g.$G)("auth"),[s,o]=(0,n.useState)(!1);return t?(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(l,{onClick:()=>{o(!0)},children:i("login.oidc")}),s&&(0,h.jsx)(m.Z,{id:"modal-modal",children:(0,h.jsxs)(b,{title:"Login with OIDC",children:[t.filter((e=>e.enable)).map(((e,t)=>(0,h.jsx)(w,{issuer:e},t))),(0,h.jsx)(r.Z,{className:"border_less ghost buttonCancel",onClick:()=>{o(!1)},children:"Close"})]})})]}):null};var j=i(17237),y=i(15924);const C=(0,a.ZP)(r.Z)`
  width: 100%;
  margin-bottom: 16px;
`;function k(){const e=(0,y.s0)();return(0,h.jsx)(C,{onClick:()=>{e("/send_magic_link")},children:"Sign in with Magic Link"})}function Z(e){let{smtp:t=!1}=e;const{t:i}=(0,g.$G)("auth"),n=(0,y.s0)();return(0,h.jsxs)("div",{className:"flex gap-1 mt-7 text-sm text-[#667085] justify-center",children:[(0,h.jsx)("span",{children:i("login.no_account")}),(0,h.jsx)("a",{className:"text-[#22d3ee] cursor-pointer",onClick:()=>{n(t?"/send_magic_link":"/register")},children:i("sign_up")})]})}var _=i(65809),E=i(25089),S=i(42712),N=i(63674),P=i(49879);function O(){const{t:e}=(0,g.$G)("auth"),{data:t}=(0,_.n8)(),[i,{isSuccess:a,isLoading:l,error:d}]=(0,p.YA)(),{clientId:u}=(0,E.Z)(),{config:f}=(0,S.Z)(),{data:m,isSuccess:w}=(0,_.ww)(),[b,y]=(0,n.useState)({email:"",password:""});(0,n.useEffect)((()=>{const e=new URLSearchParams(location.search),t=e.get("code"),n=e.get("state"),s=e.get("magic_token"),o=e.get("exists");if(t&&n&&i({code:t,state:n,type:"oidc"}),s&&"undefined"!==typeof o){"true"==o?i({magic_token:s,type:"magiclink"}):location.href=`?magic_token=${s}#/register/set_name/login`}}),[]),(0,n.useEffect)((()=>{if(d)switch(d.status){case 401:case 404:s.ZP.error("Username or Password incorrect");break;case 410:s.ZP.error("No associated account found, please contact user admin for an invitation link to join.");break;case"PARSING_ERROR":break;default:s.ZP.error("Something Error")}else;}),[d]),(0,n.useEffect)((()=>{a&&s.ZP.success("Login Successfully")}),[a]);const C=e=>{const{type:t}=e.target.dataset,{value:i}=e.target;t&&y((e=>(e[t]=i,{...e})))},{email:O,password:L}=b;if(!w)return null;const{magic_link:M,github:I,google:$,metamask:R,oidc:z=[],who_can_sign_up:A}=m,G=t&&M,B=$&&u,q=G||B||R||z.length>0||I;return(0,h.jsx)(c,{children:(0,h.jsxs)("div",{className:"form",children:[(0,h.jsxs)("div",{className:"tips",children:[(0,h.jsx)("img",{src:`${o.ZP}/resource/organization/logo`,alt:"logo",className:"logo"}),(0,h.jsx)("h2",{className:"title",children:e("login.title")}),(0,h.jsx)("span",{className:"desc",children:e("login.desc")})]}),(0,h.jsxs)("form",{onSubmit:e=>{e.preventDefault(),i({...b,type:"password"})},children:[(0,h.jsx)(j.Z,{className:"large",name:"email",value:O,type:"email",required:!0,placeholder:e("placeholder_email"),"data-type":"email",onChange:C}),(0,h.jsx)(j.Z,{className:"large",type:"password",value:L,name:"password",required:!0,"data-type":"password",onChange:C,placeholder:e("placeholder_pwd")}),(0,h.jsx)(r.Z,{type:"submit",disabled:l,children:l?"Signing":e("sign_in")})]}),q&&(0,h.jsx)("hr",{className:"or"}),(0,h.jsxs)("div",{className:"btns",children:[G&&(0,h.jsx)(k,{}),B&&(0,h.jsx)(N.Z,{clientId:u}),I&&(0,h.jsx)(P.Z,{client_id:null===f||void 0===f?void 0:f.client_id}),R&&(0,h.jsx)(x,{login:i}),z.length>0&&(0,h.jsx)(v,{issuers:z})]}),"EveryOne"===A&&(0,h.jsx)(Z,{smtp:t})]})})}}}]);