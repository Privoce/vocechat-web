...
`;function w(e){let{issuers:t}=e;const[n,s]=(0,i.useState)(!1);return t?(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(c,{onClick:()=>{s(!0)},children:"Sign in with OIDC"}),n&&(0,h.jsx)(m.Z,{id:"modal-modal",children:(0,h.jsxs)(b,{title:"Login with OIDC",children:[t.filter((e=>e.enable)).map(((e,t)=>(0,h.jsx)(x,{issuer:e},t))),(0,h.jsx)(r.Z,{className:"border_less ghost buttonCancel",onClick:()=>{s(!1)},children:"Close"})]})})]}):null}var C=n(4050),v=n(7890);const j=(0,o.ZP)(r.Z)`
  width: 100%;
  margin-bottom: 16px;
