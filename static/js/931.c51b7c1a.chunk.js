...
`,o=e=>{let{url:i="",name:s="",type:a="user",uploadImage:o,disabled:d=!1}=e;const[M,x]=(0,t.useState)(!1);return(0,c.jsxs)(r,{children:[(0,c.jsxs)("div",{className:"avatar",children:[(0,c.jsx)(l.Z,{type:a,url:i,name:s}),!d&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("div",{className:"tip",children:M?"Uploading":"Change Avatar"}),(0,c.jsx)("input",{multiple:!1,onChange:async e=>{if(M)return;if(!e.target.files)return;const[i]=Array.from(e.target.files);x(!0),await o(i),x(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,c.jsx)("img",{src:n,alt:"icon",className:"icon"})]})}},1205:(e,i,s)=>{s.d(i,{Z:()=>E});var t=s(537),a=s(7829),l=s(9195),n=s(7418),c=s(2334),r=s(6458),o=s(7889);const d=o.ZP.section`
  display: flex;
