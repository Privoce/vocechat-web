...
`,be=e=>{let{closeModal:s}=e;const{t:t}=(0,d.$)("auth"),{t:i}=(0,d.$)(),[l,n]=(0,a.useState)(!1),{logout:c,exited:r,exiting:o,clearLocalData:M}=(0,Ce.Z)();return(0,a.useEffect)((()=>{r&&(l&&M(),u.ZP.success("Logout Successfully"))}),[r,l]),(0,_.jsx)(re.Z,{id:"modal-modal",children:(0,_.jsx)(Ae,{title:t("logout.title"),description:t("logout.desc"),buttons:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(Q.Z,{onClick:s,children:i("action.cancel")}),(0,_.jsx)(Q.Z,{onClick:()=>{c()},className:"danger",children:o?"Logging out":i("action.logout")})]}),children:(0,_.jsxs)("div",{className:"clear",children:[(0,_.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:t("logout.clear_local")}),(0,_.jsx)(fe.Z,{name:"clear_cb",checked:l,onChange:e=>{n(e.target.checked)}})]})})})};let ke="";function Ue(){const{t:e}=(0,d.$)(),[s]=(0,i.lr)(),t=ve(),c=t.map((e=>{let{items:s}=e;return s})).flat(),r=s.get("nav"),[o,M]=(0,a.useState)(!1),j=(0,l.s0)();ke=ke||(s.get("f")||"/");const u=()=>{M((e=>!e))},x=c.find((e=>e.name==r))||c[0];return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(n.Z,{nav:x,closeModal:()=>{j(ke),ke=""},title:e("setting"),navs:t,dangers:[{title:e("action.logout"),handler:u}],children:x.component}),o&&(0,_.jsx)(be,{closeModal:u})]})}}}]);