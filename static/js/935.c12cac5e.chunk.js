...
`,M=e=>{let{type:t="login",source:i="webapp",client_id:n}=e;const{t:o}=(0,v.$G)("auth");(0,a.useEffect)((()=>{const e=e=>{const{key:t,newValue:i}=e;if("widget"==t&&i){localStorage.removeItem("widget");const e=window.parent;e&&e.postMessage("RELOAD_WITH_OPEN","*")}};return"widget"==i&&window.addEventListener("storage",e),()=>{"widget"==i&&window.removeEventListener("storage",e)}}),[i]);return(0,C.jsxs)(I,{onClick:()=>{const e=`https://github.com/login/oauth/authorize?client_id=${n}&redirect_uri=${location.origin}/github/cb/${i}.html`;"webapp"==i?location.href=e:window.open(e)},children:[(0,C.jsx)(N,{className:"icon"}),` ${o("login"===t?"login.github":"reg.github")}`]})};var O=i(70479);const P=i.p+"static/media/metamask.f04d5fb63394197766d0.svg";var L=i(64813);function $(e){let{login:t,type:i="login"}=e;const{t:n}=(0,v.$G)("auth"),[o,s]=(0,a.useState)(!1),[r,l]=(0,a.useState)([]),[c]=(0,b.sZ)(),d=(0,a.useRef)();(0,a.useEffect)((()=>{function e(e){l(e)}return d.current||(d.current=new O.Z),O.Z.isMetaMaskInstalled()&&window.ethereum.on("accountsChanged",e),()=>{O.Z.isMetaMaskInstalled()&&window.ethereum.removeListener("accountsChanged",e)}}),[]),(0,a.useEffect)((()=>{if(O.Z.isMetaMaskInstalled())if(r.length>0){var e;const[i]=r;(async e=>{const{data:i,isSuccess:n}=await c(e);if(n){const n=await p(e,i);t({public_address:e,nonce:i,signature:n,type:"metamask"})}})(i),s(!0),null===(e=d.current)||void 0===e||e.stopOnboarding()}else s(!1)}),[r]);const p=async(e,t)=>await window.ethereum.request({method:"personal_sign",params:[t,e,"hello from "]});return(0,C.jsxs)(L.I,{disabled:o,onClick:async()=>{if(O.Z.isMetaMaskInstalled()){s(!0);try{const e=await window.ethereum.request({method:"eth_requestAccounts"});l(e)}catch(t){window.ethereum.request({method:"wallet_requestPermissions",params:[{eth_accounts:{}}]})}s(!1)}else{var e;null===(e=d.current)||void 0===e||e.startOnboarding()}},children:[(0,C.jsx)("img",{className:"icon",src:P,alt:"meta mask icon"}),n("login"==i?"login.metamask":"reg.metamask")]})}var z=i(40698),A=i(80874);const R=e=>{let{issuer:t}=e;const[i,{data:n,isLoading:o,isSuccess:s}]=(0,b.CB)();return(0,a.useEffect)((()=>{if(s&&n){const{url:e}=n;location.href=e}}),[n,s]),(0,C.jsxs)(L.I,{disabled:o||s,onClick:()=>{i({issuer:t.domain,redirect_uri:`${location.origin}/#/login`})},children:[!!t.favicon&&(0,C.jsx)("img",{src:t.favicon,className:"icon",alt:"icon"}),o?"Loading...":`Login with ${t.domain}`]})},G=(0,g.ZP)(z.Z)`
  text-align: center;
...
`,B=e=>{let{issuers:t,type:i="login"}=e;const{t:n}=(0,v.$G)("auth"),[o,s]=(0,a.useState)(!1);return t?(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(L.I,{onClick:()=>{s(!0)},children:n("login"==i?"login.oidc":"reg.oidc")}),o&&(0,C.jsx)(A.Z,{id:"modal-modal",children:(0,C.jsxs)(G,{title:"Login with OIDC",children:[t.filter((e=>e.enable)).map(((e,t)=>(0,C.jsx)(R,{issuer:e},t))),(0,C.jsx)(w.Z,{className:"border_less ghost buttonCancel",onClick:()=>{s(!1)},children:"Close"})]})})]}):null},q=e=>{let{type:t="login"}=e;const{t:i}=(0,v.$G)(),[n,{isSuccess:o}]=(0,b.YA)(),{config:s}=(0,d.Z)(),{data:r,isSuccess:u}=(0,c.ww)(),{clientId:g}=(0,p.Z)();if((0,a.useEffect)((()=>{o&&l.ZP.success(i("tip.login"))}),[o]),!u)return null;const{github:h,google:x,metamask:f,oidc:m=[]}=r,w=x&&!!g;return(0,C.jsxs)(C.Fragment,{children:[w&&(0,C.jsx)(k,{type:t,clientId:g}),h&&(0,C.jsx)(M,{type:t,client_id:null===s||void 0===s?void 0:s.client_id}),f&&(0,C.jsx)($,{type:t,login:n}),m.length>0&&(0,C.jsx)(B,{type:t,issuers:m})]})}},64813:(e,t,i)=>{i.d(t,{I:()=>s,Z:()=>r});var n=i(57889),o=i(69885);const s=(0,n.ZP)(o.Z)`
  width: 100%;
  /* margin-bottom: 16px; */
  display: flex;
  align-items: center;
