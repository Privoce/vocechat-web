...
`,o=e=>{let{url:i="",name:s="",type:a="user",uploadImage:o,disabled:d=!1}=e;const[M,x]=(0,t.useState)(!1);return(0,c.jsxs)(r,{children:[(0,c.jsxs)("div",{className:"avatar",children:[(0,c.jsx)(n.Z,{type:a,url:i,name:s}),!d&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("div",{className:"tip",children:M?"Uploading":"Change Avatar"}),(0,c.jsx)("input",{multiple:!1,onChange:async e=>{if(M)return;if(!e.target.files)return;const[i]=Array.from(e.target.files);x(!0),await o(i),x(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,c.jsx)("img",{src:l,alt:"icon",className:"icon"})]})}},6047:(e,i,s)=>{s.d(i,{Z:()=>z});var t=s(7313),a=s(9184),n=s(2963),l=s(9784),c=s(3657),r=s(6123),o=s(5515),d=s(5281),M=s(9559),x=s(4050),j=s(1140),u=s(6417);const N=a.ZP.div`
  display: flex;
...
`;function z(e){var i;let{cid:s=0}=e;const{contacts:a,channels:M,loginUser:x}=(0,f.CG)((e=>({contacts:e.contacts,channels:e.channels,loginUser:e.authData.user}))),{copyEmail:j,removeFromChannel:N,removeUser:p,canRemove:m,canRemoveFromChannel:w}=(0,y.Z)({cid:s}),[I,{isSuccess:z}]=(0,r.wv)();(0,t.useEffect)((()=>{z&&c.ZP.success("Update Successfully")}),[z]);const E=e=>{let{ignore:i=!1,uid:s=null,isAdmin:t=!0}=e;(0,l.Bn)(),i||I({id:s,is_admin:t})},O=null!==(i=M.byId[s])&&void 0!==i?i:null,v=O?O.is_public?a.ids:O.members:a.ids;return(0,u.jsxs)(L,{children:[(null===x||void 0===x?void 0:x.is_admin)&&(0,u.jsx)(g,{}),(0,u.jsxs)("div",{className:"intro",children:[(0,u.jsx)("h4",{className:"title",children:"Manage Members"}),(0,u.jsx)("p",{className:"desc",children:"Disabling your account means you can recover it at any time after taking this action."})]}),(0,u.jsx)("ul",{className:"members",children:v.map((e=>{const{name:i,email:t,is_admin:l}=a.byId[e],c=O&&O.owner==e,r=x.is_admin&&x.uid!==e,M=t||(null===x||void 0===x?void 0:x.is_admin);return(0,u.jsxs)("li",{className:"member",children:[(0,u.jsxs)("div",{className:"left",children:[(0,u.jsx)(o.Z,{compact:!0,uid:e,interactive:!1}),(0,u.jsxs)("div",{className:"info",children:[(0,u.jsxs)("span",{className:"name",children:[i," ",c&&(0,u.jsx)(h.Z,{})]}),(0,u.jsx)("span",{className:"email",children:t})]})]}),(0,u.jsxs)("div",{className:"right",children:[(0,u.jsxs)("span",{className:"role",children:[l?"Admin":"User",r&&(0,u.jsx)(n.ZP,{interactive:!0,placement:"bottom-end",trigger:"click",content:(0,u.jsxs)(d.Z,{className:"menu",children:[(0,u.jsxs)("li",{className:"item sb",onClick:E.bind(null,{ignore:l,uid:e,isAdmin:!0}),children:["Admin",l&&(0,u.jsx)(T.Z,{className:"icon"})]}),(0,u.jsxs)("li",{className:"item sb",onClick:E.bind(null,{ignore:!l,uid:e,isAdmin:!1}),children:["User",!l&&(0,u.jsx)(T.Z,{className:"icon"})]})]}),children:(0,u.jsx)(_,{className:"icon"})})]}),M&&(0,u.jsx)(n.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,u.jsxs)(d.Z,{className:"menu",children:[t&&(0,u.jsx)("li",{className:"item",onClick:j.bind(null,t),children:"Copy Email"}),w&&(0,u.jsx)("li",{className:"item danger",onClick:N.bind(null,e),children:"Remove From Channel"}),m&&!s&&(0,u.jsx)("li",{className:"item danger",onClick:p.bind(null,e),children:"Remove From Server"})]}),children:(0,u.jsx)("div",{className:"opts",children:(0,u.jsx)("img",{className:"dots",src:D,alt:"dots icon"})})})]})]},e)}))})]})}},5579:(e,i,s)=>{s.d(i,{Z:()=>l});var t=s(9184),a=s(6417);const n=t.ZP.div`
  width: 100%;
  position: absolute;
  bottom: 64px;
  left: 0;
...
`,l=e=>{let{saveHandler:i,resetHandler:s}=e;return(0,a.jsxs)(n,{className:"animate__animated animate__flipInX animate__faster",children:[(0,a.jsx)("span",{className:"txt",children:"You have unsaved changes!"}),(0,a.jsxs)("div",{className:"btns",children:[(0,a.jsx)("button",{className:"btn reset",onClick:s,children:"Reset"}),(0,a.jsx)("button",{className:"btn",onClick:i,children:"Save Changes"})]})]})}},5638:(e,i,s)=>{s.d(i,{Z:()=>o});var t=s(9184),a=s(9466),n=s(7890);const l=s.p+"static/media/arrow.left.92fbb139607631555459.svg";var c=s(6417);const r=t.ZP.div`
  width: 100vw;
  height: 100vh;
  display: flex;
...
`,c={},r={};function o(e){let{options:i,values:s=r,value:a=c,defaultValue:o,onChange:d}=e;const M=(0,t.useId)(),[x,j]=(0,t.useState)(o),u=a!==c?a:x;return(0,n.jsx)(l,{children:i.map(((e,i)=>(0,n.jsxs)("div",{className:"option",children:[(0,n.jsx)("input",{type:"radio",checked:(s!==r?s.indexOf(u):u)===i,onChange:()=>{const e=s===r?i:s[i];a===c&&j(e),d&&d(e)},id:`${M}-${i}`}),(0,n.jsx)("div",{className:"box",children:(0,n.jsx)("label",{htmlFor:`${M}-${i}`,children:e})})]},i)))})}},4458:(e,i,s)=>{s.d(i,{Z:()=>t});const t=s(9184).ZP.textarea`
  font-family: inherit;
  width: 100%;
  background: #ffffff;
  border: 1px solid #e5e7eb;
...
`,j=e=>{let{label:i="Username",valueKey:s="name",value:a="",title:r="Change your username",intro:j="Enter a new username and your existing password.",closeModal:u}=e;const[N,g]=(0,t.useState)(a),[p,{isLoading:m,isSuccess:D}]=(0,c.g$)();return(0,t.useEffect)((()=>{D&&(n.ZP.success("update user info successfully"),u())}),[D]),(0,M.jsx)(d.Z,{id:"modal-modal",children:(0,M.jsx)(x,{title:r,description:j,buttons:(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o.Z,{className:"cancel",onClick:u,children:"Cancel"}),(0,M.jsx)(o.Z,{onClick:()=>{p({[s]:N})},children:m?"Updating":"Done"})]}),children:(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:s,children:i}),(0,M.jsx)(l.Z,{name:s,value:N,onChange:e=>{g(e.target.value)}})]})})})}},5883:(e,i,s)=>{s.d(i,{Z:()=>j});var t=s(7313),a=s(9184),n=s(3657),l=s(4050),c=s(2509),r=s(6571),o=s(1140),d=s(666),M=s(6417);const x=(0,a.ZP)(r.Z)`
  .input {
    margin: 16px 0;
    width: 100%;
    display: flex;
...
`,j=e=>{let{closeModal:i}=e;const{data:s}=(0,c.I1)(),[a,r]=(0,t.useState)({current:"",newPassword:"",confirmPassword:""}),[j,{isLoading:u,isSuccess:N}]=(0,c.a3)(),g=e=>{const{type:i}=e.target.dataset;r((s=>({...s,[i]:e.target.value})))};(0,t.useEffect)((()=>{N&&(n.ZP.success("update password successfully"),i())}),[N]);const{current:p,newPassword:m,confirmPassword:D}=a,h=(null===s||void 0===s?void 0:s.password)&&!p||!m||!D||m!==D||u;return(0,M.jsx)(d.Z,{id:"modal-modal",children:(0,M.jsxs)(x,{title:"Change your password",description:"Enter current password and new password.",buttons:(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o.Z,{className:"cancel",onClick:i,children:"Cancel"}),(0,M.jsx)(o.Z,{disabled:h,onClick:()=>{const{current:e,newPassword:i}=a;j({old_password:e,new_password:i})},children:u?"Updating":"Update"})]}),children:[(null===s||void 0===s?void 0:s.password)&&(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:"current",children:"Current Password"}),(0,M.jsx)(l.Z,{type:"password",id:"current",name:"current",value:p,"data-type":"current",onChange:g})]}),(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:"newPassword",children:"New Password"}),(0,M.jsx)(l.Z,{type:"password",name:"newPassword",value:m,"data-type":"newPassword",onChange:g})]}),(0,M.jsxs)("div",{className:"input",children:[(0,M.jsx)("label",{htmlFor:"confirmPassword",children:"Confirm New Password"}),(0,M.jsx)(l.Z,{onBlur:()=>{const{newPassword:e,confirmPassword:i}=a;e!==i&&n.ZP.error("Not same with new password")},type:"password",name:"confirmPassword",value:D,"data-type":"confirmPassword",onChange:g})]})]})})}},875:(e,i,s)=>{s.r(i),s.d(i,{default:()=>ue});var t=s(7313),a=s(9466),n=s(7890),l=s(5638),c=s(6880),r=s(9184),o=s(3657),d=s(2378),M=s(3960),x=s(4050),j=s(7169),u=s(4458),N=s(5579),g=s(643),p=s(8529),m=s(6417);const D=r.ZP.div`
  position: relative;
  width: 512px;
  height: 100%;
  display: flex;
...
`;function h(){const{loginUser:e,server:i}=(0,p.CG)((e=>({loginUser:e.authData.user,server:e.server}))),[s,a]=(0,t.useState)(!1),[n,l]=(0,t.useState)(i),[c,r]=(0,t.useState)(null),{data:h,refetch:w}=(0,d.ww)(),[I,{isSuccess:_}]=(0,d.e2)(),[T,{isSuccess:y}]=(0,d.jd)(),[f,{isSuccess:L}]=(0,d.QP)(),z=e=>{const i=e.target.value,{type:s}=e.target.dataset;l((e=>({...e,[s]:i})))};if((0,t.useEffect)((()=>{y&&o.ZP.success("Update logo successfully!")}),[y]),(0,t.useEffect)((()=>{i&&l(i)}),[i]),(0,t.useEffect)((()=>{h&&r(h)}),[h]),(0,t.useEffect)((()=>{if(i&&n&&h&&c){const{name:e,description:s}=n,{name:t,description:l}=i,{who_can_sign_up:r}=c,{who_can_sign_up:o}=h;a(t!==e||l!==s||o!==r)}}),[i,n,h,c]),(0,t.useEffect)((()=>{_&&L&&(o.ZP.success("Configuration updated!"),w())}),[_,L]),!n||!c)return null;const{name:E,description:O,logo:v}=n,{who_can_sign_up:C}=c,b=null===e||void 0===e?void 0:e.is_admin;return(0,m.jsxs)(D,{children:[(0,m.jsxs)("div",{className:"logo",children:[(0,m.jsx)("div",{className:"preview",children:(0,m.jsx)(M.Z,{disabled:!b,url:y?`${v}?t=${+new Date}`:v,name:E,uploadImage:T})}),b&&(0,m.jsx)("div",{className:"upload",children:(0,m.jsx)("div",{className:"tip",children:"Minimum size is 128x128, We recommend at least 512x512 for the server. Max size limited to 5M."})})]}),(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"name",children:"Server Name"}),(0,m.jsx)(x.Z,{disabled:!b,"data-type":"name",onChange:z,value:E,name:"name",id:"name",placeholder:"Server Name"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"desc",children:"Server Description"}),(0,m.jsx)(u.Z,{disabled:!b,"data-type":"description",onChange:z,value:null!==O&&void 0!==O?O:"",rows:4,name:"name",id:"name",placeholder:"Tell the world a bit about this server"})]}),b&&(0,m.jsxs)("div",{className:"radioButton",children:[(0,m.jsx)("p",{className:"label",children:"Default Sign Up"}),(0,m.jsx)("p",{className:"tip",children:"Who can sign up this server."}),(0,m.jsx)(g.Z,{options:["Everyone","Invitation Link Only"],values:["EveryOne","InvitationOnly"],value:C,onChange:e=>r({...h,who_can_sign_up:e})})]})]}),s&&(0,m.jsx)(N.Z,{saveHandler:()=>{const{name:i,description:s}=n;I({name:i,description:s}),null!==e&&void 0!==e&&e.is_admin&&f({...h,who_can_sign_up:c.who_can_sign_up})},resetHandler:()=>{l(i),r(h)}})]})}const w=r.ZP.div`
  position: relative;
  width: 512px;
  height: 100%;
  display: flex;
...
`;function ee(){const{data:e}=(0,d.BL)(),[i,{data:s,isSuccess:a,isLoading:n}]=(0,d.gU)();return(0,t.useEffect)((()=>{a&&((0,f.Bn)(),o.ZP.success("Update API Secret Successfully!"))}),[a]),(0,m.jsxs)($,{children:[(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)("label",{htmlFor:"secret",children:"API Secure Key:"}),(0,m.jsx)(x.Z,{type:"password",id:"secret",value:s||e})]}),(0,m.jsx)(y.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,m.jsxs)(q,{children:[(0,m.jsx)("div",{className:"tip",children:"Are you sure to update API secret? Previous secret will be invalided"}),(0,m.jsxs)("div",{className:"btns",children:[(0,m.jsx)(S.Z,{onClick:()=>(0,f.Bn)(),className:"cancel small",children:"Cancel"}),(0,m.jsx)(S.Z,{disabled:n,className:"small danger",onClick:()=>i(),children:"Yes"})]})]}),children:(0,m.jsx)(S.Z,{children:"Update Secret"})}),(0,m.jsxs)("div",{className:"tip",children:["Tip: The security key agreed between the server and the third-party app is used to encrypt the communication data."," "]})]})}var ie=s(6047);const se=r.ZP.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`;function te(){const{data:e}=(0,d.p5)();return(0,m.jsxs)(se,{children:[(0,m.jsxs)("div",{className:"item",children:["Client Version: ","0.3.1"]}),(0,m.jsxs)("div",{className:"item",children:["Server Version: ",e]}),(0,m.jsxs)("div",{className:"item",children:["Build Timestamp: ","1656512101"]})]})}function ae(){const{changed:e,reset:i,values:s,setValues:t,toggleEnable:a,updateConfig:n}=(0,T.Z)("agora"),l=e=>{const i=e.target.value,{type:s}=e.target.dataset;t((e=>({...e,[s]:i})))},{url:c,project_id:r,app_id:o,app_certificate:d,rtm_key:M,rtm_secret:g,enabled:p=!1}=null!==s&&void 0!==s?s:{};return(0,m.jsxs)(w,{children:[(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input row",children:[(0,m.jsx)(j.Z,{children:"Enable"}),(0,m.jsx)(_.Z,{onClick:a,"data-checked":p})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"url",children:"Agora Url"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"url",onChange:l,value:c||"https://api.agora.io",name:"url",placeholder:"Agora URL"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"project_id",children:"Project ID"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"project_id",onChange:l,value:r,name:"project_id",placeholder:"Project ID"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"app_id",children:"App ID"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"app_id",onChange:l,value:o,name:"app_id",placeholder:"APP ID"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"app_certificate",children:"APP Certificate"}),(0,m.jsx)(x.Z,{disabled:!p,"data-type":"app_certificate",onChange:l,value:d,name:"app_certificate",placeholder:"APP Certificate"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"rtm_key",children:"RTM Key"}),(0,m.jsx)(u.Z,{disabled:!p,"data-type":"rtm_key",onChange:l,value:M,name:"rtm_key",placeholder:"RTM Key"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(j.Z,{htmlFor:"rtm_secret",children:"RTM Secret"}),(0,m.jsx)(u.Z,{disabled:!p,"data-type":"rtm_secret",onChange:l,value:g,name:"rtm_secret",placeholder:"RTM Secret"})]})]}),e&&(0,m.jsx)(N.Z,{saveHandler:()=>{n(s)},resetHandler:i})]})}const ne=[{title:"General",items:[{name:"overview",title:"Overview",component:(0,m.jsx)(h,{})},{name:"members",title:"Members",component:(0,m.jsx)(ie.Z,{}),admin:!0}]},{title:"User",items:[{name:"my_account",title:"My Account",component:(0,m.jsx)(c.Z,{})}]},{title:"Configuration",items:[{name:"firebase",title:"Firebase",component:(0,m.jsx)(H,{})},{name:"agora",title:"Agora",component:(0,m.jsx)(ae,{})},{name:"smtp",title:"SMTP",component:(0,m.jsx)(X,{})},{name:"social_login",title:"Login Methods",component:(0,m.jsx)(F,{})},{name:"api",title:"Third-party APP",component:(0,m.jsx)(ee,{})}],admin:!0},{title:"About",items:[{name:"faq",title:"FAQ",component:(0,m.jsx)(te,{})},{name:"terms",title:"Terms & Privacy",component:"Terms & Privacy"},{name:"feedback",title:"Feedback",component:"feedback"}]}],le=()=>{const e=(0,p.CG)((e=>e.authData.user));return ne.filter((i=>!(null===e||void 0===e||!e.is_admin)||!i.admin))};var ce=s(666),re=s(6571),oe=s(3215),de=s(310);const Me=(0,r.ZP)(re.Z)`
  .clear {
    font-weight: normal;
    font-size: 14px;
    line-height: 20px;
...
`,xe=e=>{let{closeModal:i}=e;const[s,a]=(0,t.useState)(!1),{logout:n,exited:l,exiting:c,clearLocalData:r}=(0,de.Z)();return(0,t.useEffect)((()=>{l&&(s&&r(),o.ZP.success("Logout Successfully"),setTimeout((()=>{location.href=`${location.origin}#/login`}),500))}),[l,s]),(0,m.jsx)(ce.Z,{id:"modal-modal",children:(0,m.jsx)(Me,{title:"Log Out",description:"Are you sure want to log out this account?",buttons:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(S.Z,{onClick:i,children:"Cancel"}),(0,m.jsx)(S.Z,{onClick:()=>{n()},className:"danger",children:c?"Logging out":"Log Out"})]}),children:(0,m.jsxs)("div",{className:"clear",children:[(0,m.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:"Clear local data"}),(0,m.jsx)(oe.Z,{name:"clear_cb",checked:s,onChange:e=>{a(e.target.checked)}})]})})})};let je=null;function ue(){var e;const[i]=(0,a.lr)(),s=le(),c=s.map((e=>{let{items:i}=e;return i})).flat(),r=i.get("nav");je=null!==(e=je)&&void 0!==e?e:i.get("f")||"/";const[o,d]=(0,t.useState)(!1),M=(0,n.s0)(),x=()=>{d((e=>!e))},j=c.find((e=>e.name==r))||c[0];return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(l.Z,{nav:j,closeModal:()=>{M(je),je=null},title:"Settings",navs:s,dangers:[{title:"Log Out",handler:x}],children:j.component}),o&&(0,m.jsx)(xe,{closeModal:x})]})}}}]);