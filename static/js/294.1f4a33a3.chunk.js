...
`,C=e=>{let{serverName:t}=e;const{t:n}=(0,p.$G)("welcome",{keyPrefix:"onboarding"}),{nextStep:i}=s(),o=(0,r.useRef)(),a=(0,N.CG)((e=>!!e.authData.token)),l=(0,v.I0)(),[d,{isLoading:u,isError:h,isSuccess:g}]=(0,w.QK)(),[b,{isLoading:C,isError:S}]=(0,y.YA)(),{data:_}=(0,w.z3)(),[Z,{isLoading:E,isSuccess:P}]=(0,w.e2)(),[T,z]=(0,r.useState)(""),[L,$]=(0,r.useState)(""),[R,G]=(0,r.useState)("");return(0,r.useEffect)((()=>{h&&m.ZP.error("Failed to sign up")}),[h]),(0,r.useEffect)((()=>{g&&b({email:T,password:L,type:"password"})}),[g]),(0,r.useEffect)((()=>{S&&m.ZP.error("Login failed")}),[S]),(0,r.useEffect)((()=>{a&&_&&(l((0,j.R4)(!0)),Z({..._,name:t}))}),[a]),(0,r.useEffect)((()=>{P&&i()}),[P]),(0,x.jsxs)(k,{children:[(0,x.jsx)("span",{className:"primaryText",children:n("admin_title")}),(0,x.jsx)("span",{className:"secondaryText",children:n("admin_desc")}),(0,x.jsxs)("form",{ref:o,action:"/",children:[(0,x.jsx)(f.Z,{className:"input",placeholder:"Enter your email",type:"email",required:!0,value:T,onChange:e=>z(e.target.value)}),(0,x.jsx)(f.Z,{className:"input",type:"password",required:!0,minLength:6,placeholder:"Enter your password",value:L,onChange:e=>$(e.target.value)}),(0,x.jsx)(f.Z,{className:"input",type:"password",required:!0,minLength:6,placeholder:"Confirm your password",value:R,onChange:e=>G(e.target.value)})]}),(0,x.jsx)(c.Z,{className:"button",onClick:async()=>{const e=null===o||void 0===o?void 0:o.current;if(e){if(!e.checkValidity())return void e.reportValidity();d({email:T,name:"Admin",password:L,gender:0})}},children:u||C||E?"...":n("sign")})]})};var S=n(15621);const _=l.ZP.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
