...
`,C=e=>{let{serverName:t}=e;const{t:n}=(0,p.$)("welcome",{keyPrefix:"onboarding"}),{nextStep:o}=s(),r=(0,i.useRef)(),a=(0,N.CG)((e=>!!e.authData.token)),c=(0,w.I0)(),[d,{isLoading:u,isError:h,isSuccess:m}]=(0,v.QK)(),[b,{isLoading:C,isError:T}]=(0,y.YA)(),{data:S}=(0,v.z3)(),[Z,{isLoading:_,isSuccess:P}]=(0,v.e2)(),[z,E]=(0,i.useState)(""),[$,L]=(0,i.useState)(""),[R,A]=(0,i.useState)("");return(0,i.useEffect)((()=>{h&&f.ZP.error("Failed to sign up")}),[h]),(0,i.useEffect)((()=>{m&&b({email:z,password:$,type:"password"})}),[m]),(0,i.useEffect)((()=>{T&&f.ZP.error("Login failed")}),[T]),(0,i.useEffect)((()=>{a&&S&&(c((0,j.R4)(!0)),Z({...S,name:t}))}),[a]),(0,i.useEffect)((()=>{P&&o()}),[P]),(0,x.jsxs)(k,{children:[(0,x.jsx)("span",{className:"primaryText",children:n("admin_title")}),(0,x.jsx)("span",{className:"secondaryText",children:n("admin_desc")}),(0,x.jsxs)("form",{ref:r,action:"/",children:[(0,x.jsx)(g.Z,{className:"input",placeholder:"Enter your email",type:"email",required:!0,value:z,onChange:e=>E(e.target.value)}),(0,x.jsx)(g.Z,{className:"input",type:"password",required:!0,minLength:6,placeholder:"Enter your password",value:$,onChange:e=>L(e.target.value)}),(0,x.jsx)(g.Z,{className:"input",type:"password",required:!0,minLength:6,placeholder:"Confirm your password",value:R,onChange:e=>A(e.target.value)})]}),(0,x.jsx)(l.Z,{className:"button",onClick:async()=>{const e=null===r||void 0===r?void 0:r.current;if(e){if(!e.checkValidity())return void e.reportValidity();d({email:z,name:"Admin",password:$,gender:0})}},children:u||C||_?"...":n("sign")})]})};var T=n(15621);const S=c.ZP.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
`;function R(e){let{serverName:t}=e;const{t:n}=(0,p.$)("welcome",{keyPrefix:"onboarding"}),i=(0,E.s0)();return(0,x.jsxs)(L,{children:[(0,x.jsx)("span",{className:"primaryText",children:n("done_welcome",{serverName:t})}),(0,x.jsx)("span",{className:"secondaryText",children:n("done_title")}),(0,x.jsx)("span",{className:"tip",children:(0,x.jsx)($.c,{i18nKey:"onboarding.done_desc",ns:"welcome",children:(0,x.jsx)("span",{className:"strong"})})}),(0,x.jsxs)(l.Z,{className:"startButton",onClick:()=>i("/"),children:[(0,x.jsx)("img",{src:d,alt:"play icon"}),(0,x.jsx)("span",{children:n("enter")})]})]})}var A=n(47912);const B=[{name:"welcomePage",label:(0,A.t)("welcome:onboarding.welcome_page")},{name:"serverName",label:(0,A.t)("welcome:onboarding.set_name")},{name:"adminAccount",label:(0,A.t)("welcome:onboarding.admin_account")},{name:"whoCanSignUp",label:(0,A.t)("welcome:onboarding.who_sign_up")},{name:"inviteLink",label:(0,A.t)("welcome:onboarding.invites"),canJumpTo:["whoCanSignUp"]},{name:"donePage",label:(0,A.t)("welcome:onboarding.done"),canJumpTo:["whoCanSignUp","inviteLink"]}],F=c.ZP.div`
  height: 100vh;
  overflow-y: auto;
  > .navigator {
    position: absolute;
