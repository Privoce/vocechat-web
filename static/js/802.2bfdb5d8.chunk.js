...
`,l=e=>{let{saveHandler:i,resetHandler:s}=e;return(0,a.jsxs)(n,{className:"animate__animated animate__flipInX animate__faster",children:[(0,a.jsx)("span",{className:"txt",children:"You have unsaved changes!"}),(0,a.jsxs)("div",{className:"btns",children:[(0,a.jsx)("button",{className:"btn reset",onClick:s,children:"Reset"}),(0,a.jsx)("button",{className:"btn",onClick:i,children:"Save Changes"})]})]})}},5638:(e,i,s)=>{s.d(i,{Z:()=>o});var t=s(244),a=s(8467),n=s(2135);const l=s.p+"static/media/arrow.left.92fbb139607631555459.svg";var c=s(6417);const r=t.ZP.div`
  width: 100vw;
  height: 100vh;
  display: flex;
...
`;function w(){const{loginUser:e,server:i}=(0,p.CG)((e=>({loginUser:e.authData.user,server:e.server}))),[s,a]=(0,t.useState)(!1),[n,l]=(0,t.useState)(i),{values:c,updateConfig:r}=(0,m.Z)("login"),[w]=(0,d.e2)(),[_,{isSuccess:I}]=(0,d.jd)(),y=e=>{const i=e.target.value,{type:s=""}=e.target.dataset;l((e=>({...e,[s]:i})))};if((0,t.useEffect)((()=>{I&&o.ZP.success("Update logo successfully!")}),[I]),(0,t.useEffect)((()=>{i&&l(i)}),[i]),(0,t.useEffect)((()=>{if(i&&n){const{name:e,description:s}=n,{name:t,description:l}=i;a(t!==e||l!==s)}}),[i,n]),!n||!c)return null;const{name:T,description:f,logo:L}=n,{who_can_sign_up:E,guest:v}=c,z=null===e||void 0===e?void 0:e.is_admin;return(0,h.jsxs)(D,{children:[(0,h.jsxs)("div",{className:"logo",children:[(0,h.jsx)("div",{className:"preview",children:(0,h.jsx)(M.Z,{disabled:!z,url:I?`${L}?t=${+new Date}`:L,name:T,uploadImage:_})}),z&&(0,h.jsx)("div",{className:"upload",children:(0,h.jsx)("div",{className:"tip",children:"Minimum size is 128x128, We recommend at least 512x512 for the server. Max size limited to 5M."})})]}),(0,h.jsxs)("div",{className:"inputs",children:[(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"name",children:"Server Name"}),(0,h.jsx)(x.Z,{disabled:!z,"data-type":"name",onChange:y,value:T,name:"name",id:"name",placeholder:"Server Name"})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"desc",children:"Server Description"}),(0,h.jsx)(j.Z,{disabled:!z,"data-type":"description",onChange:y,value:null!==f&&void 0!==f?f:"",rows:4,name:"name",id:"name",placeholder:"Tell the world a bit about this server"})]})]}),z&&(0,h.jsxs)(h.Fragment,{children:[(0,h.jsxs)("div",{className:"setting",children:[(0,h.jsx)("p",{className:"label",children:"Default Sign Up"}),(0,h.jsx)("p",{className:"tip",children:"Who can sign up this server."}),(0,h.jsx)(g.Z,{options:["Everyone","Invitation Link Only"],values:["EveryOne","InvitationOnly"],value:E,onChange:e=>{var i;i=e,r({...c,who_can_sign_up:i})}})]}),(0,h.jsxs)("div",{className:"setting",children:[(0,h.jsx)("p",{className:"label",children:"Guest Mode"}),(0,h.jsx)("p",{className:"tip",children:(0,h.jsx)("span",{className:"txt",children:"If enabled, visitors will see public channels on this server."})}),(0,h.jsx)(g.Z,{options:["Enabled","Disabled"],values:["true","false"],value:String(v),onChange:e=>{(e=>{const i="true"===e;r({...c,guest:i})})(e)}})]})]}),s&&(0,h.jsx)(N.Z,{saveHandler:()=>{const{name:e,description:i}=n;w({name:e,description:i})},resetHandler:()=>{l(i)}})]})}const _=r.ZP.div`
  position: relative;
  width: 512px;
  height: 100%;
  display: flex;
...
`;function O(e){let{link:i="#"}=e;return(0,h.jsx)(T.ZP,{delay:[0,500],interactive:!0,arrow:f.ki,placement:"bottom",content:(0,h.jsxs)(z,{children:["Need more detail? See our"," ",(0,h.jsx)("a",{target:"doc",href:i,children:"doc"}),"."]}),children:(0,h.jsx)(v,{className:"icon"})})}var b=s(552),C=s(746),A=s(5281);const k=r.ZP.div`
  user-select: none;
  border: 1px solid #e5e7eb;
  border-radius: 4px;
  padding: 8px;
...
`;function ee(){const{updateConfig:e,values:i}=(0,m.Z)("login"),{data:s}=(0,d.BL)(),[a,{data:n,isSuccess:l,isLoading:c}]=(0,d.gU)();(0,t.useEffect)((()=>{l&&((0,f.Bn)(),o.ZP.success("Update API Secret Successfully!"))}),[l]);const r=null===i||void 0===i?void 0:i.third_party;return(0,h.jsxs)($,{children:[(0,h.jsx)(y.Z,{onClick:(s=>{e({...i,...s})}).bind(null,{third_party:!r}),"data-checked":r}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)("label",{htmlFor:"secret",children:"API Secure Key:"}),(0,h.jsx)(x.Z,{disabled:!r,type:"password",id:"secret",value:n||s})]}),(0,h.jsx)(T.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,h.jsxs)(q,{children:[(0,h.jsx)("div",{className:"tip",children:"Are you sure to update API secret? Previous secret will be invalided"}),(0,h.jsxs)("div",{className:"btns",children:[(0,h.jsx)(Z.Z,{onClick:()=>(0,f.Bn)(),className:"cancel small",children:"Cancel"}),(0,h.jsx)(Z.Z,{disabled:c,className:"small danger",onClick:()=>a(),children:"Yes"})]})]}),children:(0,h.jsx)(Z.Z,{disabled:!r,children:"Update Secret"})}),(0,h.jsx)("div",{className:"tip",children:"Tip: The security key agreed between the server and the third-party app is used to encrypt the communication data."})]})}var ie=s(658),se=s.n(ie);const te=()=>{const{data:e}=(0,d.qM)(),[i,{isLoading:s,isSuccess:t}]=(0,d.U_)(),[a,{isSuccess:n,isLoading:l}]=(0,d.yn)();return{license:e,checked:t,checking:s,upserting:l,upserted:n,checkLicense:e=>{i(e)},upsertLicense:async e=>{const s=await i(e);return!(!("data"in s)||!s.data.sign)&&await a(e)}}},ae=r.ZP.div`
  padding: 12px;
  border-radius: 10px;
  border: 1px solid orange;
  background-color: #fff;
...
`;function ce(){const{license:e,checking:i,upserting:s,upsertLicense:a}=te(),[n,l]=(0,t.useState)("");(0,t.useEffect)((()=>{null!==e&&void 0!==e&&e.base58&&l(e.base58)}),[e]);const c=i||s||!n||n===(null===e||void 0===e?void 0:e.base58);return(0,h.jsxs)(le,{children:[(0,h.jsx)("div",{className:"input",children:(0,h.jsx)(T.ZP,{placement:"right-start",visible:!!e,content:(0,h.jsxs)(ne,{children:[(0,h.jsxs)("div",{className:"item",children:[(0,h.jsx)("span",{className:"label",children:"Signed"}),(0,h.jsx)("span",{className:"info",children:null!==e&&void 0!==e&&e.sign?"Yes":"Not Yet"})]}),(0,h.jsxs)("div",{className:"item",children:[(0,h.jsx)("span",{className:"label",children:"Domains"}),(0,h.jsxs)("ul",{className:"info",children:[" ",null===e||void 0===e?void 0:e.domains.map((e=>(0,h.jsx)("li",{children:e},e)))]})]}),(0,h.jsxs)("div",{className:"item",children:[(0,h.jsx)("span",{className:"label",children:"User Limit"}),(0,h.jsxs)("span",{className:"info",children:[" ",null===e||void 0===e?void 0:e.user_limit]})]}),(0,h.jsxs)("div",{className:"item",children:[(0,h.jsx)("span",{className:"label",children:"Expired At"}),(0,h.jsx)("span",{className:"info",children:se()(null===e||void 0===e?void 0:e.expired_at).format("YYYY-MM-DD h:mm:ss A")})]}),(0,h.jsxs)("div",{className:"item",children:[(0,h.jsx)("span",{className:"label",children:"Created At"}),(0,h.jsx)("span",{className:"info",children:se()(null===e||void 0===e?void 0:e.created_at).format("YYYY-MM-DD h:mm:ss A")})]})]}),children:(0,h.jsx)(j.Z,{rows:15,id:"license",value:n,onChange:e=>{l(e.target.value)}})})}),(0,h.jsx)(T.ZP,{interactive:!0,placement:"bottom-start",trigger:"click",content:(0,h.jsxs)(ae,{children:[(0,h.jsx)("div",{className:"tip",children:"Are you sure to update License?"}),(0,h.jsxs)("div",{className:"btns",children:[(0,h.jsx)(Z.Z,{onClick:()=>(0,f.Bn)(),className:"cancel small",children:"Cancel"}),(0,h.jsx)(Z.Z,{disabled:c,className:"small danger",onClick:async()=>{if(!n)return o.ZP.error("License Empty"),void(0,f.Bn)();await a(n)?o.ZP.success("License Updated!"):(o.ZP.error("Invalid License"),(0,f.Bn)())},children:"Yes"})]})]}),children:(0,h.jsx)(Z.Z,{disabled:c,children:"Update License"})})]})}var re=s(3941);const oe=r.ZP.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
`,de=()=>{const{data:e}=(0,d.p5)();return(0,h.jsxs)(oe,{children:[(0,h.jsxs)("div",{className:"item",children:["Client Version: ","0.3.8"]}),(0,h.jsxs)("div",{className:"item",children:["Server Version: ",e]}),(0,h.jsxs)("div",{className:"item",children:["Build Timestamp: ","1663630375"]})]})};function Me(){const{changed:e,reset:i,values:s,setValues:t,toggleEnable:a,updateConfig:n}=(0,m.Z)("agora"),l=e=>{const i=e.target.value,{type:s=""}=e.target.dataset;t((e=>e?{...e,[s]:i}:e))};if(!s)return null;const{url:c,project_id:r,app_id:o,app_certificate:d,rtm_key:M,rtm_secret:g,enabled:p=!1}=s;return(0,h.jsxs)(_,{children:[(0,h.jsxs)("div",{className:"inputs",children:[(0,h.jsxs)("div",{className:"input row",children:[(0,h.jsx)(u.Z,{children:"Enable"}),(0,h.jsx)(y.Z,{onClick:a,"data-checked":p})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"url",children:"Agora Url"}),(0,h.jsx)(x.Z,{disabled:!p,"data-type":"url",onChange:l,value:c||"https://api.agora.io",name:"url",placeholder:"Agora URL"})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"project_id",children:"Project ID"}),(0,h.jsx)(x.Z,{disabled:!p,"data-type":"project_id",onChange:l,value:r,name:"project_id",placeholder:"Project ID"})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"app_id",children:"App ID"}),(0,h.jsx)(x.Z,{disabled:!p,"data-type":"app_id",onChange:l,value:o,name:"app_id",placeholder:"APP ID"})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"app_certificate",children:"APP Certificate"}),(0,h.jsx)(x.Z,{disabled:!p,"data-type":"app_certificate",onChange:l,value:d,name:"app_certificate",placeholder:"APP Certificate"})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"rtm_key",children:"RTM Key"}),(0,h.jsx)(j.Z,{disabled:!p,"data-type":"rtm_key",onChange:l,value:M,name:"rtm_key",placeholder:"RTM Key"})]}),(0,h.jsxs)("div",{className:"input",children:[(0,h.jsx)(u.Z,{htmlFor:"rtm_secret",children:"RTM Secret"}),(0,h.jsx)(j.Z,{disabled:!p,"data-type":"rtm_secret",onChange:l,value:g,name:"rtm_secret",placeholder:"RTM Secret"})]})]}),e&&(0,h.jsx)(N.Z,{saveHandler:()=>{n(s)},resetHandler:i})]})}const xe=[{title:"General",items:[{name:"overview",title:"Overview",component:(0,h.jsx)(w,{})},{name:"members",title:"Members",component:(0,h.jsx)(re.Z,{}),admin:!0}]},{title:"User",items:[{name:"my_account",title:"My Account",component:(0,h.jsx)(c.Z,{})}]},{title:"Configuration",items:[{name:"firebase",title:"Firebase",component:(0,h.jsx)(H,{})},{name:"agora",title:"Agora",component:(0,h.jsx)(Me,{})},{name:"smtp",title:"SMTP",component:(0,h.jsx)(X,{})},{name:"social_login",title:"Login Methods",component:(0,h.jsx)(F,{})},{name:"api",title:"Third-party APP",component:(0,h.jsx)(ee,{})},{name:"license",title:"License",component:(0,h.jsx)(ce,{})}],admin:!0},{title:"About",items:[{name:"faq",title:"FAQ",component:(0,h.jsx)(de,{})},{name:"terms",title:"Terms & Privacy",component:"Terms & Privacy"},{name:"feedback",title:"Feedback",component:"feedback"}]}],ue=()=>{const e=(0,p.CG)((e=>e.authData.user));return xe.filter((i=>!(null===e||void 0===e||!e.is_admin)||!i.admin))};var je=s(666),Ne=s(6571),ge=s(3215),pe=s(310);const me=(0,r.ZP)(Ne.Z)`
  .clear {
    font-weight: normal;
    font-size: 14px;
    line-height: 20px;
...
`,he=e=>{let{closeModal:i}=e;const[s,a]=(0,t.useState)(!1),{logout:n,exited:l,exiting:c,clearLocalData:r}=(0,pe.Z)();return(0,t.useEffect)((()=>{l&&(s&&r(),o.ZP.success("Logout Successfully"))}),[l,s]),(0,h.jsx)(je.Z,{id:"modal-modal",children:(0,h.jsx)(me,{title:"Log Out",description:"Are you sure want to log out this account?",buttons:(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(Z.Z,{onClick:i,children:"Cancel"}),(0,h.jsx)(Z.Z,{onClick:()=>{n()},className:"danger",children:c?"Logging out":"Log Out"})]}),children:(0,h.jsxs)("div",{className:"clear",children:[(0,h.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:"Clear local data"}),(0,h.jsx)(ge.Z,{name:"clear_cb",checked:s,onChange:e=>{a(e.target.checked)}})]})})})};let De="";function we(){const[e]=(0,a.lr)(),i=ue(),s=i.map((e=>{let{items:i}=e;return i})).flat(),c=e.get("nav"),[r,o]=(0,t.useState)(!1),d=(0,n.s0)();De=De||(e.get("f")||"/");const M=()=>{o((e=>!e))},x=s.find((e=>e.name==c))||s[0];return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(l.Z,{nav:x,closeModal:()=>{d(De),De=""},title:"Settings",navs:i,dangers:[{title:"Log Out",handler:M}],children:x.component}),r&&(0,h.jsx)(he,{closeModal:M})]})}}}]);