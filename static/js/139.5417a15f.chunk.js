...
`,Pe=e=>{let{closeModal:s}=e;const{t:t}=(0,o.$G)("auth"),{t:i}=(0,o.$G)(),[l,n]=(0,a.useState)(!1),{logout:c,exited:r,exiting:d,clearLocalData:M}=(0,Se.Z)();return(0,a.useEffect)((()=>{r&&(l&&M(),j.ZP.success("Logout Successfully"))}),[r,l]),(0,h.jsx)(re.Z,{id:"modal-modal",children:(0,h.jsx)(Ze,{title:t("logout.title"),description:t("logout.desc"),buttons:(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(Y.Z,{onClick:s,children:i("action.cancel")}),(0,h.jsx)(Y.Z,{onClick:()=>{c()},className:"danger",children:d?"Logging out":i("action.logout")})]}),children:(0,h.jsxs)("div",{className:"clear",children:[(0,h.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:t("logout.clear_local")}),(0,h.jsx)(Ue.Z,{name:"clear_cb",checked:l,onChange:e=>{n(e.target.checked)}})]})})})};let Ye="";function Qe(){const{t:e}=(0,o.$G)(),[s]=(0,i.lr)(),t=ke(),c=t.map((e=>{let{items:s}=e;return s})).flat(),r=s.get("nav"),[d,M]=(0,a.useState)(!1),u=(0,l.s0)();Ye=Ye||(s.get("f")||"/");const j=()=>{M((e=>!e))},x=c.find((e=>e.name==r))||c[0];return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(n.Z,{nav:x,closeModal:()=>{u(Ye),Ye=""},title:e("setting"),navs:t,dangers:[{title:e("action.logout"),handler:j}],children:x.component}),d&&(0,h.jsx)(Pe,{closeModal:j})]})}}}]);