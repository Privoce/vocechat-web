...
`;function S(e){let{nextStep:t}=e;const{data:n}=(0,f.ww)(),[s,{isSuccess:a,error:o}]=(0,f.QP)(),[l,p]=(0,i.useState)(void 0);return(0,i.useEffect)((()=>{n&&p(n.who_can_sign_up)}),[n]),(0,i.useEffect)((()=>{void 0!==o&&x.ZP.error(`Failed to update sign up rule: ${o.data}`)}),[o]),(0,i.useEffect)((()=>{a&&t()}),[a]),(0,c.jsxs)(N,{children:[(0,c.jsx)("span",{className:"primaryText",children:"Last step: invite others!"}),(0,c.jsx)("span",{className:"secondaryText",children:"Firstly, who can sign up to this server?"}),(0,c.jsx)(j.Z,{options:["Everyone","Invitation link only"],values:["EveryOne","InvitationOnly"],value:l,onChange:p}),(0,c.jsx)(r.Z,{className:"button",disabled:!l,onClick:()=>{void 0!==n&&s({...n,who_can_sign_up:l})},children:"Confirm"})]})}var k=n(3165);const C=o.ZP.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
