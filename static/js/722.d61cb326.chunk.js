...
`;function A(e){let{link:s="#"}=e;return(0,p.jsx)(y.ZP,{delay:[0,500],interactive:!0,arrow:L.ki,placement:"bottom",content:(0,p.jsxs)(C,{children:["Need more detail? See our"," ",(0,p.jsx)("a",{target:"doc",href:s,children:"doc"}),"."]}),children:(0,p.jsx)(O,{className:"icon"})})}var v=i(18697),f=i(48055),b=i(63211);const k=r.ZP.div`
  user-select: none;
...
`,_e=e=>{let{closeModal:s}=e;const[i,a]=(0,t.useState)(!1),{logout:l,exited:n,exiting:c,clearLocalData:r}=(0,he.Z)();return(0,t.useEffect)((()=>{n&&(i&&r(),d.ZP.success("Logout Successfully"))}),[n,i]),(0,p.jsx)(ae.Z,{id:"modal-modal",children:(0,p.jsx)(Ie,{title:"Log Out",description:"Are you sure want to log out this account?",buttons:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(S.Z,{onClick:s,children:"Cancel"}),(0,p.jsx)(S.Z,{onClick:()=>{l()},className:"danger",children:c?"Logging out":"Log Out"})]}),children:(0,p.jsxs)("div",{className:"clear",children:[(0,p.jsx)("label",{htmlFor:"clear_cb",className:"txt",children:"Clear local data"}),(0,p.jsx)(pe.Z,{name:"clear_cb",checked:i,onChange:e=>{a(e.target.checked)}})]})})})};let Te="";function we(){const[e]=(0,a.lr)(),s=me(),i=s.map((e=>{let{items:s}=e;return s})).flat(),c=e.get("nav"),[r,d]=(0,t.useState)(!1),o=(0,l.s0)();Te=Te||(e.get("f")||"/");const M=()=>{d((e=>!e))},j=i.find((e=>e.name==c))||i[0];return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(n.Z,{nav:j,closeModal:()=>{o(Te),Te=""},title:"Settings",navs:s,dangers:[{title:"Log Out",handler:M}],children:j.component}),r&&(0,p.jsx)(_e,{closeModal:M})]})}}}]);