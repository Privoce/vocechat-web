...
`,N=e=>{let{serverName:n,nextStep:t}=e;const{t:o}=(0,c.$)("welcome",{keyPrefix:"onboarding"}),s=(0,y.CG)((e=>!!e.authData.token)),a=(0,u.I0)(),[l,{isLoading:p,isError:x,isSuccess:m}]=(0,b.QK)(),[f,{isLoading:N,isError:k}]=(0,w.YA)(),{data:T}=(0,b.z3)(),[Z,{isLoading:C,isSuccess:P}]=(0,b.e2)(),[S,_]=(0,i.useState)(""),[z,$]=(0,i.useState)(""),[E,L]=(0,i.useState)("");return(0,i.useEffect)((()=>{x&&h.ZP.error("Failed to sign up")}),[x]),(0,i.useEffect)((()=>{m&&f({email:S,password:z,type:"password"})}),[m]),(0,i.useEffect)((()=>{k&&h.ZP.error("Login failed")}),[k]),(0,i.useEffect)((()=>{s&&T&&(a((0,v.R4)(!0)),Z({...T,name:n}))}),[s]),(0,i.useEffect)((()=>{P&&t()}),[P]),(0,d.jsxs)(j,{children:[(0,d.jsx)("span",{className:"primaryText",children:o("admin_title")}),(0,d.jsx)("span",{className:"secondaryText",children:o("admin_desc")}),(0,d.jsx)(g.Z,{className:"input",placeholder:"Enter your email",value:S,onChange:e=>_(e.target.value)}),(0,d.jsx)(g.Z,{className:"input",type:"password",placeholder:"Enter your password",value:z,onChange:e=>$(e.target.value)}),(0,d.jsx)(g.Z,{className:"input",type:"password",placeholder:"Confirm your password",value:E,onChange:e=>L(e.target.value)}),(0,d.jsx)(r.Z,{className:"button",onClick:async()=>{""!==S?""!==z?z.length<6?h.ZP.error("Password length greater than 6!"):z===E?l({email:S,name:"Admin",password:z,gender:0}):h.ZP.error("Two passwords do not match!"):h.ZP.error("Please enter admin password!"):h.ZP.error("Please enter admin email!")},children:p||N||C?"...":o("sign")})]})};var k=t(15621);const T=a.ZP.div`
  height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
