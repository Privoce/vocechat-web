...
`,c=e=>{let{url:n="",name:i="",type:l="user",uploadImage:c,disabled:d=!1}=e;const[p,h]=(0,t.useState)(!1);return(0,o.jsxs)(r,{children:[(0,o.jsxs)("div",{className:"avatar",children:[(0,o.jsx)(a.Z,{type:l,url:n,name:i}),!d&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("div",{className:"tip",children:p?"Uploading":"Change Avatar"}),(0,o.jsx)("input",{multiple:!1,onChange:async e=>{if(p)return;if(!e.target.files)return;const[n]=Array.from(e.target.files);h(!0),await c(n),h(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,o.jsx)("img",{src:s,alt:"icon",className:"icon"})]})}},6047:(e,n,i)=>{i.d(n,{Z:()=>L});var t=i(7313),l=i(9184),a=i(2963),s=i(9784),o=i(3657),r=i(6123),c=i(5515),d=i(5281),p=i(9559),h=i(4050),m=i(1140),x=i(6417);const u=l.ZP.div`
  display: flex;
...
`;function L(e){var n;let{cid:i=0}=e;const{contacts:l,channels:p,loginUser:h}=(0,Z.CG)((e=>({contacts:e.contacts,channels:e.channels,loginUser:e.authData.user}))),{copyEmail:m,removeFromChannel:u,removeUser:f,canRemove:b,canRemoveFromChannel:j}=(0,C.Z)({cid:i}),[y,{isSuccess:L}]=(0,r.wv)();(0,t.useEffect)((()=>{L&&o.ZP.success("Update Successfully")}),[L]);const _=e=>{let{ignore:n=!1,uid:i=null,isAdmin:t=!0}=e;(0,s.Bn)(),n||y({id:i,is_admin:t})},z=null!==(n=p.byId[i])&&void 0!==n?n:null,E=z?z.is_public?l.ids:z.members:l.ids;return(0,x.jsxs)(S,{children:[(null===h||void 0===h?void 0:h.is_admin)&&(0,x.jsx)(g,{}),(0,x.jsxs)("div",{className:"intro",children:[(0,x.jsx)("h4",{className:"title",children:"Manage Members"}),(0,x.jsx)("p",{className:"desc",children:"Disabling your account means you can recover it at any time after taking this action."})]}),(0,x.jsx)("ul",{className:"members",children:E.map((e=>{const{name:n,email:t,is_admin:s}=l.byId[e],o=z&&z.owner==e,r=h.is_admin&&h.uid!==e,p=t||(null===h||void 0===h?void 0:h.is_admin);return(0,x.jsxs)("li",{className:"member",children:[(0,x.jsxs)("div",{className:"left",children:[(0,x.jsx)(c.Z,{compact:!0,uid:e,interactive:!1}),(0,x.jsxs)("div",{className:"info",children:[(0,x.jsxs)("span",{className:"name",children:[n," ",o&&(0,x.jsx)(w.Z,{})]}),(0,x.jsx)("span",{className:"email",children:t})]})]}),(0,x.jsxs)("div",{className:"right",children:[(0,x.jsxs)("span",{className:"role",children:[s?"Admin":"User",r&&(0,x.jsx)(a.ZP,{interactive:!0,placement:"bottom-end",trigger:"click",content:(0,x.jsxs)(d.Z,{className:"menu",children:[(0,x.jsxs)("li",{className:"item sb",onClick:_.bind(null,{ignore:s,uid:e,isAdmin:!0}),children:["Admin",s&&(0,x.jsx)(k.Z,{className:"icon"})]}),(0,x.jsxs)("li",{className:"item sb",onClick:_.bind(null,{ignore:!s,uid:e,isAdmin:!1}),children:["User",!s&&(0,x.jsx)(k.Z,{className:"icon"})]})]}),children:(0,x.jsx)(N,{className:"icon"})})]}),p&&(0,x.jsx)(a.ZP,{interactive:!0,placement:"right-start",trigger:"click",content:(0,x.jsxs)(d.Z,{className:"menu",children:[t&&(0,x.jsx)("li",{className:"item",onClick:m.bind(null,t),children:"Copy Email"}),j&&(0,x.jsx)("li",{className:"item danger",onClick:u.bind(null,e),children:"Remove From Channel"}),b&&!i&&(0,x.jsx)("li",{className:"item danger",onClick:f.bind(null,e),children:"Remove From Server"})]}),children:(0,x.jsx)("div",{className:"opts",children:(0,x.jsx)("img",{className:"dots",src:v,alt:"dots icon"})})})]})]},e)}))})]})}},5579:(e,n,i)=>{i.d(n,{Z:()=>s});var t=i(9184),l=i(6417);const a=t.ZP.div`
  width: 100%;
  position: absolute;
  bottom: 64px;
  left: 0;
...
`},3798:(e,n,i)=>{i.r(n),i.d(n,{default:()=>O});var t=i(7313),l=i(9466),a=i(7890),s=i(3657),o=i(9184),r=i(666),c=i(1962),d=i(8529);function p(e){const{channel:n,loginUid:i}=(0,d.CG)((n=>{var i;return{channel:n.channels.byId[e],loginUid:null===(i=n.authData.user)||void 0===i?void 0:i.uid}})),[t,{isLoading:l,isSuccess:a}]=(0,c.tW)(),[s,{isLoading:o,isSuccess:r}]=(0,c.VJ)(),p=i==n.owner;return{otherMembers:n.members.filter((e=>e!=i)),transferOwner:function(){let n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;n&&t({id:e,owner:n})},leaveChannel:()=>{e&&s(e)},leaving:o,leaveSuccess:r,isOwner:p,transfering:l,transferSuccess:a}}var h=i(6571),m=i(1140),x=i(5515),u=i(6417);const g=o.ZP.ul`
  display: flex;
  flex-direction: column;
  max-height: 260px;
  padding: 16px 0;
...
`;function _(e){let{id:n=0}=e;const{loginUser:i,channel:l}=(0,d.CG)((e=>({loginUser:e.authData.user,channel:e.channels.byId[n]}))),{data:a,refetch:o}=(0,c.aw)(n),[r,p]=(0,t.useState)(!1),[h,m]=(0,t.useState)(null),[x]=(0,c.kG)(),[g,{isSuccess:f}]=(0,c.tW)(),b=e=>{const n=e.target.value,{type:i}=e.target.dataset;m((e=>({...e,[i]:n})))};if((0,t.useEffect)((()=>{a&&m(a)}),[a]),(0,t.useEffect)((()=>{if(a&&h){const{name:e,description:n}=h,{name:i,description:t}=a;p(i!==e||t!==n)}}),[a,h]),(0,t.useEffect)((()=>{f&&(s.ZP.success("Channel updated!"),o())}),[f]),!h||!n)return null;const{name:v,description:w}=h,j=!(null!==i&&void 0!==i&&i.is_admin)&&(null===l||void 0===l?void 0:l.owner)!=(null===i||void 0===i?void 0:i.uid);return(0,u.jsxs)(L,{children:[(0,u.jsx)(y.Z,{type:"channel",url:null===l||void 0===l?void 0:l.icon,name:v,uploadImage:e=>{x({gid:n,image:e})}}),(0,u.jsxs)("div",{className:"inputs",children:[(0,u.jsxs)("div",{className:"input",children:[(0,u.jsx)(k.Z,{htmlFor:"name",children:"Channel Name"}),(0,u.jsx)(N.Z,{disabled:j,className:"name","data-type":"name",onChange:b,value:v,name:"name",id:"name",placeholder:"Channel Name"})]}),(0,u.jsxs)("div",{className:"input",children:[(0,u.jsx)(k.Z,{htmlFor:"desc",children:"Channel Topic"}),(0,u.jsx)(C.Z,{disabled:j,"data-type":"description",onChange:b,value:null!==w&&void 0!==w?w:"",rows:4,name:"name",id:"name",placeholder:"Let everyone know how to use this channel."})]})]}),r&&(0,u.jsx)(Z.Z,{saveHandler:()=>{const{name:e,description:i}=h;g({id:n,name:e,description:i})},resetHandler:()=>{m(a)}})]})}var z=i(6047);const E=e=>[{title:"General",items:[{name:"overview",title:"Overview",component:(0,u.jsx)(_,{id:e})},{name:"members",title:"Members",component:(0,u.jsx)(z.Z,{cid:e})}]}];let P=null;function O(){var e;const{cid:n}=(0,a.UO)(),{loginUser:i,channel:s}=(0,d.CG)((e=>({loginUser:e.authData.user,channel:e.channels.byId[n]}))),o=(0,a.s0)(),[r]=(0,l.lr)(),c=E(n),p=c.map((e=>{let{items:n}=e;return n})).flat(),h=r.get("nav");P=null!==(e=P)&&void 0!==e?e:r.get("f")||"/";const[m,x]=(0,t.useState)(!1),[g,f]=(0,t.useState)(!1),b=()=>{x((e=>!e))},y=()=>{f((e=>!e))};if(!n)return null;const N=p.find((e=>e.name==h))||p[0],k=i.isAdmin||(null===s||void 0===s?void 0:s.owner)==i.uid,C=!(null!==s&&void 0!==s&&s.is_public);return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(w.Z,{nav:N,closeModal:()=>{o(P),P=null},title:"Channel Setting",navs:c,dangers:[C&&{title:"Leave Channel",handler:y},k&&{title:"Delete Channel",handler:b}],children:N.component}),m&&(0,u.jsx)(j.Z,{closeModal:b,id:n}),g&&(0,u.jsx)(v,{closeModal:y,id:n})]})}}}]);