...
`,c=e=>{let{url:i="",name:n="",type:l="user",uploadImage:c,disabled:d=!1}=e;const[p,h]=(0,t.useState)(!1);return(0,o.jsxs)(r,{children:[(0,o.jsxs)("div",{className:"avatar",children:[(0,o.jsx)(a.Z,{type:l,url:i,name:n}),!d&&(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)("div",{className:"tip",children:p?"Uploading":"Change Avatar"}),(0,o.jsx)("input",{multiple:!1,onChange:async e=>{if(p)return;if(!e.target.files)return;const[i]=Array.from(e.target.files);h(!0),await c(i),h(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,o.jsx)("img",{src:s,alt:"icon",className:"icon"})]})}},1205:(e,i,n)=>{n.d(i,{Z:()=>L});var t=n(537),l=n(7829),a=n(9195),s=n(8555),o=n(2334),r=n(6458),c=n(7889);const d=c.ZP.section`
  display: flex;
...
`;var p=n(3211),h=n(4884),m=n(3022),x=n(9885),u=n(683);const g=c.ZP.div`
  display: flex;
  flex-direction: column;
...
`,s=e=>{let{saveHandler:i,resetHandler:n}=e;return(0,l.jsxs)(a,{className:"animate__animated animate__flipInX animate__faster",children:[(0,l.jsx)("span",{className:"txt",children:"You have unsaved changes!"}),(0,l.jsxs)("div",{className:"btns",children:[(0,l.jsx)("button",{className:"btn reset",onClick:n,children:"Reset"}),(0,l.jsx)("button",{className:"btn",onClick:i,children:"Save Changes"})]})]})}},7477:(e,i,n)=>{n.d(i,{Z:()=>c});var t=n(7889),l=n(5924),a=n(4084);const s=n.p+"static/media/arrow.left.92fbb139607631555459.svg";var o=n(683);const r=t.ZP.div`
  width: 100vw;
  height: 100vh;
  display: flex;
...
`},5157:(e,i,n)=>{n.r(i),n.d(i,{default:()=>P});var t=n(537),l=n(5924),a=n(4084),s=n(8555),o=n(7889),r=n(874),c=n(6144),d=n(3986);function p(e){const{channel:i,loginUid:n}=(0,d.CG)((i=>{var n;return{channel:i.channels.byId[e],loginUid:null===(n=i.authData.user)||void 0===n?void 0:n.uid}})),[t,{isLoading:l,isSuccess:a}]=(0,c.tW)(),[s,{isLoading:o,isSuccess:r}]=(0,c.VJ)(),p=n==(null===i||void 0===i?void 0:i.owner);return{otherMembers:(null===i||void 0===i?void 0:i.members.filter((e=>e!=n)))||[],transferOwner:i=>{i&&t({id:e,owner:i})},leaveChannel:()=>{e&&s(e)},leaving:o,leaveSuccess:r,isOwner:p,transferring:l,transferSuccess:a}}var h=n(698),m=n(9885),x=n(6458),u=n(683);const g=o.ZP.ul`
  display: flex;
  flex-direction: column;
  max-height: 260px;
  padding: 16px 0;
