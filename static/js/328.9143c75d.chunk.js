"use strict";(globalThis.webpackChunkrustchat_web=globalThis.webpackChunkrustchat_web||[]).push([[328],{8648:(e,t,n)=>{n.d(t,{Z:()=>l});var i=n(7313),s=n(887),o=n(9184),a=n(6417);const r=o.ZP.div`
  width: 100%;
  position: relative;
  display: flex;
  overflow: hidden;
...
`;function j(e){let{issuers:t}=e;const[n,s]=(0,i.useState)(!1);return t?(0,u.jsxs)(u.Fragment,{children:[(0,u.jsxs)(c,{onClick:()=>{s(!0)},children:[(0,u.jsx)("img",{src:m,className:"icon",alt:"solid icon"}),"Sign in with OIDC"]}),n&&(0,u.jsx)(f.Z,{id:"modal-modal",children:(0,u.jsxs)(w,{title:"Login with OIDC",children:[t.filter((e=>e.enable)).map(((e,t)=>(0,u.jsx)(b,{issuer:e},t))),(0,u.jsx)(r.Z,{className:"border_less ghost buttonCancel",onClick:()=>{s(!1)},children:"Close"})]})})]}):null}var C=n(8648),v=n(2338);const k=n.p+"static/media/google.db7474a481e12799b961.svg";function y(e){let{login:t,clientId:n}=e;const{signIn:i,loaded:s}=(0,v.useGoogleLogin)({onScriptLoadFailure:e=>{},clientId:n,onSuccess:e=>{let{tokenId:n,...i}=e;t({id_token:n,type:"google"})},onFailure:e=>{}});return(0,u.jsxs)(c,{disabled:!s,onClick:()=>{i()},children:[(0,u.jsx)("img",{className:"icon",src:k,alt:"google icon"}),s?"Sign in with Google":"Initailizing"]})}var S=n(7890);const Z=(0,a.ZP)(r.Z)`
  width: 100%;
  margin-bottom: 16px;
`;function N(){const e=(0,S.s0)();return(0,u.jsx)(Z,{onClick:()=>{e("/send_magic_link")},children:"Sign in with Magic Link"})}const _=a.ZP.p`
  text-align: center;
  margin: 24px 0 8px;
