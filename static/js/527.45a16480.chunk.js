...
`;var w=n(8198),y=n(7054),j=n(6417);function E(e){let{uid:t=null,type:n="embed",cid:i=null}=e;const{canCall:o,call:c,canCopyEmail:s,copyEmail:u,removeFromChannel:p,canRemoveFromChannel:h,canRemove:x,removeUser:f}=(0,y.Z)({uid:t,cid:i}),{data:g}=(0,l.v9)((e=>({data:e.contacts.byId[t]})));if(!g)return null;const{name:E,email:Z,avatar:k}=g,N="card"==n&&o,M="embed"==n&&x,O=N||Z||h||M;return(0,j.jsxs)(C,{className:n,children:[(0,j.jsx)(b.Z,{className:"avatar",url:k,name:E}),(0,j.jsx)("h2",{className:"name",children:E}),(0,j.jsx)("span",{className:"email",children:Z}),(0,j.jsxs)("ul",{className:"icons",children:[(0,j.jsx)(a.OL,{to:`/chat/dm/${t}`,children:(0,j.jsxs)("li",{className:"icon chat",children:[(0,j.jsx)(d,{}),(0,j.jsx)("span",{className:"txt",children:"Message"})]})}),"embed"==n&&(0,j.jsxs)("li",{className:"icon call",onClick:c,children:[(0,j.jsx)(m,{}),(0,j.jsx)("span",{className:"txt",children:"Call"})]}),(0,j.jsx)(r.ZP,{disabled:!O,interactive:!0,popperOptions:{strategy:"fixed"},placement:"bottom-start",trigger:"click",hideOnClick:!0,content:(0,j.jsxs)(w.Z,{children:[N&&(0,j.jsx)("li",{className:"item",onClick:c,children:"Call"}),s&&(0,j.jsx)("li",{className:"item",onClick:u,children:"Copy Email"}),h&&(0,j.jsx)("li",{className:"item danger",onClick:p,children:"Remove from Channel"}),M&&(0,j.jsx)("li",{className:"item danger",onClick:f,children:"Remove from Server"})]}),children:(0,j.jsxs)("li",{className:"icon more "+(O?"":"disabled"),children:[(0,j.jsx)(v,{}),(0,j.jsx)("span",{className:"txt",children:"More"})]})})]})]})}},8198:(e,t,n)=>{n.d(t,{Z:()=>i});const i=n(9184).ZP.ul`
  display: flex;
  flex-direction: column;
  gap: 2px;
  padding: 4px;
...
`},7054:(e,t,n)=>{n.d(t,{Z:()=>u});var i=n(7313),l=n(3657),a=n(3709),r=n(7890),o=n(9784),c=n(5564),s=n(6432),d=n(1026);function u(e){let{uid:t,cid:n}=e;const[u,p]=(0,i.useState)(void 0),h=(0,r.bS)(`/contacts/${t}`),[m,{isSuccess:x}]=(0,s.QQ)(),[f,{isSuccess:g}]=(0,c.Cg)(),v=(0,r.s0)(),{copy:b}=(0,d.Z)(),{user:C,channel:w,loginUid:y,isAdmin:j}=(0,a.v9)((e=>{var i;return{user:e.contacts.byId[t],channel:e.channels.byId[n],loginUid:e.authData.uid,isAdmin:null===(i=e.contacts.byId[e.authData.uid])||void 0===i?void 0:i.is_admin}}));(0,i.useEffect)((()=>{p(null!==t&&void 0!==t?t:y)}),[t,y]),(0,i.useEffect)((()=>{(g||x)&&(l.ZP.success("Remove Successfully"),x&&h&&v("/contacts"))}),[g,x,h]);const E=n&&!(null!==w&&void 0!==w&&w.is_public)&&(j||(null===w||void 0===w?void 0:w.owner)==y),Z=y!=t;return{canRemove:j&&y!=t,removeUser:e=>{const t=!Number.isNaN(+e);m(t&&e||u),(0,o.Bn)()},startChat:()=>{v(`/chat/dm/${t}`)},removeFromChannel:e=>{const t=!Number.isNaN(+e);f({id:+n,members:[+(t&&e||u)]}),(0,o.Bn)()},canRemoveFromChannel:E,canCopyEmail:!(null===C||void 0===C||!C.email),copyEmail:e=>{const t="string"==typeof e&&e||(null===C||void 0===C?void 0:C.email);b(t),(0,o.Bn)()},canCall:Z,call:()=>{l.ZP.success("Cooming Soon..."),(0,o.Bn)()}}}},3561:(e,t,n)=>{n.d(t,{Z:()=>c});var i=n(7313),l=n(9784),a=n(2963),r=n(2648),o=n(6417);function c(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"right-start";const[t,n]=(0,i.useState)(!1),[c,s]=(0,i.useState)({x:0,y:0}),d=t=>{(0,l.Bn)(),t.preventDefault();const{currentTarget:i,clientX:a,clientY:r}=t,{left:o,top:c,width:d,height:u}=i.getBoundingClientRect();let p,h;"right-start"==e?(p=a-(o+d),h=c+u-r):(p=a-o,h=c-r),s({x:p,y:h}),n(!0)},u=()=>{n(!1)},p=e=>{let{key:n,items:i,children:l}=e;return(0,o.jsx)(a.ZP,{visible:t,followCursor:"initial",interactive:!0,placement:"right-start",popperOptions:{strategy:"fixed"},onClickOutside:u,content:(0,o.jsx)(r.Z,{hideMenu:u,items:i}),children:l},n)};return{ContextMenu:p,offset:c,visible:t,hideContextMenu:u,handleContextMenuEvent:d}}},1026:(e,t,n)=>{n.d(t,{Z:()=>r});var i=n(7313),l=n(1818),a=n(3657);const r=e=>{const{enableToast:t=!0}=e||{},[n,r]=(0,i.useState)(!1);(0,i.useEffect)((()=>{n&&t&&a.ZP.success("Copied!")}),[n]);const o=e=>{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="absolute",t.style.left="-9999px",document.body.appendChild(t);const n=document.getSelection().rangeCount>0&&document.getSelection().getRangeAt(0);t.select();const i=document.execCommand("copy");return document.body.removeChild(t),n&&(document.getSelection().removeAllRanges(),document.getSelection().addRange(n)),i};return{copied:n,copy:function(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],i=0;return n||(t?(0,l.VP)(e).then((()=>{r(!0),i=setTimeout((()=>{r(!1)}),500)})):(r(o(e)),i=setTimeout((()=>{r(!1)}),500))),()=>{clearTimeout(i)}}}}}}]);