...
`;var ra=n(89670),oa=n(37076);const ca=e=>{let{pullUp:t=null}=e;const n=(0,i.useRef)(null);return(0,i.useEffect)((()=>{const e=new IntersectionObserver((e=>{e.forEach((e=>{e.isIntersecting&&t&&t()}))}),{threshold:0});let i=null;return n&&(i=n.current,i&&e.observe(i)),()=>{i&&e.unobserve(i)}}),[n,t]),(0,m.jsx)("div",{className:"mt-20 flex justify-center items-center w-full py-7",ref:n,children:(0,m.jsx)(oa.Z,{size:24,lineWeight:5,speed:1,color:"#ccc"})})};function da(e){var t;let{cid:n=0,dropFiles:s=[]}=e;const{t:l}=(0,x.$)("chat"),{values:r}=(0,G.Z)("agora"),{list:h,appends:g,hasMore:f,pullUp:w}=A({context:"channel",id:n}),{pathname:j}=(0,a.TH)(),y=(0,b.I0)(),[Z]=(0,C.o5)(),k=(0,v.N)(Z,300),[N,M]=(0,i.useState)(!0),[E,_]=(0,i.useState)(!1),{selects:D,userIds:L,data:O,messageData:I,loginUser:F,footprint:z}=(0,u.CG)((e=>({selects:e.ui.selectMessages[`channel_${n}`],footprint:e.footprint,loginUser:e.authData.user,userIds:e.users.ids,data:e.channels.byId[n],messageData:e.message||{}})));(0,i.useEffect)((()=>(y((0,S.cp)()),()=>{y((0,S.cp)({path:j}))})),[j]);const H=()=>{_((e=>!e))};if(!O)return null;const{name:V,description:R,is_public:U,members:T=[],owner:B}=O,X=U?L:T.slice(0).sort((e=>e==B?-1:0)),K=(null===F||void 0===F?void 0:F.is_admin)||B==(null===F||void 0===F?void 0:F.uid),W=z.readChannels[n],J=(null===O||void 0===O||null===(t=O.pinned_messages)||void 0===t?void 0:t.length)||0,Q=[...h,...g];return(0,m.jsxs)(m.Fragment,{children:[E&&(0,m.jsx)(ra.Z,{cid:n,closeModal:H}),(0,m.jsx)(en,{to:n,context:"channel",dropFiles:s,aside:(0,m.jsx)(m.Fragment,{children:(0,m.jsxs)("ul",{className:"tools",children:[(null===r||void 0===r?void 0:r.enabled)&&(0,m.jsx)("li",{className:"tool",children:(0,m.jsx)(p.Z,{tip:"Voice/Video Chat",placement:"left",children:(0,m.jsx)(ia,{})})}),(0,m.jsx)(p.Z,{tip:l("pin"),placement:"left",children:(0,m.jsx)(c.ZP,{placement:"left-start",popperOptions:{strategy:"fixed"},offset:[0,150],interactive:!0,trigger:"click",content:(0,m.jsx)(P,{id:n}),children:(0,m.jsx)("li",{className:"tool "+(J>0?"badge":""),"data-count":J,children:(0,m.jsx)(wi,{})})})}),(0,m.jsx)(p.Z,{tip:l("fav"),placement:"left",children:(0,m.jsx)(c.ZP,{placement:"left-start",popperOptions:{strategy:"fixed"},offset:[0,162],interactive:!0,trigger:"click",content:(0,m.jsx)($,{cid:n}),children:(0,m.jsx)("li",{className:"tool fav","data-count":J,children:(0,m.jsx)(Dt.Z,{})})})}),(0,m.jsx)("li",{className:"tool "+(N?"active":""),onClick:()=>{M((e=>!e))},children:(0,m.jsx)(p.Z,{tip:l("channel_members"),placement:"left",children:(0,m.jsx)(Qi,{})})})]})}),header:(0,m.jsx)(aa,{className:"head",children:(0,m.jsxs)("div",{className:"txt",children:[(0,m.jsx)(Y.Z,{personal:!U}),(0,m.jsx)("span",{className:"title",children:V}),(0,m.jsx)("span",{className:"desc",children:R})]})}),users:N?(0,m.jsx)(m.Fragment,{children:(0,m.jsxs)(sa,{children:[K&&(0,m.jsxs)("div",{className:"add",onClick:H,children:[(0,m.jsx)("img",{className:"icon",src:d}),(0,m.jsx)("div",{className:"txt",children:l("add_channel_members")})]}),X.map((e=>(0,m.jsx)(q.Z,{enableContextMenu:!0,cid:n,owner:B==e,uid:e,dm:!0,popover:!0},e)))]})}):null,children:(0,m.jsxs)(la,{id:`VOCECHAT_FEED_channel_${n}`,children:[f?(0,m.jsx)(ca,{pullUp:w}):(0,m.jsxs)("div",{className:"info",children:[(0,m.jsx)("h2",{className:"title",children:l("welcome_channel",{name:V})}),(0,m.jsxs)("p",{className:"desc",children:[l("welcome_desc",{name:V})," "]}),(null===F||void 0===F?void 0:F.is_admin)&&(0,m.jsxs)(o.OL,{to:`/setting/channel/${n}?f=${j}`,className:"edit",children:[(0,m.jsx)(Ne,{className:"icon"}),l("edit_channel")]})]}),Q.map(((e,t)=>{const i=I[e];if(!i)return null;const a=0==t?null:I[Q[t-1]],s=(null===i||void 0===i?void 0:i.from_uid)==(null===F||void 0===F?void 0:F.uid)||e<=W;return qi({selectMode:!!D,updateReadIndex:k,read:s,prev:a,curr:i,contextId:n,context:"channel"})}))]})})]})}const pa=(0,i.memo)(da),ha=s.ZP.header`
  height: 100%;
...
`,ua=s.ZP.article`
  ...
  height: -webkit-fill-available;
  overflow: auto;
`,xa=e=>{let{uid:t=0,dropFiles:n}=e;const{list:i,appends:a,hasMore:s,pullUp:l}=A({context:"user",id:t}),[r]=(0,C.o5)(),o=(0,v.N)(r,300),{currUser:d,messageData:h,footprint:x,loginUid:g,selects:f}=(0,u.CG)((e=>{var n;return{selects:e.ui.selectMessages[`user_${t}`],loginUid:null===(n=e.authData.user)||void 0===n?void 0:n.uid,footprint:e.footprint,currUser:e.users.byId[t],messageData:e.message}}));if(!d)return null;const b=x.readUsers[t],w=[...i,...a];return(0,m.jsx)(en,{to:t,context:"user",dropFiles:n,aside:(0,m.jsx)(m.Fragment,{children:(0,m.jsx)("ul",{className:"tools",children:(0,m.jsx)(p.Z,{tip:"Saved Items",placement:"left",children:(0,m.jsx)(c.ZP,{placement:"left-start",popperOptions:{strategy:"fixed"},offset:[0,180],interactive:!0,trigger:"click",content:(0,m.jsx)($,{uid:t}),children:(0,m.jsx)("li",{className:"tool fav",children:(0,m.jsx)(Dt.Z,{})})})})})}),header:(0,m.jsx)(ha,{className:"head",children:(0,m.jsx)(q.Z,{interactive:!1,uid:d.uid})}),children:(0,m.jsxs)(ua,{id:`VOCECHAT_FEED_user_${t}`,children:[s?(0,m.jsx)(ca,{pullUp:l}):null,[...w].map(((e,n)=>{const i=h[e],a=0==n?null:h[w[n-1]],s=(null===i||void 0===i?void 0:i.from_uid)==g||e<=b;return qi({selectMode:!!f,updateReadIndex:o,read:s,prev:a,curr:i,contextId:t,context:"user"})}))]})})};var ma=n(59476),ga=n(99757);const fa=s.ZP.ul`
  display: flex;
  flex-direction: column;
  gap: 2px;
  padding: 8px;
...
`,Ea=()=>{const{t:e}=(0,x.$)("auth"),t=(0,b.I0)(),{clearLocalData:n}=(0,qt.Z)(),i=(0,a.s0)(),s=(0,u.CG)((e=>e.server.name));return(0,m.jsxs)(Ma,{children:[(0,m.jsx)("h2",{className:"title",children:e("welcome",{name:s})}),(0,m.jsxs)("div",{className:"details",children:[(0,m.jsx)("span",{className:"desc",children:e("guest_login_tip")}),(0,m.jsx)(ve.Z,{onClick:()=>{t((0,Yt.sQ)()),n(),i("/login")},className:"small",children:e("sign_in")})]})]})},_a=s.ZP.header`
  height: 100%;
  display: flex;
  align-items: center;
  justify-content: space-between;
