...
`;function Z(e){let{uploading:t,progress:i,thumbnail:n,download:s,content:r,properties:a={}}=e;const{width:o=0,height:l=0}=(0,_.CW)(a);return(0,h.jsxs)(k,{children:[t&&(0,h.jsx)("div",{className:"overlay",children:(0,h.jsx)("div",{className:"progress",children:(0,h.jsx)(j.Ip,{value:i,strokeWidth:50,styles:(0,j.y3)({storke:"#000",strokeLinecap:"butt"})})})}),(0,h.jsx)("img",{className:"img preview",style:{width:o?`${o}px`:"",height:l?`${l}px`:""},"data-meta":JSON.stringify(a),"data-origin":r,"data-download":s,src:n||s||r})]})}var N=i(3247),L=i(445),C=i(5106);var E=i(1808),S=i(6475);const z=c.ZP.div`
  background: #ecfdff;
  border-radius: 4px;
  height: 8px;
  overflow: hidden;
...
`;function $(e){let{value:t,width:i="100%"}=e;return(0,h.jsx)(z,{style:{width:i},children:(0,h.jsx)("div",{className:"progress",style:{width:`${t}%`}})})}var P=i(6544),F=i(9930);a().extend(w());const M=e=>e&&"string"==typeof e&&e.startsWith("blob:");function R(e){let{context:t="",to:i=null,created_at:s,from_uid:r=null,content:o="",download:l="",thumbnail:c="",properties:d={local_id:0,name:"",size:0,content_type:""}}=e;const[p,f]=(0,n.useState)(null),[u,x]=(0,n.useState)(!1),g=function(e){let{context:t="user",id:i=0}=e;const n=(0,b.I0)(),s="channel"==t?L.nF:C.Fs;return e=>{n(s({id:i,mid:e})),n((0,N.Gd)(e))}}({context:t,id:i}),{sendMessage:m,isSuccess:v,isSending:w}=(0,S.Z)({context:t,from:r,to:i}),{stopUploading:j,data:k,uploadFile:z,progress:R,isSuccess:O}=(0,E.Z)(),I=(0,b.v9)((e=>e.contacts.byId[r])),{size:U,name:D,content_type:T}=null!==d&&void 0!==d?d:{};(0,n.useEffect)((()=>{M(o)&&(async e=>{let{url:t,name:i,type:n}=e;try{if(x(!0),n.startsWith("image")){const e=await(0,_.Ad)(t);f(e)}let e=await fetch(t).then((e=>e.blob())).then((e=>new File([e],i,{type:n})));await z(e),x(!1)}catch(s){x(!1)}})({url:o,name:D,type:T})}),[o,D,T]),(0,n.useEffect)((()=>{const e=null!==d&&void 0!==d?d:{},t=p?{...e,...p}:e;if(O&&M(o)){const{path:e}=k;m({ignoreLocal:!0,type:"file",content:{path:e},properties:t})}}),[O,k,d,o]),(0,n.useEffect)((()=>{v&&URL.revokeObjectURL(o)}),[v,o]);if(!d)return null;const H=(0,_.LP)(T,D);if(!o||!D)return null;const A=u||w;return(0,_.Or)(T,U)?(0,h.jsx)(Z,{uploading:A,progress:R,properties:{...p,...d},size:U,content:o,download:l,thumbnail:c}):(0,h.jsx)(y,{className:"file_message "+(A?"sending":""),children:(0,h.jsxs)("div",{className:"basic",children:[H,(0,h.jsxs)("div",{className:"info",children:[(0,h.jsx)("span",{className:"name",children:D}),(0,h.jsx)("span",{className:"details",children:A?(0,h.jsx)($,{value:R,width:"80%"}):(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)("i",{className:"size",children:(0,_.td)(U)}),(0,h.jsx)("i",{className:"time",children:a()(s).fromNow()}),I&&(0,h.jsxs)("i",{className:"from",children:["by ",(0,h.jsx)("strong",{children:I.name})]})]})})]}),A?(0,h.jsx)(F.Z,{className:"cancel",onClick:()=>{j(),URL.revokeObjectURL(o),g(d.local_id)}}):(0,h.jsx)("a",{className:"download",download:D,href:`${o}&download=true`,children:(0,h.jsx)(P.Z,{})})]})})}var O=i(5843);const I=c.ZP.a`
  background: #f3f4f6;
  border: 1px solid #d4d4d4;
  box-sizing: border-box;
  border-radius: 6px;
...
`;function D(e){let{url:t=""}=e;const[i,s]=(0,n.useState)(""),[r]=(0,O.rf)(),[a,o]=(0,n.useState)(null);(0,n.useEffect)((()=>{(async e=>{var t;const{data:i}=await r(e),n=i.title||i.site_name,a=i.description,l=(null===(t=i.images.find((e=>!!e.url)))||void 0===t?void 0:t.url)||"",c=i.favicon_url||`${new URL(e).origin}/favicon.ico`;s(c),o({title:n,description:a,ogImage:l})})(t)}),[t]);if(!t||!a||!a.title)return null;const{title:l,description:c,ogImage:d}=a;return d?(0,h.jsxs)(U,{href:t,target:"_blank",children:[(0,h.jsx)("h3",{className:"title",children:l}),(0,h.jsx)("p",{className:"desc dots",children:c}),(0,h.jsx)("div",{className:"image",children:(0,h.jsx)("img",{src:d,alt:"og image"})})]}):(0,h.jsxs)(I,{href:t,target:"_blank",children:[i&&(0,h.jsx)("div",{className:"favicon",children:(0,h.jsx)("img",{onError:()=>{s("")},src:i,alt:"favicon"})}),(0,h.jsxs)("div",{className:"info",children:[(0,h.jsx)("h3",{className:"title",children:l}),(0,h.jsx)("p",{className:"desc dots",children:c}),(0,h.jsx)("span",{className:"link dots",children:t})]})]})}var T=i(7560),H=i.n(T);const A=e=>{let{context:t=null,to:i=null,from_uid:r,created_at:c,properties:d,content_type:p,content:f,download:u,thumbnail:x,edited:v=!1}=e,w=null;switch(p){case o.bT.text:w=(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(s.Z,{componentDecorator:(e,t,i)=>(0,h.jsxs)(n.Fragment,{children:[(0,h.jsx)("a",{className:"link",target:"_blank",href:e,rel:"noreferrer",children:t},i),!e.startsWith("mailto")&&(0,h.jsx)(D,{url:e})]},i),children:H()(f,/(\s{1}@[0-9]+\s{1})/g,((e,t)=>{const n=e.trim().slice(1);return(0,h.jsx)(l.Z,{uid:n,cid:i},t)}))}),v&&(0,h.jsx)("span",{className:"edited",title:a()(v).format("YYYY-MM-DD h:mm:ss A"),children:"(edited)"})]});break;case o.bT.markdown:w=(0,h.jsx)(m.Z,{content:f});break;case o.bT.file:w=(0,h.jsx)(R,{properties:d,context:t,to:i,download:u,thumbnail:x,from_uid:r,created_at:c,content:f});break;case o.bT.archive:w=(0,h.jsx)(g,{properties:d,context:t,to:i,from_uid:r,created_at:c,id:f,thumbnail:x})}return w}},7323:(e,t,i)=>{i.d(t,{Z:()=>n});const n=i(9184).ZP.div`
  position: relative;
  display: flex;
