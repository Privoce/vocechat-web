...
`;function o(e){let{url:i="",name:t="",type:a="user",uploadImage:o,disabled:d=!1}=e;const[M,u]=(0,s.useState)(!1);return(0,c.jsxs)(r,{children:[(0,c.jsxs)("div",{className:"avatar",children:[(0,c.jsx)(n.Z,{type:a,url:i,name:t}),!d&&(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("div",{className:"tip",children:M?"Uploading":"Change Avatar"}),(0,c.jsx)("input",{multiple:!1,onChange:async e=>{if(M)return;const[i]=e.target.files;u(!0),await o(i),u(!1)},type:"file",accept:"image/*",name:"avatar",id:"avatar"})]})]}),!d&&(0,c.jsx)("img",{src:l,alt:"icon",className:"icon"})]})}},6047:(e,i,t)=>{t.d(i,{Z:()=>z});var s=t(7313),a=t(9184),n=t(2963),l=t(9784),c=t(3657),r=t(6123),o=t(5515),d=t(5281),M=t(3165),u=t(4050),x=t(1140),j=t(6417);const N=a.ZP.div`
  display: flex;
...
`,c={},r={};function o(e){let{options:i,values:t=r,value:a=c,defaultValue:o,onChange:d}=e;const M=(0,s.useId)(),[u,x]=(0,s.useState)(o),j=a!==c?a:u;return(0,n.jsx)(l,{children:i.map(((e,i)=>(0,n.jsxs)("div",{className:"option",children:[(0,n.jsx)("input",{type:"radio",checked:(t!==r?t.indexOf(j):j)===i,onChange:()=>{const e=t===r?i:t[i];a===c&&x(e),d&&d(e)},id:`${M}-${i}`}),(0,n.jsx)("div",{className:"box",children:(0,n.jsx)("label",{htmlFor:`${M}-${i}`,children:e})})]},i)))})}},4458:(e,i,t)=>{t.d(i,{Z:()=>s});const s=t(9184).ZP.textarea`
  font-family: inherit;
  width: 100%;
  background: #ffffff;
  border: 1px solid #e5e7eb;
...
`;function h(){const e=(0,p.CG)((e=>e.contacts.byId[e.authData.uid])),[i,t]=(0,s.useState)(!1),[a,n]=(0,s.useState)(null),[l,c]=(0,s.useState)(null),{data:r,refetch:h}=(0,d.z3)(),{data:w,refetch:I}=(0,d.ww)(),[_,{isSuccess:T}]=(0,d.e2)(),[y,{isSuccess:f}]=(0,d.jd)(),[L,{isSuccess:z}]=(0,d.QP)(),E=e=>{const i=e.target.value,{type:t}=e.target.dataset;n((e=>({...e,[t]:i})))};if((0,s.useEffect)((()=>{f&&(o.ZP.success("Update logo successfully!"),h())}),[f]),(0,s.useEffect)((()=>{r&&n(r)}),[r]),(0,s.useEffect)((()=>{w&&c(w)}),[w]),(0,s.useEffect)((()=>{if(r&&a&&w&&l){const{name:e,description:i}=a,{name:s,description:n}=r,{who_can_sign_up:c}=l,{who_can_sign_up:o}=w;t(s!==e||n!==i||o!==c)}}),[r,a,w,l]),(0,s.useEffect)((()=>{T&&z&&(o.ZP.success("Configuration updated!"),h(),I())}),[T,z]),!a||!l)return null;const{name:O,description:b,logo:C}=a,{who_can_sign_up:v}=l,A=null===e||void 0===e?void 0:e.is_admin;return(0,m.jsxs)(D,{children:[(0,m.jsxs)("div",{className:"logo",children:[(0,m.jsx)("div",{className:"preview",children:(0,m.jsx)(M.Z,{disabled:!A,url:f?`${C}?t=${+new Date}`:C,name:O,uploadImage:y})}),A&&(0,m.jsx)("div",{className:"upload",children:(0,m.jsx)("div",{className:"tip",children:"Minimum size is 128x128, We recommend at least 512x512 for the server. Max size limited to 5M."})})]}),(0,m.jsxs)("div",{className:"inputs",children:[(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(x.Z,{htmlFor:"name",children:"Server Name"}),(0,m.jsx)(u.Z,{disabled:!A,"data-type":"name",onChange:E,value:O,name:"name",id:"name",placeholder:"Server Name"})]}),(0,m.jsxs)("div",{className:"input",children:[(0,m.jsx)(x.Z,{htmlFor:"desc",children:"Server Description"}),(0,m.jsx)(j.Z,{disabled:!A,"data-type":"description",onChange:E,value:null!==b&&void 0!==b?b:"",rows:4,name:"name",id:"name",placeholder:"Tell the world a bit about this server"})]}),A&&(0,m.jsxs)("div",{className:"radioButton",children:[(0,m.jsx)("p",{className:"label",children:"Default Sign Up"}),(0,m.jsx)("p",{className:"tip",children:"Who can sign up this server."}),(0,m.jsx)(g.Z,{options:["Everyone","Invitation Link Only"],values:["EveryOne","InvitationOnly"],value:v,onChange:e=>c({...w,who_can_sign_up:e})})]})]}),i&&(0,m.jsx)(N.Z,{saveHandler:()=>{const{name:e,description:i}=a;_({name:e,description:i}),L({...w,who_can_sign_up:l.who_can_sign_up})},resetHandler:()=>{n(r),c(w)}})]})}const w=r.ZP.div`
  position: relative;
  width: 512px;
  height: 100%;
  display: flex;
...
`;function b(e){let{link:i="#"}=e;return(0,m.jsx)(y.ZP,{delay:[0,500],interactive:!0,arrow:f.ki,placement:"bottom",content:(0,m.jsxs)(O,{children:["Need more detail? See our"," ",(0,m.jsx)("a",{target:"doc",href:i,children:"doc"}),"."]}),children:(0,m.jsx)(E,{className:"icon"})})}var C=t(552),v=t(746),A=t(5281);const k=r.ZP.div`
  user-select: none;
  border: 1px solid #e5e7eb;
  border-radius: 4px;
  padding: 8px;
