...
`,Z=e=>{let{uploading:t,progress:i,thumbnail:n,download:a,content:r,properties:o}=e;const[l,d]=(0,s.useState)(n),{width:c=0,height:p=0}=(0,x.CW)(o);return(0,s.useEffect)((()=>{const e=n,t=new Image;t.onload=()=>{d(e)},t.onerror=()=>{d("")},t.src=e}),[n]),(0,v.jsxs)(_,{children:[t&&(0,v.jsx)("div",{className:"overlay",children:(0,v.jsx)("div",{className:"progress",children:(0,v.jsx)(N.Ip,{value:i,strokeWidth:50,styles:(0,N.y3)({strokeLinecap:"butt"})})})}),(0,v.jsx)("img",{className:"img preview",style:{width:c?`${c}px`:"",height:p?`${p}px`:""},"data-meta":JSON.stringify(o),"data-origin":r,"data-download":a,src:l})]})};var k=i(53517),L=i(1823),C=i(88332),E=i(66160);var z=i(34265),S=i(62432);const $=e=>{let{value:t,width:i="100%"}=e;return(0,v.jsx)("div",{className:"bg-[#ecfdff] rounded h-2 overflow-hidden",style:{width:i},children:(0,v.jsx)("div",{className:"h-2 bg-[#088ab2] rounded transition-all",style:{width:`${t}%`}})})};var P=i(11972),F=i(24041),O=i(66673),M=i(8969);const R=e=>{let{url:t,name:i,size:n,download:a}=e;const[r,o]=(0,s.useState)(!1),[l,d]=(0,s.useState)(!1),c=(0,x.td)(n),p="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2";return(0,v.jsxs)("div",{className:"w-96 h-52 relative rounded-md border border-solid border-gray-300 overflow-hidden group",children:[(0,v.jsx)("div",{className:"absolute top-0 left-0 w-full h-full bg-black/40 z-20 group-hover:hidden"}),(0,v.jsxs)("div",{className:"absolute top-0 left-0 w-full flex justify-between z-30 px-3 py-2 overflow-hidden group-hover:bg-black/20",children:[(0,v.jsxs)("div",{className:"flex gap-2 ",children:[(0,v.jsx)(M.Z,{className:"w-9 h-auto"}),(0,v.jsxs)("div",{className:"flex flex-col gap-1 text-sm text-white",children:[(0,v.jsx)("span",{title:i,className:"font-bold whitespace-nowrap text-ellipsis w-[240px] overflow-hidden",children:i}),(0,v.jsx)("span",{children:c})]})]}),(0,v.jsx)("a",{href:a,className:"mt-2",children:(0,v.jsx)(P.Z,{className:"fill-white"})})]}),r?l?(0,v.jsx)("span",{className:`${p} text-red-500`,children:"Error"}):null:(0,v.jsx)("div",{className:p,children:(0,v.jsx)(O.Z,{color:"#fff"})}),(0,v.jsx)("video",{onPlay:e=>{const t=e.currentTarget.previousSibling;t&&t.classList.add("hidden")},onError:()=>{o(!1),d(!0)},onCanPlay:()=>{o(!0)},onPause:e=>{const t=e.currentTarget.previousSibling;t&&t.classList.remove("hidden")},controls:r,className:"absolute left-0 top-0 w-full h-full object-cover z-10",children:(0,v.jsx)("source",{src:t,type:"video/mp4"})})]})};var U=i(20814),I=i(57425);const D=e=>{let{url:t,name:i,size:n,download:a}=e;const[r,o]=(0,s.useState)(!1),l=(0,x.td)(n);return(0,v.jsxs)("div",{className:"w-96 flex flex-col gap-2 px-3 py-2 rounded-md border border-solid border-gray-300 overflow-hidden bg-[#f1f3f4]",children:[(0,v.jsxs)("div",{className:"flex justify-between z-30 overflow-hidden",children:[(0,v.jsxs)("div",{className:"flex gap-2 ",children:[(0,v.jsx)(U.Z,{className:"w-9 h-auto"}),(0,v.jsxs)("div",{className:"flex flex-col gap-1 text-sm text-gray-700",children:[(0,v.jsx)("span",{title:i,className:"font-bold whitespace-nowrap text-ellipsis w-[240px] overflow-hidden",children:i}),(0,v.jsx)("span",{children:l})]})]}),(0,v.jsx)("a",{href:a,className:"mt-2",children:(0,v.jsx)(P.Z,{className:"download_icon gray"})})]}),(0,v.jsx)("audio",{src:t,onCanPlay:()=>{o(!0)},controls:!0,className:(0,I.Z)("w-full object-cover z-10",r?"":"hidden")})]})},T=e=>e.startsWith("blob:"),G=e=>{let{context:t,to:i,created_at:n,from_uid:a,content:o="",download:l="",thumbnail:d="",properties:c={local_id:0,name:"",size:0,content_type:""}}=e;const[p,f]=(0,s.useState)(null),[h,u]=(0,s.useState)(!1),g=function(e){let{context:t="user",id:i=0}=e;const s=(0,E.TL)(),n="channel"==t?L.nF:C.Fs;return e=>{s(n({id:i,mid:e})),s((0,k.Gd)(e))}}({context:t,id:i}),{sendMessage:m,isSuccess:w,isSending:b}=(0,S.Z)({context:t,from:a,to:i}),{stopUploading:j,data:N,uploadFile:_,progress:O,isSuccess:M}=(0,z.Z)(),U=(0,E.CG)((e=>e.users.byId[a])),{size:I=0,name:G,content_type:W}=null!==c&&void 0!==c?c:{};(0,s.useEffect)((()=>{T(o)&&(async e=>{let{url:t,name:i,type:s}=e;try{if(u(!0),s.startsWith("image")){const e=await(0,x.Ad)(t);f(e)}let e=await fetch(t).then((e=>e.blob())).then((e=>new File([e],i,{type:s})));await _(e),u(!1)}catch(n){u(!1)}})({url:o,name:G,type:W})}),[o,G,W]),(0,s.useEffect)((()=>{const e=null!==c&&void 0!==c?c:{},t=p?{...e,...p}:e;if(M&&T(o)){const{path:e}=N;m({ignoreLocal:!0,type:"file",content:{path:e},properties:t})}}),[M,N,c,o]),(0,s.useEffect)((()=>{w&&URL.revokeObjectURL(o)}),[w,o]);if(!c)return null;const H=(0,x.LP)(W,G);if(!o||!G)return null;const A=h||b;return(0,x.Or)(W,I)?(0,v.jsx)(Z,{uploading:A,progress:O,properties:{...p,...c},content:o,download:l,thumbnail:d},null===c||void 0===c?void 0:c.local_id):W.startsWith("video")&&!A?(0,v.jsx)(R,{size:I,url:o,name:G,download:l}):W.startsWith("audio")&&!A?(0,v.jsx)(D,{size:I,url:o,name:G,download:l}):(0,v.jsx)(y,{className:"file_message "+(A?"sending":""),children:(0,v.jsxs)("div",{className:"basic",children:[H,(0,v.jsxs)("div",{className:"info",children:[(0,v.jsx)("span",{className:"name",children:G}),(0,v.jsx)("span",{className:"details",children:A?(0,v.jsx)($,{value:O,width:"80%"}):(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)("i",{className:"size",children:(0,x.td)(I)}),(0,v.jsx)("i",{className:"time",children:r()(n).fromNow()}),U&&(0,v.jsxs)("i",{className:"from",children:["by ",(0,v.jsx)("strong",{children:U.name})]})]})})]}),A?(0,v.jsx)(F.Z,{className:"cancel",onClick:()=>{j(),URL.revokeObjectURL(o),g(c.local_id)}}):(0,v.jsx)("a",{className:"download",download:G,href:`${o}&download=true`,children:(0,v.jsx)(P.Z,{})})]})})},W=p.ZP.a`
  background: #f3f4f6;
  border: 1px solid #d4d4d4;
  box-sizing: border-box;
  border-radius: 6px;
...
`;function A(e){let{url:t=""}=e;const[i,n]=(0,s.useState)(""),[a]=(0,g.rf)(),[r,o]=(0,s.useState)(null);(0,s.useEffect)((()=>{(async e=>{var t;const{data:i}=await a(e),s=(null===i||void 0===i?void 0:i.title)||(null===i||void 0===i?void 0:i.site_name)||"",r=(null===i||void 0===i?void 0:i.description)||"",l=(null===i||void 0===i||null===(t=i.images.find((e=>!!e.url)))||void 0===t?void 0:t.url)||"",d=(null===i||void 0===i?void 0:i.favicon_url)||`${new URL(e).origin}/favicon.ico`;n(d),o({title:s,description:r,ogImage:l})})(t)}),[t]);if(!t||!r||!r.title)return null;const{title:l,description:d,ogImage:c}=r;return c?(0,v.jsxs)(H,{href:t,target:"_blank",children:[(0,v.jsx)("h3",{className:"title",children:l}),(0,v.jsx)("p",{className:"desc dots",children:d}),(0,v.jsx)("div",{className:"image",children:(0,v.jsx)("img",{src:c,alt:"og image"})})]}):(0,v.jsxs)(W,{href:t,target:"_blank",children:[i&&(0,v.jsx)("div",{className:"favicon",children:(0,v.jsx)("img",{onError:()=>{n("")},src:i,alt:"favicon"})}),(0,v.jsxs)("div",{className:"info",children:[(0,v.jsx)("h3",{className:"title",children:l}),(0,v.jsx)("p",{className:"desc dots",children:d}),(0,v.jsx)("span",{className:"link dots",children:t})]})]})}const V=e=>{let{context:t,to:i=0,from_uid:a=0,created_at:o,properties:p,content_type:f,content:h,download:u,thumbnail:x,edited:g=!1}=e,m=null;switch(f){case d.bT.text:m=(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(n.Z,{componentDecorator:(e,t,i)=>(0,v.jsxs)(s.Fragment,{children:[(0,v.jsx)("a",{className:"link",target:"_blank",href:e,rel:"noreferrer",children:t},i),!e.startsWith("mailto")&&(0,v.jsx)(A,{url:e})]},i),children:l()(h,/(\s{1}@[0-9]+\s{1})/g,((e,t)=>{const s=e.trim().slice(1);return(0,v.jsx)(c.Z,{uid:+s,cid:i},t)}))}),g&&(0,v.jsx)("span",{className:"edited",title:r()(+g).format("YYYY-MM-DD h:mm:ss A"),children:"(edited)"})]});break;case d.bT.markdown:m=(0,v.jsx)(j.Z,{content:h});break;case d.bT.file:m=(0,v.jsx)(G,{properties:p,context:t,to:i,download:u,thumbnail:x,from_uid:a,created_at:o,content:h});break;case d.bT.archive:m=(0,v.jsx)(b,{properties:p,context:t,to:i,from_uid:a,created_at:o,id:h,thumbnail:x})}return m}},17150:(e,t,i)=>{i.d(t,{Z:()=>s});const s=i(57889).ZP.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 16px;
